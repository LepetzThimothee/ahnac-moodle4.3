...
class __Mustache_7e61df9d9249a149ee92e690e53ad9a4 extends Mustache_Template
{
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '    <a class="favorite-icon ';
        $value = $this->resolveValue($context->find('favoriteclass'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '" href="#" data-course-id="';
        $value = $this->resolveValue($context->find('courseid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '"><i class="fas fa-star"></i></a>
';
        $value = $context->find('tags');
        $buffer .= $this->section5bf9739fb3264247a4bc3613734db7de($context, $indent, $value);
...
';
        ...
        $buffer .= $this->section43f8b8225526164263a26056415ee2ad($context, $indent, $value);

        return $buffer;
    }

    private function section5bf9739fb3264247a4bc3613734db7de(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
        <a class="btn btn-secondary btn-sm" href="{{tagurl}}" data-tag-id="{{id}}">{{name}}</a>
    ';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('tagurl'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '" data-tag-id="';
...
';
    ...
    private function section43f8b8225526164263a26056415ee2ad(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
require([\'theme_ahnac/main\'], function(Main) {
    Main.init();
});
';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
...
';
                $buffer .= $indent . '});
';
                $buffer .= $indent . 'require([\'theme_ahnac/main\'], function(Main) {
';
                $buffer .= $indent . '    Main.init();
';
                $buffer .= $indent . '});
';
                $context->pop();
