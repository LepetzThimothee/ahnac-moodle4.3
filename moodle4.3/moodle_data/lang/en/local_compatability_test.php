...
/**
 * Strings for component 'local_compatability_test', language 'en', version '4.3'.
 *
...
$string['admin_feedback'] = 'Admin Feedback';
$string['admin_feedback_def'] = 'Enter your feedback here.';
$string['admin_feedback_desc'] = 'Adds feedback in the view.php page for the user upon failing the compatability test.';
...
$string['force_view_page'] = 'Force View Status Page';
$string['force_view_page_desc'] = 'Force the user to view the plugin status page until they are compliant.';
...
$string['min_version_flash'] = 'Minimum Flash Version';
...
$string['pluginname'] = 'Compatibility Test';
