...
/**
 * Strings for component 'qtype_externaltask', language 'en', version '4.3'.
 *
...
$string['pluginname'] = 'External task';
$string['pluginname_help'] = 'Allows for an external task to be performed. This must then be graded manually.';
$string['pluginname_link'] = 'question/type/externaltask';
$string['pluginnameadding'] = 'Adding an External task question';
$string['pluginnameediting'] = 'Editing an External task question';
$string['pluginnamesummary'] = 'Allows for an external task to be performed. This must then be graded manually.';
$string['privacy:metadata'] = 'The External task question type plugin does not store any personal data.';
