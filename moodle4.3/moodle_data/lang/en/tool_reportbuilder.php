...
/**
 * Strings for component 'tool_reportbuilder', language 'en', version '4.3'.
 *
...
$string['columncannotbeconverted'] = 'Column \'{$a}\' can not be converted';
$string['conditioncannotbeconverted'] = 'Condition \'{$a}\' can not be converted';
$string['conditionoptioncannotbeconverted'] = 'Option \'{$a->option}\' in the condition \'{$a->condition}\' can not be converted';
...
$string['convertingreport'] = 'Converting report \'{$a}\'';
$string['convertnotimplementeddesc'] = 'The report could not be converted. The developer needs to specify the conversion rules. You can also try to create the same report in the new version of the report builder from scratch and remove this one.';
$string['convertnotpossibledesc'] = 'The report could not be converted automatically. Please see the error message below. It is possible that some columns or other attributes of this report do not have an exact match in the new data sources. In this case you may edit the report and remove elements that can not be converted automatically, then try to convert again. Note that if there are several errors during report conversion only the first one is displayed here.';
$string['convertocore'] = 'Convert to latest version';
$string['course_completion_days_course'] = 'Days taking course';
$string['course_completion_days_enrolled'] = 'Days enrolled';
$string['course_completion_daysuntilcompletion'] = 'Days until completion';
...
$string['course_completion_reaggregated'] = 'Time reaggregated';
...
$string['course_enrolment_method'] = 'Method';
...
$string['editinglegacywarning'] = 'You are editing a report from the outdated version of Report builder. It is recommended that you convert it to the latest version.';
...
$string['filtercannotbeconverted'] = 'Filter \'{$a}\' can not be converted';
...
$string['gotocorerb'] = 'Go to custom reports';
...
$string['importlogconversionfailure'] = 'Imported custom report \'{$a->name}\' was made in the outdated version of report builder and it could not be converted automatically. Please visit <a href="{$a->url}">Report Builder</a> page to proceed with manual conversion: \'{$a->message}\'';
$string['importlogconversionsuccess'] = 'Imported custom report \'{$a->name}\' was converted from the outdated version of report builder';
...
$string['legacyreportsview'] = 'View reports';
$string['legacyreportswarning'] = 'Some reports were not converted to the latest version.';
...
$string['or'] = 'OR';
$string['pluginname'] = 'Report builder - outdated version';
...
$string['reportconverted'] = 'Report has been successfully converted.';
...
$string['viewconvertedreport'] = 'View converted report';
$string['viewreports'] = 'Report builder';
$string['warningonlegacypage'] = 'You are browsing outdated version of reportbuilder.';
