...
/**
 * Strings for component 'local_envbar', language 'en', version '4.3'.
 *
...
$string['refreshedagotitle'] = 'This sites database was copied on {$a}';
...
$string['showrefresh'] = 'Show refresh time';
$string['showrefresh_desc'] = 'This setting controls if the last refresh time is shown.';
