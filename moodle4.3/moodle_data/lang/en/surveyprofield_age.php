...
/**
 * Strings for component 'surveyprofield_age', language 'en', version '4.3'.
 *
...
$string['uerr_agenotset'] = 'Please choose a age or select the "{$a}" checkbox';
$string['uerr_agenotsetrequired'] = 'Age is not correctly defined';
