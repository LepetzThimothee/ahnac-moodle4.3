...
/**
 * Strings for component 'tool_uploadpageresults', language 'en', version '4.3'.
 *
...
$string['pluginname'] = 'Upload page activities completions';
$string['result'] = 'Result';
$string['uploadpageresultsresult'] = 'Upload results';
