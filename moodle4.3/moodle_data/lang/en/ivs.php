...
/**
 * Strings for component 'ivs', language 'en', version '4.3'.
 *
 * @package     ivs
 * @category    string
...
$string['ivs_course_license_modal_confirmation'] = 'Are you sure? The license will be released after this action an can be assigned again.';
...
$string['ivs_license_data_policy'] = 'Data protection: Your privacy is important to us. To enable us to create a custom-made IVS-Player for you, only pseudonymized usage statistics are transferred via an encrypted connection. For detailed information please check our AGBs.';
...
$string['ivs_match_config_assessment_mode_formative_help'] = 'Please answer the questions shown in this video. With the button "Repeat" you can change your answer.';
...
$string['ivs_match_context_label_help'] = '<strong>Note:</strong> In this mode the questions are only simulated and the answers will not be saved.';
$string['ivs_match_context_label_timing'] = 'Edit and create timing sequences';
...
$string['ivs_match_question_summary_question_type_timing'] = 'Timing sequence';
...
$string['ivs_setting_annotation_buttons_help'] = 'The reply, edit and delete actions for comments will only be shown on mouseover.';
...
$string['ivs_setting_annotation_readmore_help'] = 'Shorten comments that are too long. The whole message can still be displayed by clicking to the pop-up icon.';
$string['ivs_setting_annotation_realm_default'] = 'Set default read access to "course"';
$string['ivs_setting_annotation_realm_default_help'] = 'The read access when creating new comments is set to "course" by default. All users enrolled in the course can read the comments.';
...
$string['ivs_setting_playbackcommands_help'] = 'Add markers, text cues, zoom, pause, slow motion, and fast motion to your video. Use these to draw learners attention to important aspects and encourage discussion in the video.';
...
$string['ivs_setting_single_choice_question_random_default_help'] = 'Answers in Single Choice questions will be displayed in random order.';
...
$string['ivs_setting_vimp_external_files_help'] = 'You can use VIMP as video source';
$string['ivs_setting_vimp_external_files_title'] = 'Use VIMP video source';
$string['ivs_setting_vimp_menu_title'] = 'VIMP Video';
...
$string['ivs_usage_error_instance'] = 'The instance license {$a->name} has a utilization of {$a->usage} %. The licence is deactivated';
$string['ivs_usage_error_with_license'] = 'The license in course {$a->name} has a utilization of {$a->usage} %. The license will be deactivated when the {$a->product_name} is full';
...
$string['ivs_usage_warning'] = 'The license in course {$a->name} has a utilization of {$a->usage} %. From 110% the license will be deactivated!';
