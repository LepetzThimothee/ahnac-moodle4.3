...
/**
 * Strings for component 'theme_aigne', language 'en', version '4.3'.
 *
 * @package     theme_aigne
 * @category    string
...
$string['accessibilitypage'] = '<h2 style="text-align: center">This is a sample page</h2>
<p>&nbsp;</p>
<h2>Accessibility/h2>
...
$string['bgposition00'] = 'In coordenate 0.0';
...
$string['bgpositiondesc'] = 'Depending on the image type, you can configure the origin point for that image.';
$string['bgrepeat'] = 'Page background repetition';
...
$string['choosereadme'] = '<div class="clearfix">
  <div class="theme_screenshot">
    ...
    <h3>Report a bug:</h3>
    <p>Send a eMail to francpombal@hotmail.com</p>
  </div>
  ...
  <div class="theme_description">
    ...
    <ul>
      <li>Simple design and full CSS compliance, adaptative to several screen sizes..
      ...
      <li>A FrontPage with banner, marketing information and images customized spaces.
      <li>User Information Area, to be displayed in head or in navigation block.
      <li>NavHelp footer section with all needed administrative links to personalized and language sensitive pages.
      (webmap, help, search, stats, disclaimer, policies, privacy, security and accessibility)
      <li>Contact section with about 30 Social Network links
      <li>Copyright section and Credits information section, with new options about external w3c validator servers
      <br />
      <li>More than 100 customization options at Site Admin -> Appearance -> Themes -> aigne
    </ul>
    <h3>Credits:</h3>
...
$string['helppage'] = '<h2 style="text-align: center">This is a sample page</h2>
<p>&nbsp;</p>
...
$string['infobanner7'] = 'Show loggin standard form';
...
$string['policiespage'] = '<h2 style="text-align: center">This is a sample page</h2>
<p>&nbsp;</p>
<h2>Site policies:</h2>
...
$string['privacypage'] = '<h2 style="text-align: center">This is a sample page</h2>
<p>&nbsp;</p>
...
$string['quadro1txt'] = '<h2>Text boxes:</h2>
...
$string['quadro2txt'] = '<h2>Text boxes:</h2>
Introduce here a concise and interesting paragraph<br />
Write a text in your favorite HTML editor, then look up the language file
...
$string['quadro3txt'] = '<h2>Text boxes:</h2>
Introduce here a concise and interesting paragraph<br />
Write a text in your favorite HTML editor, then look up the language file
...
$string['securitypage'] = '<h2 style="text-align: center">This is a sample page</h2>
<p>&nbsp;</p>
<h2>Security:</h2>
...
$string['sloganaigne'] = '...insert here a slogan...';
...
$string['statspage'] = '<h2 style="text-align: center">This is a sample page</h2>
<p>&nbsp;</p>
<h2>Statistics:</h2>
...
$string['usermenu'] = 'On the Header, in new user menu style (greeting + new dropdowm menu)';
$string['usermoodle'] = 'On the Header, in moodle old-fashioned style (login + greeting + user name + logout)';
$string['usernav'] = 'User Information area';
$string['usernavdesc'] = 'Select the type of user information to be displayed, in the header area, in the navigation block or no user information.
The second option (new user menu style) wil run only from the 2.8 version of Moodle or above.';
...
$string['usersalut'] = 'On the Header, only display a greeting';
...
$string['webmappage'] = '<h2 style="text-align: center">This is a sample page</h2>
<p>&nbsp;</p>
