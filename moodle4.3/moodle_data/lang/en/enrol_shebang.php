...
/**
 * Strings for component 'enrol_shebang', language 'en', version '4.3'.
 *
...
$string['LBL_MONITOR_help'] = '<p>If this feature is enabled you can request e-mail notifications to be sent when there has not been activity for more than a specified number of minutes. The check is made during the monitor scheduled task so the frequency of monitoring when the last message was received is dependent on the task configuration.</p><p><ul><li>Begin notifications after - The threshold, in minutes, after which a notification should be sent if there is no activity. Notifications will be sent every 30 minutes thereafter until a new LMB message arrives.</li><li>Notify email address(es) - A comma separated list of e-mail addresses to which to send notification.</li></ul></p>';
...
$string['LBL_PERSON_FULLNAME_DESC'] = 'Use fullname for user description';
...
$string['LBL_PERSON_NICKNAME_PREFER'] = 'Use nickname for user firstname';
...
$string['shebang:config'] = 'Configure enrol instance in course';
