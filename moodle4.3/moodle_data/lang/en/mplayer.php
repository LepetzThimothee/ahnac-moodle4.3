...
/**
 * Strings for component 'mplayer', language 'en', version '4.3'.
 *
 * @package     mplayer
 * @category    string
...
$string['cue_list_help'] = '<div class="indent">
...
$string['livestreaminterval'] = 'Interval';
...
$string['mplayer_advanced_help'] = '<div class="indent">
...
$string['mplayer_appearance'] = 'Appearance';
$string['mplayer_appearance_help'] = '<div class="indent">
...
$string['mplayer_audiodescription'] = 'Audio description';
...
$string['mplayer_behaviour'] = 'Behaviour';
$string['mplayer_behaviour_help'] = '<div class="indent">
...
$string['mplayer_captions'] = 'Captions';
$string['mplayer_captions_help'] = '<div class="indent">
...
$string['mplayer_configxml'] = 'XML configuration';
$string['mplayer_configxml_help'] = '<div class="indent">
...
$string['mplayer_hd_help'] = '<div class="indent">
...
$string['mplayer_infobox'] = 'Infobox';
...
$string['mplayer_livestream'] = 'Live Streaming';
$string['mplayer_livestream_help'] = '<div class="indent">
...
$string['mplayer_logobox'] = 'Logo Box';
$string['mplayer_logobox_help'] = '<div class="indent">
...
$string['mplayer_metadata'] = 'Metadata';
...
$string['mplayer_metaviewer'] = 'Metadata Viewer';
$string['mplayer_metaviewer_help'] = '<div class="indent">
  <p><strong>Position</strong>: </p>
  <ul>
...
$string['mplayer_playlist_help'] = '<div class="indent">
  <p><strong>Position</strong>: </p>
  <ul>
...
$string['mplayer_resources_help'] = '<div class="indent">
  <ul>
...
$string['mplayer_searchbar'] = 'Search Bar';
$string['mplayer_searchbar_help'] = '<div class="indent">
...
$string['mplayer_snapshot'] = 'Snapshot';
$string['mplayer_snapshot_help'] = '<div class="indent">
...
$string['mplayer_technology_help'] = '<p>The MPlayer supports both Flowplayer HTML5 and JW player technology. Moodle administrator may choose to force the technology for the whole platform,
...
$string['mplayer_track_help'] = 'Admits a VTT file which is a simply text formatted file that gives subtitles
