...
/**
 * Strings for component 'atto_morebackcolors', language 'en', version '4.3'.
 *
...
$string['privacy:metadata'] = 'The atto_morebackcolors plugin does not store any personal data.';
$string['rgb'] = 'RGB:';
