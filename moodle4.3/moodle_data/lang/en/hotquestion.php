...
/**
 * Strings for component 'hotquestion', language 'en', version '4.3'.
 *
 * @package     hotquestion
 * @category    string
...
$string['viewaftertimeclosevalidation'] = 'If no closing date is set, then View after close time must be, No.';
