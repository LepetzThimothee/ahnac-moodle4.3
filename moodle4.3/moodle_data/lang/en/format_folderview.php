...
/**
 * Strings for component 'format_folderview', language 'en', version '4.3'.
 *
...
$string['section0name'] = 'Topic list';
$string['sectionaddresource'] = 'Add resource';
