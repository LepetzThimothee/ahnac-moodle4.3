...
/**
 * Strings for component 'antivirus_mimeblocker', language 'en', version '4.3'.
 *
...
$string['allowedmimetypesdesc'] = 'Provide a list of allowed mimetypes separated by ";". For example: "text/xml;image/png;application/pdf"';
