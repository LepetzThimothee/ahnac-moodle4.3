...
/**
 * Strings for component 'qtype_stack', language 'en', version '4.3'.
 *
 * @package     qtype_stack
 * @category    string
...
$string['ATFacForm_isfactored'] = 'Your answer is factored, well done.';
$string['ATFacForm_notalgequiv'] = 'Note that your answer is not algebraically equivalent to the correct answer.  You must have done something wrong.';
$string['ATFacForm_notfactored'] = 'Your answer is not factored.';
...
$string['irred_Q_commonint'] = 'You need to take out a common factor.';
