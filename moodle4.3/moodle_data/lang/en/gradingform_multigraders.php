...
/**
 * Strings for component 'gradingform_multigraders', language 'en', version '4.3'.
 *
...
$string['err_grader_intermediary'] = '<b>{$a}</b> - You can not publish the grade for this student because you are not the final grader.';
...
$string['err_notgraded'] = '<b>{$a}</b> - This student is not graded';
...
$string['show_notify_student_box'] = 'Show notify student box?';
$string['show_notify_student_box_help'] = 'If checked, graders may choose if their show the notify student box or not';
