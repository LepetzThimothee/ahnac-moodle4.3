...
/**
 * Strings for component 'block_news_slider', language 'en', version '4.3'.
 *
...
$string['courseitemsperiod'] = 'Maximum period to show course announcements for (in days)';
$string['courseitemstoshow'] = 'Maximum number of course announcements to display';
...
$string['showrtl'] = 'Use RTL. Select this when using languaages such as Arabic and Hebrew';
...
$string['sliderheight'] = 'Adjust the height of the slider (in px)';
$string['subjectmaxlength'] = 'Max length of subject';
