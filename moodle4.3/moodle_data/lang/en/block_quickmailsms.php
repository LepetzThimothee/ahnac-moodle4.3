...
/**
 * Strings for component 'block_quickmailsms', language 'en', version '4.3'.
 *
...
$string['addionalemail'] = 'Allow SMSs to external email addresses';
$string['addionalemail_desc'] = 'If this option is enabled quickmailsms texts are also sent so external test adresses the user entered within the form.';
...
$string['backup_block_configuration'] = 'Backup QuickmailSMS Block Level Configuration Settings (Such as [Allow Students to use QuickmailSMS])';
...
$string['eventalternateemailadded'] = 'Alternate Sms added';
