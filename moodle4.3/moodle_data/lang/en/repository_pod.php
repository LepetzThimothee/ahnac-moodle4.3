...
/**
 * Strings for component 'repository_pod', language 'en', version '4.3'.
 *
...
$string['page_size_help'] = 'Number of items per page in file picker, must be the same value than in Pod settings.py file';
