...
/**
 * Strings for component 'pcast', language 'en', version '4.3'.
 *
 * @package     pcast
 * @category    string
...
$string['approvalview'] = 'Approve episodes';
$string['approvethisepisode'] = 'Approve this episode';
...
$string['completiondetail:episodes'] = 'Add {$a} episode(s)';
$string['completionepisodes'] = 'Student must create episodes:';
$string['completionepisodesgroup'] = 'Require episodes';
...
$string['disapprovethisepisode'] = 'Disapprove this episode';
...
$string['editthisepisode'] = 'Edit this episode';
...
$string['eventepisodeapproved'] = 'Episode has been approved';
$string['eventepisodecreated'] = 'Episode has been created';
$string['eventepisodedeleted'] = 'Episode has been deleted';
$string['eventepisodedisapproved'] = 'Episode has been disapproved';
$string['eventepisodeupdated'] = 'Episode has been updated';
$string['eventepisodeviewed'] = 'Episode has been viewed';
$string['eventratingsviewed'] = 'Episode ratings viewed';
$string['eventviewsviewed'] = 'Episode viewers have been viewed';
...
$string['noepisodesposted'] = 'No episodes posted';
...
$string['pcast:approve'] = 'Approve unapproved episodes, or disapprove approved ones';
...
$string['privacy:metadata:core_comments'] = 'Comments made on pcast definitions are stored using core_comment system';
...
$string['privacy:metadata:pcast_episodes:name'] = 'The name of the episode the user added';
$string['privacy:metadata:pcast_episodes:pcastid'] = 'The ID of the pcast activity the user is providing episode for';
$string['privacy:metadata:pcast_episodes:subtitle'] = 'The subtitle of the episode the user added';
...
$string['tagarea_pcast_episodes'] = 'Podcast episodes';
$string['tagsdeleted'] = 'Episode tags have been deleted';
...
$string['viewnewepisodes'] = 'There are {$a} new episodes since you last login';
$string['viewpcast'] = 'View podcast: {$a}';
$string['views'] = 'Views';
$string['viewthisepisode'] = 'Viewing an episode from: {$a}';
$string['viewunapprovedepisodes'] = 'There are {$a} episodes awaiting approval';
