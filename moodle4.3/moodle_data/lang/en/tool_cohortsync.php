...
/**
 * Strings for component 'tool_cohortsync', language 'en', version '4.3'.
 *
...
$string['errorreadingfile'] = 'The file "{$a}" is not readable or does not exist.';
$string['filepathsource'] = 'The path to the source file';
$string['flatfiledelimiter'] = 'Flatfile delimiter';
