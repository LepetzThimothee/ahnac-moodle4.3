...
/**
 * Strings for component 'forumanon', language 'en', version '4.3'.
 *
 * @package     forumanon
 * @category    string
...
$string['anonconditiontext'] = 'By using this forum anonymously, you agree to make no posts in objectionable language or with profane, pornographic, sexually objectionable or defamatory content, or violating applicable law or infringing on the rights of others. To prevent potential abuse, the administrators (but not the other users) may determine the identity of the author of an anonymous post.';
...
$string['blockafter_help'] = 'This setting specifies the maximum number of posts which a user can post in the given time period. Users with the capability mod/forumanon:postwithoutthrottling are exempt from post limits.';
$string['blockperiod'] = 'Time period for blocking';
$string['blockperiod_help'] = 'Students can be blocked from posting more than a given number of posts in a given time period. Users with the capability mod/forumanon:postwithoutthrottling are exempt from post limits.';
...
$string['configlongpost'] = 'Any post over this length (in characters not including HTML) is considered long. Posts displayed on the site front page, social format course pages, or user profiles are shortened to a natural break somewhere between the forumanon_shortpost and forumanon_longpost values.';
...
$string['forum'] = 'Anonymizable forum';
$string['forumanon:addnews'] = 'Add news';
$string['forumanon:createattachment'] = 'Create attachments';
$string['forumanon:deleteanypost'] = 'Delete any posts (anytime)';
$string['forumanon:deleteownpost'] = 'Delete own posts (within deadline)';
$string['forumanon:editanypost'] = 'Edit any post';
$string['forumanon:exportdiscussion'] = 'Export whole discussion';
$string['forumanon:exportownpost'] = 'Export own post';
$string['forumanon:exportpost'] = 'Export post';
$string['forumanon:initialsubscriptions'] = 'Initial subscription';
$string['forumanon:managesubscriptions'] = 'Manage subscriptions';
$string['forumanon:movediscussions'] = 'Move discussions';
$string['forumanon:postwithoutthrottling'] = 'Exempt from post threshold';
$string['forumanon:rate'] = 'Rate posts';
$string['forumanon:replynews'] = 'Reply to news';
$string['forumanon:replypost'] = 'Reply to posts';
$string['forumanon:splitdiscussions'] = 'Split discussions';
$string['forumanon:startdiscussion'] = 'Start new discussions';
$string['forumanon:throttlingapplies'] = 'Throttling applies';
$string['forumanon:viewallratings'] = 'View all raw ratings given by individuals';
$string['forumanon:viewanyrating'] = 'View total ratings that anyone received';
$string['forumanon:viewdiscussion'] = 'View discussions';
$string['forumanon:viewhiddentimedposts'] = 'View hidden timed posts';
$string['forumanon:viewqandawithoutposting'] = 'Always see Q and A posts';
$string['forumanon:viewrating'] = 'View the total rating you received';
$string['forumanon:viewsubscribers'] = 'View subscribers';
...
$string['pluginname'] = 'Anonymizable Forum';
...
$string['warnafter_help'] = 'Students can be warned as they approach the maximum number of posts allowed in a given period. This setting specifies after how many posts they are warned. Users with the capability mod/forumanon:postwithoutthrottling are exempt from post limits.';
