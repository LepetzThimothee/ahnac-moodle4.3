...
/**
 * Strings for component 'availability_integrityadvocate', language 'en', version '4.3'.
 *
...
$string['option_invalid'] = 'must have IA status invalid';
$string['option_valid'] = 'must have IA status valid';
