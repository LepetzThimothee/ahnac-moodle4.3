...
/**
 * Strings for component 'repository_xpert_url', language 'en', version '4.3'.
 *
...
$string['authorurl'] = 'Author\'s URL';
$string['cachedef_options'] = 'Options used to generate copyright notice';
...
$string['configplugin'] = 'Xpert URL repository type configuration';
$string['copyrightyear'] = 'Copyright year';
...
$string['pluginname'] = 'URL downloader (Xpert)';
$string['privacy:metadata'] = 'The Xpert URL downloader repository does not store or transmit any personal information.';
...
$string['url'] = 'URL';
$string['url:view'] = 'Use Xpert URL downloader in file picker';
...
$string['xpert_url:debug'] = 'Debug URL Downloader (Xpert) repository';
$string['xpert_url:view'] = 'Use URL Downloader (Xpert) repository in file picker';
