...
/**
 * Strings for component 'plagiarism_unicheck', language 'en', version '4.3'.
 *
...
$string['api_region'] = 'Unicheck API region';
...
$string['debugging:batchoperations:batchoperationsdescription'] = 'With selected...';
$string['debugging:batchoperations:chooseoperation'] = 'Choose operation';
...
$string['debugging:batchoperations:delete'] = 'Delete';
$string['debugging:batchoperations:filesnotresubmitted'] = 'There are no matching files to resubmit.';
$string['debugging:batchoperations:nofilesselected'] = 'No files selected';
$string['debugging:batchoperations:resubmit'] = 'Resubmit';
$string['debugging:batchoperations:selectfile'] = 'Select {$a}';
$string['debugging:filter:button:reset'] = 'Reset filters';
$string['debugging:filter:button:submit'] = 'Apply filters';
$string['debugging:filter:errorcode'] = 'Error code';
$string['debugging:filter:errormessage'] = 'Error message';
$string['debugging:filter:perpage'] = 'Per page';
$string['debugging:filter:timesubmittedfrom'] = 'Submitted from';
$string['debugging:filter:timesubmittedto'] = 'Submitted to';
$string['debugging:filter:title'] = 'Filter options';
$string['debugging:statustable:checkcallback_url'] = 'Test Moodle Server callback URL availability';
$string['debugging:statustable:checkcallback_urloauth'] = 'Without OAuth verification';
$string['debugging:statustable:checklicense'] = 'License status';
$string['debugging:statustable:checkmoodle_adhoc'] = 'Analyze Moodle Adhoc table';
$string['debugging:statustable:checkmoodle_adhocbigqueue'] = 'A large number of adhoc tasks in queue. Need run cron more often';
$string['debugging:statustable:checkmoodle_adhoclastexecution'] = 'Last cron execution more than {$a} min ago';
$string['debugging:statustable:checkmoodle_adhocslowly'] = 'Slow adhoc task processing';
$string['debugging:statustable:checkunicheck_api_key'] = 'Test Unicheck API Key';
$string['debugging:statustable:checkunicheck_host'] = 'Test Unicheck Host availability';
$string['debugging:statustable:fixtest'] = 'Fix check {$a} first';
$string['debugging:statustable:header'] = 'Unicheck status checks';
$string['debugging:statustable:recheck'] = 'Recheck';
$string['debugging:statustable:recheckdescription'] = 'Availability checks result stored in cache';
...
$string['debugging:table:possibleoperations'] = 'Possible operations';
...
$string['exclude_citations'] = 'Exclude citations';
$string['exclude_citations_help'] = 'Enable this option to identify and exclude citations. Unicheck identifies citations according to rules described in APA, MLA, Chicago, Turabian, Harvard guides. Citations will be marked with blue color. Such items will be excluded from total similarity score.';
$string['exclude_references'] = 'Exclude references';
$string['exclude_references_help'] = 'Enable this option to identify and exclude references. References will be marked with violet color. Such items will be excluded from total similarity score.';
...
$string['plagiarism_run_error'] = 'The file(s) did not send for plagiarism scan';
...
$string['setting:apicallbackoauthcheck'] = 'Check API callbacks using OAuth';
$string['setting:apicallbackoauthcheck_help'] = 'The result from Unicheck is signed using OAuth protocol so that the plugin can verify the request.';
...
$string['ufiles'] = 'Submitted Files';
$string['ui:cheatingtooltip'] = 'Text modifications detected. View the Modifind tab in similarity report.';
...
$string['unicheck:changeexcludecitationssetting'] = 'Allow enable/disable exclude citations';
$string['unicheck:changeexcludereferencessetting'] = 'Allow enable/disable exclude references';
