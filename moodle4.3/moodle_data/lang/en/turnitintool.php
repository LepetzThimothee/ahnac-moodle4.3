...
/**
 * Strings for component 'turnitintool', language 'en', version '4.3'.
 *
...
$string['add_turnitintool'] = 'Add Turnitin assignment';
...
$string['delete_turnitintool'] = 'Delete Turnitin assignment';
...
$string['filenotfound'] = 'File for submission was not found on Moodle server, it may be corrupt or missing. This Turnitin submission attempt will be deleted.';
$string['files'] = 'Files';
...
$string['list_turnitintool'] = 'List Turnitin assignments';
$string['marks'] = 'Marks';
...
$string['nonorsubmission'] = 'Non OR Submission';
...
$string['pseudolastnamegen_desc'] = 'If set to yes and the pseudo lastname is set to a user profile field, thenthe field will be automatically populated with a unique identifier.';
...
$string['turnitinapiurl_desc'] = '<b>[Required]</b><br />Enter the Turnitin API URL<br /><i>(e.g. https://api.turnitin.com/api.asp)<br />(e.g. https://api.turnitinuk.com/api.asp)</i>';
...
$string['update_turnitintool'] = 'Update Turnitin assignment';
...
$string['view'] = 'View';
$string['view_turnitintool'] = 'View Turnitin assignment';
