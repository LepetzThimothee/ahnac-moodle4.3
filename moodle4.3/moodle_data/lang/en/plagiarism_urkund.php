...
/**
 * Strings for component 'plagiarism_urkund', language 'en', version '4.3'.
 *
...
$string['assignforcedisclosureagreement'] = 'Force agreement of Ouriginal disclosure';
$string['assignforcedisclosureagreement_desc'] = 'If enabled, the user will be forced to indicate they agree to having their assignment sent to Ouriginal before being allowed to upload their assignment.';
...
$string['assignpreventexistingenable'] = 'Prevent enabling when assignments exist';
$string['assignpreventexistingenable_desc'] = 'Prevent non-admin staff from enabling Ouriginal when the assignment already contains submissions.';
$string['assignsettings'] = 'Assign settings';
$string['attempts'] = 'Attempts made';
$string['cannotsubmitonbehalf'] = 'Students in this assignment are required to agree to the Ouriginal submission statement prior to submission, you cannot do this on their behalf';
...
$string['iagreetostatement'] = 'I agree to having my assignment sent to Ouriginal for processing.';
$string['id'] = 'ID';
$string['identifier'] = 'Identifier';
$string['idisagree'] = 'Cancel';
...
$string['submissionagreement'] = 'Submission agreement';
