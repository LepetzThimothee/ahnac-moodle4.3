...
/**
 * Strings for component 'coursebadges', language 'en', version '4.3'.
 *
...
$string['atleastonebadgerequired'] = 'You must create at least one badge for this course in order for this activity to function properly : <a href="{$a->linkbadges}">Manage badges</a>';
...
$string['nobadgeyet'] = 'There is no badge for this course at this moment. Please come back later : <a href="{$a->linkcourse}">Back to the course</a>';
...
$string['pleasesetonebadgeor'] = 'Please create at least one badge for this course to be able to configure this activity properly.
<ul>
