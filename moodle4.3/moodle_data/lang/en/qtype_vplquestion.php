...
/**
 * Strings for component 'qtype_vplquestion', language 'en', version '4.3'.
 *
...
$string['cfg:evaluationtries'] = 'Number of internal tries for evaluation';
$string['cfg:evaluationtries_help'] = 'If set to more than 1, the server will try several times to evaluate question if evaluation fails (as evaluation errors may occur).';
