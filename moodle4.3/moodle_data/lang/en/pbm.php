...
/**
 * Strings for component 'pbm', language 'en', version '4.3'.
 *
 * @package     pbm
 * @category    string
...
$string['default_server'] = 'Default PBM Server';
$string['default_server_description'] = 'This will be the default server for new pbm instances from which they will retrieve data.';
$string['desc'] = 'descending';
$string['direct_link'] = 'View this list directly on';
$string['docs_downloadable'] = 'Downloadable Documents?';
...
$string['pbm_help'] = 'PBM is the PUMA/BibSonomy plugin for Moodle. It helps you to publish publication lists from the Publication Management System PUMA or BibSonomy within a Moodle course.';
...
$string['server'] = 'Insert the URL of BibSonomy or PUMA server.';
$string['server_help'] = 'The default server for new pbm instances can be set under: Site administration -> Plugins -> Activity modules -> PUMA/BibSonomy Module.';
$string['sort'] = 'Sorting and Ordering';
$string['sort_by'] = 'Sorting by';
$string['sort_order'] = 'Sorting order';
$string['source_id'] = 'Id of user, group or viewable source';
$string['source_id_help'] = 'The name of a Bibsonomy user or group e.g..';
$string['source_id_type'] = 'Select Content Source';
$string['tags'] = 'Tags';
