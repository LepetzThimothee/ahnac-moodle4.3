...
/**
 * Strings for component 'local_yukaltura', language 'en', version '4.3'.
 *
...
$string['privacy:metadata'] = 'The YU Kaltura Media Local Libraries does not store any personal data.';
...
$string['rootcategory_desc'] = '<p>Set the root category path to create a category/sub-category structure, in the KMC, to organize all of the Moodle user categories. For example: <b>Sites>My Moodle Site</b>, will create a KMC category called "Sites" and a sub category called "My Moodle Site".  All of Moodle user categories will created as a sub directories of "My Moodle Site".</p>';
