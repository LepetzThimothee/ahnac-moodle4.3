...
/**
 * Strings for component 'block_culactivity_stream', language 'en', version '4.3'.
 *
...
$string['plural'] = 's';
$string['privacy:metadata'] = 'The CUL Activity Feed block only displays existing message data.';
