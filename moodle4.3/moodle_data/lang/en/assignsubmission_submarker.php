...
/**
 * Strings for component 'assignsubmission_submarker', language 'en', version '4.3'.
 *
...
$string['default_help'] = 'If set, this submission plugin will be enabled by default for all new assignments.';
