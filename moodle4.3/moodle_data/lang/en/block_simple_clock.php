...
/**
 * Strings for component 'block_simple_clock', language 'en', version '4.3'.
 *
...
$string['config_day_help'] = '<p>Showing the day name adds additional information for students who may be in a timezone a day earlier or later.</p>';
$string['config_header'] = 'Show header';
$string['config_header_help'] = '<p>With this setting, you can control whether the block header, including the title, will be shown.</p>
...
$string['config_icons_help'] = '<p>With this setting, you can control whether icons are shown next to each clock label.</p>
...
$string['config_seconds_help'] = '<p>Showing seconds will show users the time including seconds on all visible clocks.</p>
