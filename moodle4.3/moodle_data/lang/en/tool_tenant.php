...
/**
 * Strings for component 'tool_tenant', language 'en', version '4.3'.
 *
 * @package     tool_tenant
 * @category    string
...
$string['brandgraytones'] = 'Match gray tones hue with primary colour';
$string['brandgraytones_help'] = 'Select a brand colour, and a range of complementary colours will be generated automatically. These colours will highlight different parts of the user interface such as links, buttons, etc.';
$string['branding'] = 'Branding';
$string['buttoncolour'] = 'Primary button colour';
$string['buttoncolour_help'] = 'Background colour of primary buttons';
...
$string['modurl:configtenantdata'] = 'Enable if you want to include tenant ID and ID number in list of available parameter variables.';
$string['modurl:tenantdata'] = 'Tenant data';
$string['modurl:tenantdatadesc'] = 'Tenant data can be added to URL activities';
$string['modurl:tenantid'] = 'Tenant ID';
$string['modurl:tenantidnumber'] = 'Tenant ID number';
...
$string['navbarcolour'] = 'Navigation bar colour';
$string['navbarcolour_help'] = 'Background colour of the top navigation bar';
...
$string['supportavailabilitydescription'] = 'The support availability is configured at the site level by default. By selecting \'Override\' a new availability can be provided';
$string['supportemail'] = 'Support email';
$string['supportemaildescription'] = 'The support email is configured at the site level by default. By selecting \'Override\' a new email can be provided';
$string['supportname'] = 'Support name';
$string['supportnamedescription'] = 'The support name is configured at the site level by default. By selecting \'Override\' a new name can be provided';
$string['supportpage'] = 'Link to \'Contact site support\'';
...
$string['tenant:managethemeadvanced'] = 'Manage advanced theme settings for the current tenant';
...
$string['usersallocatedtotenant'] = 'Users allocated to tenant';
...
$string['usersnotallocatedtotenant'] = 'Users not allocated to tenant';
