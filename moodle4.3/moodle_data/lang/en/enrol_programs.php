...
/**
 * Strings for component 'enrol_programs', language 'en', version '4.3'.
 *
...
$string['source_approval_notification_approval_request_body'] = 'User {$a->user_fullname} requested access to program "{$a->program_fullname}".';
