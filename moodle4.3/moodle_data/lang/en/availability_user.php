...
/**
 * Strings for component 'availability_user', language 'en', version '4.3'.
 *
...
$string['description'] = 'Restrict access to a certain enrolled user';
$string['missing_user'] = 'Not enrolled user';
$string['pluginname'] = 'Restriction by user';
