...
/**
 * Strings for component 'tool_dynamicrule', language 'en', version '4.3'.
 *
...
$string['conditioncoursecompletedgradeany'] = 'Any course grade';
$string['conditioncoursecompletedgradegreaterthan'] = 'Course grade greater than {$a}%';
$string['conditioncoursecompletedgradelessthan'] = 'Course grade less than {$a}%';
$string['conditioncoursecompletedgraderange'] = 'Course grade between {$a->value}% and {$a->value2}%';
...
$string['conditionuserfirstlogindescriptionever'] = 'Users who have first logged in at least once';
$string['conditionuserfirstlogindescriptioninlast'] = 'Users who have first logged in the last {$a}';
$string['conditionuserfirstlogindescriptionover'] = 'Users who have first logged in between {$a->startdate} to {$a->enddate}';
...
$string['confirmduplicateruleconflicts'] = 'The rule contains entities that can\'t be used in non-shared rule and will be omitted:';
...
$string['coursegrade_help'] = 'Select a percentage to match users who have achieved a course grade within the specified range. Grade is rounded to 5 decimal points. Greater and less comparison is strict.';
...
$string['errorinvaliddates'] = 'Invalid start and end dates';
$string['errorinvalidenrolmentmethod'] = 'This course does not have selected enrolment method or it is not enabled';
$string['errorinvalidlearningplan'] = 'Invalid learning plan';
$string['errorinvalidoperator'] = 'Invalid operator.';
$string['errorinvalidsubject'] = 'Invalid notification subject';
$string['errorinvaliduserfirstlogin'] = 'Invalid first login date';
$string['errorinvaliduserfirstlogintype'] = 'Invalid first login type';
...
$string['errorinvalidvalue'] = 'Invalid value';
$string['errornopermissionissuecertificate'] = 'You don\'t have permission to issue this certificate';
$string['eventconditionadded'] = 'Dynamic rule condition added';
$string['eventconditiondeleted'] = 'Dynamic rule condition deleted';
$string['eventconditionupdated'] = 'Dynamic rule condition updated';
$string['eventoutcomeadded'] = 'Dynamic rule action added';
$string['eventoutcomedeleted'] = 'Dynamic rule action deleted';
$string['eventoutcomeupdated'] = 'Dynamic rule action updated';
$string['eventrulearchived'] = 'Dynamic rule archived';
$string['eventrulecreated'] = 'Dynamic rule created';
$string['eventruledeleted'] = 'Dynamic rule deleted';
$string['eventruleunarchived'] = 'Dynamic rule unarchived';
$string['eventruleupdated'] = 'Dynamic rule updated';
$string['ever'] = 'ever';
...
$string['firstlogin'] = 'The user\'s first login was';
$string['firstlogin_help'] = 'You can select users who first logged in during a set window of time or in a period relative to the current date, as well as users who first logged in at any time or have never logged in .';
...
$string['outcomelearningplan'] = 'Assign learning plan';
$string['outcomelearningplanbroken'] = 'Learning plan template with ID \'{$a}\' does not exist.';
$string['outcomelearningplandescription'] = 'Assign learning plan template \'{$a}\' to users';
$string['outcomelearningplanunassign'] = 'Un-assign learning plan';
$string['outcomelearningplanunassigndescription'] = 'Un-assign learning plan template \'{$a}\' from user';
...
$string['selectbadge_help'] = 'Only site badges using exclusively the \'manual issue by role\' criteria are eligible for awarding by Dynamic Rules.';
...
$string['selectlearningplan'] = 'Select learning plan';
$string['selectlearningplan_help'] = 'Select learning plan template';
