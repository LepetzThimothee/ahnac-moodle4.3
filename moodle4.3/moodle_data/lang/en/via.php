...
/**
 * Strings for component 'via', language 'en', version '4.3'.
 *
 * @package     via
 * @category    string
...
$string['apiportal'] = 'Lära Portal';
$string['apiportalsetting'] = 'API identifier of the associated portal in Lära. The redirects to the activities will be based on the URL of this portal.';
...
$string['df_header_option'] = 'Options';
$string['df_header_size'] = 'Size';
$string['df_header_title'] = 'Title';
$string['df_header_type'] = 'Type';
$string['df_header_view'] = 'View';
$string['df_header_visibility'] = 'Visibility';
...
$string['noticeemail'] = 'Hello {$a->username},
...
$string['notificationemail'] = 'Hello {$a->username},
...
$string['resource_audio'] = 'Audio';
$string['resource_document'] = 'Document';
$string['resource_formative_quiz'] = 'Formative quiz';
$string['resource_image'] = 'Image';
$string['resource_quiz'] = 'Quiz';
$string['resource_survey'] = 'Survey';
$string['resource_url'] = 'URL';
$string['resource_visibility_0'] = 'Administrators';
$string['resource_visibility_1'] = 'All participants';
$string['resource_whiteboard'] = 'Whiteboard';
$string['resources'] = 'Resources';
$string['resources_access_result'] = 'View results';
$string['resources_confirmdelete'] = 'Are you sure you want to remove the resource "{$a}"?';
$string['resources_delete_success'] = 'Resource "{$a}" has been successfully removed';
$string['resources_document_warning'] = 'Warning! If you remove this resource while it contains annotations, these will be deleted at the same time.';
$string['resources_downloadable'] = 'Make downloadable';
$string['resources_downloadable_subroom'] = 'Make downloadable in activity';
$string['resources_edit'] = 'Edit resource';
$string['resources_edit_success'] = 'Resource "{$a}" has been successfully edited';
$string['resources_mainroom'] = 'Main room';
$string['resources_remove'] = 'Remove resource';
$string['resources_settings'] = 'Settings';
$string['resources_survey_visibility_warning'] = 'If you enable this option, participants will only be able to view their results. Administrators always have access to all quizzes and surveys results.';
$string['resources_survey_warning'] = 'Warning! If you remove this resource, the results of all assignments made in this activity will be deleted.';
$string['resources_visibility'] = 'Resource visibility';
$string['resources_visibility_edit'] = 'Manage visibility';
$string['resources_visibility_public'] = 'Make the resource visible to all participants';
$string['return'] = 'Back';
