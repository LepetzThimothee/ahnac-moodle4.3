...
/**
 * Strings for component 'tool_certification', language 'en', version '4.3'.
 *
...
$string['certificationnamewitheditlink'] = 'Certification name with link to edit';
...
$string['programchangewarning'] = 'Users who are currently taking this program will not be reallocated automatically. This can be done manually on a per-user basis. The status of users who have already completed the program, or those who were manually marked as certified, will not change, but they will be unallocated from the old program and no longer see it on their courses listing page.';
