...
/**
 * Strings for component 'local_o365', language 'en', version '4.3'.
 *
 * @package     local_o365
 * @category    string
...
$string['courserequest_customrequestnote'] = '| This request is made from the Microsoft Teams course request page and will be connected to Team: "{$a->name}" with URL {$a->url} on approval.';
