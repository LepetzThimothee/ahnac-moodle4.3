...
/**
 * Strings for component 'block_stash', language 'en', version '4.3'.
 *
 * @package     block_stash
 * @category    string
...
$string['quizitemsremoved'] = 'The following items were removed:';
$string['quizname'] = 'Quiz name';
$string['quiznotenoughitems'] = 'You do not have enough items to take this quiz. You need the following items:';
