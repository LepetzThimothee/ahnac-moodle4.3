...
/**
 * Strings for component 'flax', language 'en', version '4.3'.
 *
 * @package     flax
 * @category    string
...
$string['exercisemode_help'] = 'This option specifies whether the exercise is going to be graded.';
...
$string['grade'] = 'Grade';
$string['gradedexercise'] = 'Exercise graded';
$string['gradeno'] = 'No grade';
...
$string['notgradedexercise'] = 'Exercise not graded';
