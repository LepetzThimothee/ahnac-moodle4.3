...
/**
 * Strings for component 'auth_onelogin_saml', language 'en', version '4.3'.
 *
...
$string['auth_onelogin_saml_saml_trigger_user_create_update_events'] = 'Trigger events';
$string['auth_onelogin_saml_saml_trigger_user_create_update_events_description'] = 'If enabled, user_created and user_updated events will be triggered when the extension create or update a user.';
...
$string['auth_onelogin_samltitle'] = 'OneLogin SAML';
