...
/**
 * Strings for component 'gradingform_offline', language 'en', version '4.3'.
 *
...
$string['definerubric'] = 'Define Offline Rubric';
...
$string['export'] = 'Export as CSV';
$string['gradingof'] = '{$a} grading';
$string['import'] = 'Import CSV:';
...
$string['noerrors'] = 'No errors were detected during data import.';
$string['nofile'] = 'No File Detected';
$string['notset'] = 'Not set';
$string['nullfields'] = 'Null field/s were detected and omitted during import in following criteria:';
...
$string['success'] = 'Successfully Imported Data from File';
$string['template_link'] = 'Template File To Create Rubric Offline:';
$string['unevenrows'] = 'Uneven number of rows in file (Improper File Format). File not Imported.';
