...
/**
 * Strings for component 'block_checklist', language 'en', version '4.3'.
 *
...
$string['checklist:addinstance'] = 'Add new Checklist block';
$string['checklist:myaddinstance'] = 'Add Checklist block to My Moodle page';
