...
/**
 * Strings for component 'block_via_permanent', language 'en', version '4.3'.
 *
...
$string['blockstring'] = 'Via permanent activities';
...
$string['via_permanent:addinstance'] = 'Add a new block which displays all the Via permanent activities';
$string['via_permanent:myaddinstance'] = 'Add a new simple HTML block to the My Moodle page';
