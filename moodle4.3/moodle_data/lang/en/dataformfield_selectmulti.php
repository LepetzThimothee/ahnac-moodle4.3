...
/**
 * Strings for component 'dataformfield_selectmulti', language 'en', version '4.3'.
 *
...
$string['comma'] = 'Comma';
$string['commaandspace'] = 'Comma and space';
$string['newline'] = 'New line';
$string['options'] = 'Options';
$string['optionsdefault'] = 'Default values';
$string['optionsseparator'] = 'Options separator';
