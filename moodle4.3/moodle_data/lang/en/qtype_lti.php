...
/**
 * Strings for component 'qtype_lti', language 'en', version '4.3'.
 *
 * @package     qtype_lti
 * @category    string
...
$string['cannot_add'] = 'You may not add a new tool.';
...
$string['checkduplicateltiurl'] = 'Check duplicate LTI URLs';
$string['checkduplicateltiurl_help'] = 'While creating a notification is displayed when the entered LTI URL is already used somewhere else in the system.';
...
$string['manage_tool_proxies'] = 'Manage LTI qtype external tool Proxies';
...
$string['pluginname'] = 'External question type (ETH)';
$string['pluginname_help'] = 'With External question types questions or tasks from other tools are included in Moodle.';
...
$string['pluginnamesummary'] = 'With the External question type, one can connect to a question or task created in a different tool.';
...
$string['tool_config_duplicate_url'] = 'This tool URL is already used in another question. Are you sure you want to use this tool URL anyway? Note that a tool URL used more than once can cause problems.';
$string['tool_config_not_found'] = 'Tool configuration not found for this URL.';
$string['tool_config_not_valid'] = 'Configuration for "{$a->toolname}" was detected. However, this configuration requires "{$a->verifytoolurl}" as part of the tool URL.';
...
$string['unlockabletoolurl'] = 'Unlockable tool URL';
$string['unlockabletoolurl_edit'] = 'Unlock tool URL';
$string['unlockabletoolurl_edit_help'] = 'Unlocks the Tool URL for editing';
$string['unlockabletoolurl_help'] = 'Once a question has been created, the tool URL can no longer be changed by default. If this option is activated however, it is possible to unlock the tool URL via a checkbox while editing a question. This checkbox is displayed by default next to the tool URL input field. If "Advanced" is activated, it will be displayed via "Show more...".';
$string['update'] = 'Update';
$string['useraccountinformation'] = 'User account information';
$string['userfield_optional'] = 'Additional (optional) profilefield';
$string['userfield_optional_help'] = 'Select additional user profile field for external LTI-Provider. (Optional user fields are already existing with a fresh moodle installation)';
$string['userfield_optional_short'] = 'Optional profilefield';
$string['userfield_other'] = 'Additional (other) profilefield';
$string['userfield_other_help'] = 'Select additional user profile field for external LTI-Provider';
$string['userfield_other_short'] = 'Other profilefield';
...
$string['verifyltiurl'] = 'Tool URL verification';
$string['verifyltiurl_help'] = 'When this configuration is recognized while creating a question, the entered tool URL is checked for compliance with this expression. If this field remains empty (default), no check will take place.';
$string['viewsubmissions'] = 'View submissions and grading screen';
$string['whichadditionalfield'] = 'Send extra field to LTI-provider';
$string['whichadditionalfield_help'] = 'Choose one of the two fields above to be sent as extra field to the LTI Provider.';
