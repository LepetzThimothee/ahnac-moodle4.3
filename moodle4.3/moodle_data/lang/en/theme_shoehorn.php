...
/**
 * Strings for component 'theme_shoehorn', language 'en', version '4.3'.
 *
...
$string['loginmessage_desc'] = 'The brief login message to show.  Leave blank to use the \'theloginmessage\' language string contained in the language file.  Where you can make use of Moodle multi-language functionality.';
...
$string['pageheadertextcolour'] = 'Page header text colour';
$string['pageheadertextcolourdesc'] = 'Page header text colour.  Has no effect when there is a background image.';
