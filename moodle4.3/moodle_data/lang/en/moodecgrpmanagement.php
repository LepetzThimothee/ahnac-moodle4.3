...
/**
 * Strings for component 'moodecgrpmanagement', language 'en', version '4.3'.
 *
...
$string['activategooglemap'] = 'Activate Google Maps';
$string['add'] = 'Add';
...
$string['displaygroupmap'] = 'Display group map';
...
$string['enrollementKeyFormoodecgrpmanagement'] = 'Enrollement key for the group';
$string['event:answered'] = 'Choice made';
$string['event:answered_desc'] = 'The user with id \'{$a->userid}\' has chosen a group in the group management with the course module id \'{$a->contextinstanceid}\'.';
$string['event:removed'] = 'Choice removed';
$string['event:removed_desc'] = 'The user with id \'{$a->userid}\' has removed his choice in the group management with the course module id \'{$a->contextinstanceid}\'.';
$string['event:reportviewed'] = 'Report viewed';
$string['event:reportviewed_desc'] = 'The user with id \'{$a->userid}\' has viewed the report for the group management activity with the course module id \'{$a->contextinstanceid}\'.';
...
$string['filtredFromString'] = '(filtered from';
...
$string['groupsfrozen'] = 'The groups have been frozen';
$string['groupsfrozenaftertime'] = 'The groups are frozen since';
$string['groupsheader'] = 'Groups';
$string['groupvideo'] = 'Iframe video';
$string['grpcountry'] = 'Country';
$string['grpmembernbr'] = 'Number of members';
...
$string['limitmaxusersingroups'] = 'Limit the number of students per group';
...
$string['modulename_help'] = 'The Group Management module allows students to create and enrol themselves in a group within a course. The teacher configure what the students can do and which information will be display to present a Moodec group.';
$string['modulenameplural'] = 'Groups Management';
$string['moodecgrpmanagement:addinstance'] = 'Add a new group management activity';
$string['moodecgrpmanagement:choose'] = 'Record a choice';
$string['moodecgrpmanagement:deleteresponses'] = 'Delete responses';
$string['moodecgrpmanagement:downloadresponses'] = 'Download responses';
$string['moodecgrpmanagement:managegroups'] = 'Manage Groups';
$string['moodecgrpmanagement:readresponses'] = 'Read responses';
$string['moodecgrpmanagementclose'] = 'Until';
$string['moodecgrpmanagementfull'] = 'This group management is full and there are no available places';
$string['moodecgrpmanagementname'] = 'Group management name';
$string['moodecgrpmanagementopen'] = 'Open';
$string['moodecgrpmanagementoptions'] = 'Choice options';
$string['moodecgrpmanagementoptions_help'] = 'Here is where you specify the options that participants have to choose from.
...
$string['nogroupbtnname'] = 'Leave all groups';
...
$string['ofString'] = 'of';
$string['onegroupbtnname'] = 'Join group';
$string['option'] = 'Group';
$string['page-mod-choice-x'] = 'Any Group management module page';
...
$string['pluginname'] = 'Group Management';
...
$string['removemymoodecgrpmanagement'] = 'Remove my choice';
$string['removeresponses'] = 'Remove all responses';
$string['requestEnrollementKeyFrom'] = 'Request the enrollement key from';
$string['requestEnrollementKeyFromShort'] = 'Request the key';
$string['resetgrpmanagement'] = 'Reset Group Member Choices';
$string['responses'] = 'Responses';
$string['responsesto'] = 'Responses to {$a}';
$string['samegroupused'] = 'The same group can not be used several times.';
$string['savemymoodecgrpmanagement'] = 'Save my choice';
...
$string['toString'] = 'to';
$string['totalRecordsString'] = 'total records)';
$string['userimage'] = 'Picture';
$string['userlocation'] = 'Origin';
