...
/**
 * Strings for component 'tinymce_clozeeditor', language 'en', version '4.3'.
 *
...
$string['clozeeditor:encode'] = 'Encode';
$string['clozeeditor:output'] = 'Output';
$string['clozeeditor:titleclozeeditor'] = 'Embedded answers (CLOZE) item';
