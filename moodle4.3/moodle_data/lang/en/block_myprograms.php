...
/**
 * Strings for component 'block_myprograms', language 'en', version '4.3'.
 *
...
$string['error:cannotaccessprogram'] = 'You do not have access to this program';
$string['error:coursemisconfigured'] = 'Course is misconfigured';
$string['filterprograms'] = 'Filter my programs';
...
$string['noprograms'] = 'There is no program information to show.';
$string['noresult'] = 'Your search didn\'t match any programs.';
$string['noresultdescription'] = 'Try adjusting your filters.';
$string['pluginname'] = 'My programs';
$string['privacy:metadata'] = 'My programs block does not store data itself.';
$string['programdetail'] = 'Program Detail';
...
$string['programstatusall'] = 'All';
$string['programstatusallactive'] = 'All Active';
$string['programstatuscompleted'] = 'Completed';
$string['programstatusfailed'] = 'Failed';
$string['programstatusopen'] = 'Open';
$string['programstatusoverdue'] = 'Overdue';
