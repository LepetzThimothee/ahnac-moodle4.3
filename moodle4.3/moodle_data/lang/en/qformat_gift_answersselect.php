...
/**
 * Strings for component 'qformat_gift_answersselect', language 'en', version '4.3'.
 *
...
$string['pluginname'] = 'GIFT to Random select answers format';
$string['pluginname_help'] = 'GIFT to Random select answers format enables Random select answers to be imported via text file.';
$string['pluginname_link'] = 'qformat/gift_to_answersselect';
$string['privacy:metadata'] = 'GIFT to Random select answers format plugin does not store any personal data.';
