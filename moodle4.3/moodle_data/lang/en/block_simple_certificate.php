...
/**
 * Strings for component 'block_simple_certificate', language 'en', version '4.3'.
 *
...
$string['numcertsshow_help'] = 'Number of courses, with issued certificates, to show in block, 0 means all';
