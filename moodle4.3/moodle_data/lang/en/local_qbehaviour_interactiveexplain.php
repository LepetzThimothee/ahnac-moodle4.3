...
/**
 * Strings for component 'local_qbehaviour_interactiveexplain', language 'en', version '4.3'.
 *
...
$string['privacy:metadata'] = 'The Interactive with explanation question behaviour  settings plugin does not store any personal data.';
