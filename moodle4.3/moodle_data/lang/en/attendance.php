...
/**
 * Strings for component 'attendance', language 'en', version '4.3'.
 *
 * @package     attendance
 * @category    string
...
$string['error:usernotfound'] = 'A user with the {$a->userfield} set to {$a->extuser} could not be found in this course';
