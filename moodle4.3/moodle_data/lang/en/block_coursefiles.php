...
/**
 * Strings for component 'block_coursefiles', language 'en', version '4.3'.
 *
...
$string['coursefilesusagereport'] = 'Course file usage report';
$string['filesize'] = 'File size';
$string['nofilesoncourse'] = 'No files found on course';
$string['pluginname'] = 'Course files';
$string['timecreated'] = 'Time created';
$string['topfive'] = 'Top five files';
$string['totalfilesize'] = 'Total file size: {$a}';
