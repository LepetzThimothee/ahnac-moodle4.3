...
/**
 * Strings for component 'theme_snap', language 'en', version '4.3'.
 *
 * @package     theme_snap
 * @category    string
...
$string['behavior_mod_page'] = 'Open page resource activity on the same view';
$string['behavior_mod_page_description'] = 'If enabled, page resource content will be displayed inside the same page, course or front page. If the page content includes videos, this setting significantly decreases course page load times.';
...
$string['personalmenuandsnapfeeds'] = 'Personal menu and Snap feeds';
...
$string['summarylabel'] = 'Section summary';
