...
/**
 * Strings for component 'atto_pastespecial', language 'en', version '4.3'.
 *
...
$string['clickthebutton'] = '4. Click the "Complete paste" button, or use Ctrl+Shift+Enter.';
