...
/**
 * Strings for component 'openmeetings', language 'en', version '4.3'.
 *
...
$string['Moderation_TYPE_1'] = 'Participants need to wait till the teacher enters the room';
...
$string['recordings_search'] = 'Please search the recording to show';
$string['recordings_show'] = 'Available Recordings to Show';
