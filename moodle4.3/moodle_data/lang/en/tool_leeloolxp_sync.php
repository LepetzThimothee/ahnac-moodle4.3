...
/**
 * Strings for component 'tool_leeloolxp_sync', language 'en', version '4.3'.
 *
...
$string['add'] = 'Add';
$string['backtocourse'] = 'Back to courses list';
$string['cannotundo'] = 'You can’t undo this.';
$string['close'] = 'Close';
$string['course_exists'] = 'This course\'s sort name or id number already exist in Leeloo.';
$string['datesychronizationed_success'] = 'Date sychronizationed successfully.';
$string['edit'] = 'Edit';
$string['invalidsynclicensekey'] = 'Invalid license key';
$string['is_syced'] = 'Synced?';
$string['leeloolxp_sync'] = 'Sync activities/resources/quizzes with Leeloo LXP';
$string['leeloolxp_sync_settings'] = 'Leeloo LXP synchronizer';
$string['leeloolxp_synclicensekey'] = 'License key';
$string['leeloolxp_synclicensekey_help'] = 'License key';
$string['lxpartracker'] = 'LeelooLXP Activity Tracker';
$string['lxpquiztracker'] = 'LeelooLXP Quiz Tracker';
$string['name'] = 'Name';
$string['no'] = 'No';
$string['pluginname'] = 'Sync activities/resources/quizzes with Leeloo LXP';
...
$string['privacy:metadata:leeloolxp_sync'] = 'In order to integrate with Leeloo LXP, some user
data need to be sent to the Leeloo LXP client application (remote system).';
...
$string['resychronizationed_success'] = 'Resychronizationed successfully.';
$string['resync'] = 'Resync';
$string['section'] = 'Section';
$string['selectall'] = 'Select all';
$string['sure_not_needdata'] = 'I don’t need this data anymore, and never will';
$string['sure_unsync_ar'] = 'Are you sure you want to unsync this Activity/Resourse?';
$string['sychronizationed_cat_not_found'] = 'No category found to be synced.';
$string['sychronizationed_success'] = 'Sychronizationed successfully.';
$string['topic'] = 'Topic';
$string['unsychronizationed_success'] = 'Unsychronizationed successfully.';
$string['unsync'] = 'Unsync';
$string['unsync_course'] = 'Are you sure you want to unsync this course?';
$string['unsync_course_warning'] = 'If you do, all users tracking data in the course will be lost!';
$string['unsync_warning_users'] = 'If you do, all users tracking data in the Activity/Resourse will be lost!';
$string['yes'] = 'Yes';
$string['yessure'] = 'Yes, I’m sure';
