...
/**
 * Strings for component 'block_notifications', language 'en', version '4.3'.
 *
...
$string['email'] = 'e-mail';
$string['email_icon_tooltip'] = 'The notification of new content via e-mail is enabled.';
...
$string['history_length'] = 'Notified events history length';
$string['history_length_explanation'] = 'This is the number limit of the notified events. It is the history log length.';
...
$string['notify'] = 'Block Notifications Task';
...
$string['sms_icon_tooltip'] = 'The notification of new content via SMS is enabled.';
