...
/**
 * Strings for component 'block_moodletxt', language 'en', version '4.3'.
 *
...
$string['adminaccountctxtinstance'] = 'ConnectTxt instance';
$string['adminaccountfragloading'] = 'Updating account...';
$string['adminaccountfragneverupdated'] = 'Never Updated';
$string['adminaccountintropara1'] = 'This page displays details about the ConnectTxt server used by moodletxt.  To enable or disable inbound/outbound access on a given account, find the account\'s entry in the table below, and click the appropriate icon.  This will toggle access as required.';
...
$string['adminaccounturl'] = 'ConnectTxt instance URL';
...
$string['adminheaderserversetting'] = 'ConnectTxt Server Setting';
...
$string['adminlabelserverlocation'] = 'Server Location:';
$string['adminlabelserverlocationUK'] = 'United Kingdom';
$string['adminlabelserverlocationUSA'] = 'United States of America';
...
$string['adminlinkserver'] = 'ConnectTxt Server';
...
$string['adminserverintropara1'] = 'This page displays details about the ConnectTxt server used by moodletxt';
$string['adminserverintropara2'] = 'It is necessary to select the correct server serving location. Different serving location servers have different capability, which affects moodletxt capability and the geographic area served.';
...
$string['admintitleserversetting'] = 'Server Setting';
...
$string['altstatusblacklisted'] = 'Recipient is blacklisted';
...
$string['errorinvalidlocationorurl'] = 'No ConnectTxt instance or custom URL was provided.';
...
$string['errornourl'] = 'No URL was entered for the ConnectTxt account.';
...
$string['labelstatusblacklisted'] = 'Message has not been sent. The recipient has opted out.';
...
$string['navserver'] = 'ConnectTxt Server';
...
$string['tableheadereditaccess'] = 'Access';
...
$string['tableheaderlocation'] = 'Location';
