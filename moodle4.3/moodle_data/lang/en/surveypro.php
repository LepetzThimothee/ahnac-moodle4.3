...
/**
 * Strings for component 'surveypro', language 'en', version '4.3'.
 *
 * @package     surveypro
 * @category    string
...
$string['calendar_close_description'] = 'Surveypro "{$a}" closed.';
$string['calendar_close_time'] = 'Surveypro "{$a}" is no longer available.';
$string['calendar_open_description'] = 'Fill surveypro "{$a}", please.';
$string['calendar_open_time'] = 'Surveypro "{$a}" is available.';
...
$string['cannotsubmittoolate'] = 'This survey has been closed on {$a}';
...
$string['duplicateemail'] = 'Email addresses must be different each other';
...
$string['mailroles_help'] = 'Send an email to each component of the selected roles at each response. Roles are intended at course level therefore any division into groups is neglected. The email will only advise about response from the user, not about its content and without sender details.';
...
$string['onlyfinalizationallowed'] = 'but only the finalization of those still "{$a->inprogress}" through the page "{$a->surveyproresponses}".';
...
$string['surveypro_dashboard'] = 'Dashboard';
