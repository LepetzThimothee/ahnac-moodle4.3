...
/**
 * Strings for component 'concordance', language 'en', version '4.3'.
 *
 * @package     concordance
 * @category    string
...
$string['errorincludepanelist'] = '- You must include at least one panelist';
$string['errorincludequestion'] = '- You must include at least one question';
...
$string['panelistsquiznotfound'] = 'No quiz found for panelists';
$string['panelistsrole'] = 'Role for the panelists';
$string['panelistssystemrole'] = 'System role for the panelists';
...
$string['pluginadministration'] = 'Concordance administration';
$string['pluginname'] = 'Concordance';
$string['privacy:metadata'] = 'The Concordance activity plugin does not store any personal data.';
$string['privacy:metadata:concordance_panelist'] = 'A record of the state of panelist';
$string['privacy:metadata:panelist:bibliography'] = 'The biography of the panelist';
$string['privacy:metadata:panelist:email'] = 'The email of the panelist';
$string['privacy:metadata:panelist:firstname'] = 'The firstname of the panelist';
$string['privacy:metadata:panelist:lastname'] = 'The lastname of the panelist';
...
$string['questionscategoryinfo'] = 'Questions in the quiz generated for students on {$a}';
$string['questionscategoryname'] = 'Concordance - Quiz "{$a}"';
...
$string['shouldnotmodifyquiz'] = 'You should not change the content of the currently selected quiz since these changes will not be reflected in the quiz for panelists.';
...
$string['switchtonextphase'] = 'Switch to the next phase';
$string['task_contactpanelists'] = 'Contact panelists';
$string['task_editsettings'] = 'Edit settings';
$string['task_generatequiz'] = 'Generate the quiz for students';
$string['task_panelistsmanagement'] = 'Manage panelists';
$string['task_quizselection'] = 'Select the quiz for panelists';
