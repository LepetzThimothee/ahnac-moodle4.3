...
/**
 * Strings for component 'peerwork', language 'en', version '4.3'.
 *
 * @package     peerwork
 * @category    string
...
$string['requirejustification_help'] = '- Disabled: Students will not be required to add any comments justifying the scores given for each of their peers
