...
/**
 * Strings for component 'block_globalad', language 'en', version '4.3'.
 *
...
$string['pluginname'] = 'Globalad';
$string['privacy:metadata'] = 'The Globalad block only save and display site-level config.';
$string['tit'] = 'Title';
$string['title'] = 'Globalad';
