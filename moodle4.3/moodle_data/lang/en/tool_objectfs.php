...
/**
 * Strings for component 'tool_objectfs', language 'en', version '4.3'.
 *
...
$string['settings:presignedcloudfronturl:cloudfront_private_key_pem_help'] = 'Private key in .pem format either inline or the filename including the pem extension e.g. <code>cloudfront.pem</code> which should be located under <code>dataroot/objectfs/</code>
<pre>
