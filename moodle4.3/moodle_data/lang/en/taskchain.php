...
/**
 * Strings for component 'taskchain', language 'en', version '4.3'.
 *
 * @package     taskchain
 * @category    string
...
$string['confirmdeletechainscolumnlist'] = 'Are you sure you want to delete this chain column list: {$a}';
...
$string['confirmdeletetaskscolumnlist'] = 'Are you sure you want to delete this task column list: {$a}';
