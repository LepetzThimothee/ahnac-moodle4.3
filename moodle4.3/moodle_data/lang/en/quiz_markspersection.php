...
/**
 * Strings for component 'quiz_markspersection', language 'en', version '4.3'.
 *
...
$string['markspersection'] = 'Marks per section';
$string['markspersectionfilename'] = 'marks-per-section';
