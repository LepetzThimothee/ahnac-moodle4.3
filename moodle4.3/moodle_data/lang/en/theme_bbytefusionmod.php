...
/**
 * Strings for component 'theme_bbytefusionmod', language 'en', version '4.3'.
 *
 * @package     theme_bbytefusionmod
 * @category    string
...
$string['choosereadme'] = '<div class="clearfix">
	<div class="theme_screenshot">
		...
		<h2>BByte Fusion Mod</h2>
		<img src="bbytefusionmod/pix/screenshot.jpg" />

		<h3>Original Theme Credits</h3>
		<p><a href="http://docs.moodle.org/en/Theme_credits">http://docs.moodle.org/en/Theme_credits</a></p>

		<h3>Modified Theme Credits</h3>
		<p><a href="http://www.bananabyte.com.br">http://www.bananabyte.com.br</a></p>
	...
	<div class="theme_description">
		...
		<h2>About</h2>
		<p>BByte Fusion Mod is a modified version of Fusion core theme
		<h2>Parents</h2>
		...
		<h2>Credits for Original Version</h2>
		<p>This design was of Fusion originally created by Digital Nature (hello@digitalnature.ro) before being ported to Moodle by Patrick Malley (patrick@newschoollearning.com).

		<h2>Credits for Mod Version</h2>
		<p>This design was chaged by BananaByte (marco@bananabyte.com.br).
		<h2>License</h2>
...
$string['configtitle'] = 'bbytefusionmod settings';
...
$string['pluginname'] = 'bbytefusionmod';
