...
/**
 * Strings for component 'tracker', language 'en', version '4.3'.
 *
 * @package     tracker
 * @category    string
...
$string['addcomment_html_tpl'] = '<b>Cours :</b> [<%%COURSE_SHORT%%>] <%%COURSENAME%%><br/>
...
$string['allownotifications_help'] = 'When enabled some state changes may result in sending notifications to users when user is watching an issue. Users can
...
$string['configinitialviewcomments_desc'] = 'Gives the initial state for the ticket comments panel';
$string['configinitialviewdeps'] = 'Dependancies panel';
...
$string['doaddelementautourl'] = 'Add an url collector';
...
$string['doupdateelementautourl'] = 'Update an auto url';
...
$string['elements_help'] = 'Issue submission form can be customized by adding form elements. The "summary", "description", et "reportedby" fields are as
...
$string['failovertrackerurl_help'] = 'Using tracker inside Moodle may not address situation where moodle itself is down or working improperly. When giving a failover tracker url,
...
$string['failovertrackerurl_tpl'] = 'In case this tracker is not reachable or not available, you may post a signal into the <a href="{$a}">emergency tracker</a>.
...
$string['issuemoved_html_tpl'] = '<p>The following ticket:</p>
...
$string['issuemoved_tpl'] = 'The following ticket:
--------------------------------------
...
$string['mods_help'] = 'This module provides an administrator or technical operator a way to collect locally issues on a Moodle implementation. It
...
$string['ownershipchanged_html_tpl'] = '<b>Course:</b> [<%%COURSE_SHORT%%>] <%%COURSENAME%%><br />
<b>Tracker:</b> <%%TRACKERNAME%%><br/>
<hr/>
...
$string['ownershipchanged_tpl'] = 'Course: [<%%COURSE_SHORT%%>] <%%COURSENAME%%>
Tracker: <%%TRACKERNAME%%>
--------------------------------------
Ticket: <%%ISSUE%%> / <%%SUMMARY%%>
has been reassigned to: <%%ASSIGNEDTO%%>
...
$string['raiserequest_html_tpl'] = '<b>Course:</b> [<%%COURSE_SHORT%%>] <%%COURSENAME%%><br/>
<b>Tracker:</b> <%%TRACKERNAME%%><br/>
<hr/>
...
$string['raiserequest_tpl'] = 'Course: [<%%COURSE_SHORT%%>] <%%COURSENAME%%>
Tracker: <%%TRACKERNAME%%>
--------------------------------------
...
$string['statechanged_html_tpl'] = '<p><b>Course:</b> [<%%COURSE_SHORT%%>] <%%COURSENAME%%>
...
<a href="<%%UNCCURL%%>">Unregister from watches on this issue</a><br/>
<a href="<%%ALLUNCCURL%%>">Unregister from all watches on this tracker</a></p>';
$string['statechanged_tpl'] = 'Course: [<%%COURSE_SHORT%%>] <%%COURSENAME%%>
Tracker: <%%TRACKERNAME%%>
--------------------------------------
...
$string['strictworkflow_help'] = 'When enabled, each specific internal role in tracker (reporter, developer, resolvers, manager) will only have access to his
accessible states against his role.';
$string['submission'] = '[{$a->tracker}:{$a->issueid}] A new ticket has been reported';
$string['submission_html_tpl'] = '<b>Course:</b> [<%%COURSE_SHORT%%>] <%%COURSENAME%%><br/>
<b>Tracker:</b> <%%TRACKERNAME%%><br/>
<hr/>
...
$string['submission_tpl'] = 'Course: [<%%COURSE_SHORT%%>] <%%COURSENAME%%>
Tracker: <%%TRACKERNAME%%>
--------------------------------------
...
$string['ticketprefix_help'] = 'This parameter allows defining a fixed prefix thatt will be prepended to the issue numerical identifier. This should allow better
...
$string['update_html_tpl'] = '<b>Course:</b> [<%%COURSE_SHORT%%>] <%%COURSENAME%%><br/>
<b>Tracker:</b> <%%TRACKERNAME%%><br/>
<hr/>
--------------------------------------
...
<p><a href="<%%ISSUEURL%%>">See the issue record</a><br/>
<a href="<%%CCURL%%>">Register for watches on this record</a></p>';
$string['update_tpl'] = 'Course: [<%%COURSE_SHORT%%>] <%%COURSENAME%%>
Tracker: <%%TRACKERNAME%%>
--------------------------------------
Ticket entry: <%%ISSUE%%> / <%%SUMMARY%%>
By: <%%BY%%>
