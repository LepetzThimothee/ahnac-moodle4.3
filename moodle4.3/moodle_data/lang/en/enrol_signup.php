...
/**
 * Strings for component 'enrol_signup', language 'en', version '4.3'.
 *
...
$string['signup:unenrolself'] = 'Unenrol self from the course';
$string['status'] = 'Allow Signup enrolments';
$string['status_desc'] = 'Enrol users in the course on signup';
