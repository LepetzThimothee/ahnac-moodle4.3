...
/**
 * Strings for component 'theme_cafe_con_leche', language 'en', version '4.3'.
 *
 * @package     theme_cafe_con_leche
 * @category    string
...
$string['cabecerabackgroundcolor'] = 'Header\'s background colour';
$string['cabecerabackgroundcolordesc'] = 'Header\'s background colour. Only visible if you has selected no image, or if it has transparent areas.';
...
$string['configtitle'] = 'Coffee with milk theme settings';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'This sets the logo page.';
