...
/**
 * Strings for component 'surveyprofield_numeric', language 'en', version '4.3'.
 *
...
$string['restriction_hasdecimals'] = 'is supposed to have {$a} decimal positions';
...
$string['uerr_negative'] = 'Provided value is supposed to be unsigned';
$string['uerr_notanumber'] = 'Provided value is not a number';
$string['uerr_notinteger'] = 'Provided value is supposed to be integer';
