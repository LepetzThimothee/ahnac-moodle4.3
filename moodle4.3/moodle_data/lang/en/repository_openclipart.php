...
/**
 * Strings for component 'repository_openclipart', language 'en', version '4.3'.
 *
...
$string['maxfiles'] = 'Maximum number of images';
$string['maxfiles_help'] = 'Maximum number of images to return from searches - default is {$a}.';
