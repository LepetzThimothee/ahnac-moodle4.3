...
/**
 * Strings for component 'techproject', language 'en', version '4.3'.
 *
 * @package     techproject
 * @category    string
...
$string['currentgroup'] = 'Workgroup:&ensp;';
$string['currentphase'] = 'Current phase:&ensp;';
...
$string['evaluatingfor'] = 'Evaluating for:&ensp;';
...
$string['newentrynotify_tpl'] = '<h2>Project : <%%PROJECT%%></h2>
...
$string['newtasknotify_tpl'] = '<h2>Project : <%%PROJECT%%></h2>
...
$string['projectis'] = 'Project is:&ensp;';
...
$string['realwork'] = 'Effective work:&ensp;';
...
$string['summaryforproject'] = 'Summary for project:&ensp;';
$string['takreleasenotify_tpl'] = '<h2>Project : <%%PROJECT%%></h2>
<p><b><%%OWNER%%>, owner of the task:</b>
...
$string['unspecifiedtasks_help'] = '<p>Priority is given to the specification, whuch stands for a more pregannt project component to do before others. Tasks
...
$string['weight_help'] = '<p>The criterion weight allows balancing influence of eacb criteria in the set. The balancing is performed using
"barycentric" mean : the sum of all weights will determine the 100% factor on the max grade.</p>';
$string['what'] = 'What?';
$string['will'] = 'WILL';
