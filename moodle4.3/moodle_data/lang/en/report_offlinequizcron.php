...
/**
 * Strings for component 'report_offlinequizcron', language 'en', version '4.3'.
 *
...
$string['pagesize_details'] = 'Number of files per page';
$string['pagesize_jobs'] = 'Number of jobs per page';
