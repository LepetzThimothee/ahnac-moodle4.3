...
/**
 * Strings for component 'customlabeltype_pedagogicadvice', language 'en', version '4.3'.
 *
...
$string['pedagogicadvice'] = 'Pedagogic advising';
$string['pedagogicadvice:addinstance'] = 'Can add an instance';
$string['pedagogicadvice:view'] = 'Can view the content';
$string['pedagogicnotesignal'] = 'This note is only seen by teachers.';
