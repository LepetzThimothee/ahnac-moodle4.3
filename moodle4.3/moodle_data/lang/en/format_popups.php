...
/**
 * Strings for component 'format_popups', language 'en', version '4.3'.
 *
...
$string['displaymain'] = 'Display in main course page';
$string['displaymain_help'] = 'This displays the activity in place of the course conttent instead of a popup';
