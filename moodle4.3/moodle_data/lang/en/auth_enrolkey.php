...
/**
 * Strings for component 'auth_enrolkey', language 'en', version '4.3'.
 *
...
$string['privacy:metadata:auth_enrolkey'] = 'The auth enrolkey plugin.';
$string['privacy:metadata:auth_enrolkey_cohort'] = 'The auth enrolkey plugin cohort.';
$string['privacy:metadata:auth_enrolkey_cohort:usermodified'] = 'The auth enrolkey cohort user id';
$string['privacy:metadata:auth_enrolkey_profile'] = 'The auth enrolkey plugin profile.';
$string['privacy:metadata:auth_enrolkey_profile:usermodified'] = 'The auth enrolkey profile user id';
$string['privacy:metadata:auth_enrolkey_redirect'] = 'The auth enrolkey redirect.';
$string['privacy:metadata:auth_enrolkey_redirect:usermodified'] = 'The auth enrolkey redirect user id.';
