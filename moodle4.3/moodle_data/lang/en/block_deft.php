...
/**
 * Strings for component 'block_deft', language 'en', version '4.3'.
 *
 * @package     block_deft
 * @category    string
...
$string['enablebridge_desc'] = 'This makes the option to configure audio bridge appear when editing a venue. The bridge allows more partcipants in the venue and better audio qualiy. You will also need a plan from {$a} or other server installation to provide the bridge.';
