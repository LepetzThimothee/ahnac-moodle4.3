...
/**
 * Strings for component 'theme_educator', language 'en', version '4.3'.
 *
 * @package     theme_educator
 * @category    string
...
$string['blocktitlebggbottom'] = 'block Title bottom background colour';
$string['blocktitlebggbottomdesc'] = 'Choose bottom background color for the title.';
$string['blocktitlebggtop'] = 'block title top background colour';
$string['blocktitlebggtopdesc'] = 'Choose top background color for the title.';
$string['choosereadme'] = '<div class="clearfix">
    <div class="theme_screenshot">
        <h2>Educator</h2>
        <img src="educator/pix/screenshot.gif" />
    ...
    <div class="theme_description">
        <h2>About</h2>
        <p>Educator is a fluid-width, three-column theme ported over to 2.0 from Moodle 1.X.</p>
        <h2>Tweaks</h2>
        <p>This theme is built upon both Base, Canvas and Formal White, themes included in the Moodle core. If you want to modify this theme, we recommend that you first duplicate it, then rename it before making your changes. This will prevent your customized theme from being overwritten by future Moodle upgrades, and you\'ll still have the original files if you make a mess. More information on modifying themes can be found in the <a href="http://docs.moodle.org/en/Theme">MoodleDocs</a>.</p>
    <h2>Credits</h2>
    <p>This theme was coded and is maintained by <a href="http://www.thedigitalgroup.com/">The Digital Group</a></p>
        <h2>License</h2>
...
$string['configtitle'] = 'Educator theme';
...
$string['custombannerimg'] = 'Custom banner image';
$string['custombannerimgdesc'] = 'Change the banner image for this theme by entering the full or relatve URL to an image you wish to use (i.e. http://www.yoursite.com/banner.png or ../path/to/your/banner.png).';
...
$string['custommenubgc'] = 'Custom Menu background colour';
$string['custommenubgcdesc'] = 'This sets the custome menu background colour for the theme.';
$string['displayblocktitlecolour'] = 'Block Title background colour';
$string['displayblocktitleimage'] = 'Block Title background Image';
...
$string['headerbgctop'] = 'Page header top background colour';
$string['headerbgctopdesc'] = 'Choose top background color for the page header.';
$string['headerbggbottom'] = 'Page header bottom background colour';
$string['headerbggbottomdesc'] = 'Choose bottom background color for the page header.';
...
$string['inputbbgc'] = 'Choose background color for input button.';
$string['inputbbgcdesc'] = 'This sets the background color for input button.';
$string['inputtextc'] = 'Choose color for input text.';
$string['inputtextcdesc'] = 'This sets the color for input text.';
...
$string['menu_title_bg'] = 'Menu title Selector';
$string['menu_title_bgdesc'] = 'Choose whether display moodle menu title selector';
$string['noframe'] = 'Educator 1.9 look';
...
$string['pagewidthdesc'] = 'Make page width flexible or fixed .';
$string['pluginname'] = 'Educator';
