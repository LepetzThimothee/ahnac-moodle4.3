...
/**
 * Strings for component 'theme_klass', language 'en', version '4.3'.
 *
 * @package     theme_klass
 * @category    string
...
$string['contacttitle'] = 'Footer block 2 title';
$string['contacttitle_default'] = 'CONTACT US';
...
$string['infotitle'] = 'Footer block 1 title';
...
$string['socialtitle'] = 'Footer block 3 title';
$string['socialtitle_default'] = 'GET SOCIAL';
