...
/**
 * Strings for component 'block_course_checker', language 'en', version '4.3'.
 *
...
$string['blocks_setting_help'] = 'Define the allowed blocks (must be enabled in <a href="/admin/blocks.php" target="_blank">Manage blocks</a>) to be checked.';
...
$string['checker_links_error_code'] = 'HTTP Error {$a->http_code} on {$a->url}';
$string['checker_links_error_curl'] = 'cURL Error {$a->curl_errno} {$a->curl_error} on {$a->url}';
...
$string['checker_links_ok'] = '{$a->url} is valid (Code {$a->http_code})';
...
$string['quiz_grade_sum_error'] = 'Maximum grade ({$a->grade}) and Total of marks ({$a->sumgrades}) should be the same number in this quiz';
...
$string['userdata_help'] = 'If you want this data to be copied to other courses, you have to import it manually. Here are some useful manuals: <a href="https://docs.moodle.org/38/en/Backup_of_user_data" target="_blank">Backup of user data</a> and <a href="https://docs.moodle.org/38/en/Reusing_activities" target="_blank">Reusing activities</a>.';
$string['userdata_setting_coursesregex'] = 'Course fullname regex filter';
$string['userdata_setting_coursesregex_help'] = 'Define a regexp, to run this checker only, when the course fullname matches it.';
$string['userdata_setting_modules'] = 'Enabled modules';
$string['userdata_setting_modules_help'] = 'Define the allowed modules (must be enabled in <a href="/admin/modules.php" target="_blank">Manage activities</a>, contain reset_userdata method in <code>mod/{modname}/lib.php</code> and supported by this plugin) to be checked for user data.';
