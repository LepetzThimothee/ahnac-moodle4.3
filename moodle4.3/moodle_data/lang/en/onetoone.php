...
/**
 * Strings for component 'onetoone', language 'en', version '4.3'.
 *
 * @package     onetoone
 * @category    string
...
$string['alreadysignedup'] = 'You have already signed-up for this One-to-one activity.';
$string['answer'] = 'Sign in';
$string['answercancel'] = 'Sign out';
$string['approvalreqd'] = 'Approval required';
$string['approvalreqd_help'] = 'When "Approval required" is checked, a learner will need approval from their manager to be permitted to attend a one-to-one session.';
...
$string['calendareventdescriptionbooking'] = 'You are booked for this <a href="{$a}">One-to-one session</a>.';
$string['calendareventdescriptionsession'] = 'You have created this <a href="{$a}">One-to-one session</a>.';
...
$string['cancellationinstrmngr_help'] = 'When **Send notice to manager** is checked, the text in the **Notice for manager** field is sent to a learner\'s manager advising that they have cancelled a one-to-one booking.';
...
When a one-to-one session reaches capacity the session details do not appear on the course page. The details will appear greyed out on the \'View all sessions\' page and the learner cannot enrol on the session.
&nbsp;';
...
$string['confirmationinstrmngr_help'] = 'When "Send notice to manager" is checked, the text in the "Notice for manager" field is sent to a manager advising that a staff member has signed up for a one-to-one session.';
...
$string['description_help'] = '**Description** is the course description that displays when a learner enrols on a one-to-one session.
...
$string['emailmanagercancellation_help'] = 'When "Send notice to manager" is checked, an email will be sent to the learner\'s manager advising them that the one-to-one booking has been cancelled.';
$string['emailmanagerconfirmation'] = '# Send notice to manager';
$string['emailmanagerconfirmation_help'] = 'When "Send notice to manager" is checked, a confirmation email will be sent to the learner\'s manager when the learner signs up for a one-to-one session.';
$string['emailmanagerreminder'] = '# Send notice to manager';
$string['emailmanagerreminder_help'] = 'When "Send notice to manager" is checked, a reminder message will be sent to the learner\'s manager a few days before the start date of the one-to-one session.';
$string['emptylocation'] = 'Location was empty';
$string['enrolled'] = 'enrolled';
$string['error:addalreadysignedupattendee'] = '{$a} is already signed-up for this One-to-one activity.';
...
$string['error:couldnotaddtrainer'] = 'Could not save new one-to-one session trainer';
...
$string['error:couldnotdeletetrainer'] = 'Could not delete a one-to-one session trainer';
...
$string['error:couldnotupdateo2orecord'] = 'Could not update one-to-one signup record in database';
$string['error:couldnotupdatesession'] = 'Could not update session';
$string['error:coursemisconfigured'] = 'Course is misconfigured';
$string['error:cronprefix'] = 'Error: onetoone cron:';
...
$string['error:incorrectcoursemodulesession'] = 'Course Module One-to-one Session was incorrect';
$string['error:incorrectnotificationtype'] = 'Incorrect notification type supplied';
$string['error:incorrectonetooneid'] = 'One-to-one ID was incorrect';
...
$string['error:mustspecifycoursemoduleonetoone'] = 'Must specify a course module or a onetoone ID';
...
$string['error:nopermissiontosignup'] = 'You don\'t have permission to signup to this onetoone session.';
$string['error:noticeidincorrect'] = 'Notice ID is incorrect: {$a}';
$string['error:o2ofailedupdatestatus'] = 'One-to-one failed to update the user\'s status';
...
$string['error:signedupinothersession'] = 'You are already signed up in another session for this activity. You can only sign up for one session per One-to-one activity.';
...
$string['modulenameplural'] = 'One-to-one';
...
$string['none'] = 'none';
$string['noonetoones'] = 'There are no One-to-one activities';
...
$string['onetoone'] = 'One-to-one';
$string['onetoone:addattendees'] = 'Add attendees to a one-to-one session';
$string['onetoone:editsessions'] = 'Add, edit, copy and delete one-to-one sessions';
$string['onetoone:overbook'] = 'Sign-up to full sessions.';
$string['onetoone:removeattendees'] = 'Remove attendees from a one-to-one session';
$string['onetoone:signup'] = 'Sign-up for a session';
$string['onetoone:takeattendance'] = 'Take attendance';
$string['onetoone:view'] = 'View one-to-one activities and sessions';
$string['onetoone:viewattendees'] = 'View attendance list and attendees';
$string['onetoone:viewcancellations'] = 'View cancellations';
$string['onetoone:viewemptyactivities'] = 'View empty one-to-one activities';
$string['onetoonebooking'] = 'One-to-one booking';
$string['onetoonename'] = 'One-to-one name';
$string['onetoonesession'] = 'One-to-one session';
...
$string['placeholder:onetoonename'] = '[onetoonename]';
...
$string['pluginadministration'] = 'onetoone administration';
$string['pluginname'] = 'One-to-one';
$string['points'] = 'Points';
$string['pointsplural'] = 'Points';
$string['potentialattendees'] = 'Potential Attendees';
$string['previoussessions'] = 'Previous sessions';
$string['previoussessionslist'] = 'List of all past sessions for this One-to-one activity';
$string['printversionid'] = 'Print version: without name';
$string['printversionname'] = 'Print version: with name';
$string['really'] = 'Do you really want to delete all results for this onetoone?';
$string['registeredon'] = 'Registered On';
$string['registrations'] = 'Registrations';
$string['reminder'] = 'Reminder';
$string['reminderinstrmngr'] = '# Notice for Manager';
$string['reminderinstrmngr_help'] = 'When **Send notice to manager** is checked, the text in the **Notice for Manager** field is sent to a learner\'s manager advising that they have signed up for a one-to-one session.';
...
The **Request message** section displays the notices sent to the learner and their manager regarding the approval process for the learner to attend the one-to-one session.

**Subject:** is the subject line that appears on the request approval emails sent to the manager and the learner.

**Message:** is the email text sent to the learner advising them that their request to attend the one-to-one session has been sent to their manager for approval.

**Notice for manager:** is the email text sent to the learner\'s manager requesting approval to attend the one-to-one session.';
...
* The staff member and the staff member\'s manager will be sent a confirmation email (i.e., the one formatted per the "Confirmation message" section of the one-to-one instance\'s settings).
* The staff member will be sent a reminder email message (i.e., the one formatted per the "Reminder message" section of the one-to-one instance\'s settings). The reminder will be sent a number of days before the session, according to the "Days before message is sent" setting also found in the "Reminder message" section of the one-to-one instance\'s settings.
...
* The staff member will be sent a confirmation email (i.e. the one formatted per the "Wait-listed message" section of the one-to-onee instance\'s settings).
...
$string['sessionsoncoursepage_help'] = 'This is the number of sessions for each one-to-one activity that will be shown on the main course page.';
...
$string['setting:defaultconfirmationsubjectdefault'] = 'Course booking confirmation: [onetoonename], [starttime]-[finishtime], [sessiondate]';
...
$string['setting:defaultremindersubjectdefault'] = 'Course booking reminder: [onetoonename], [starttime]-[finishtime], [sessiondate]';
...
Date(s):
[alldates]';
$string['setting:defaultrequestsubjectdefault'] = 'Course booking request: [onetoonename], [starttime]-[finishtime]';
...
$string['setting:defaultwaitlistedsubjectdefault'] = 'Waitlisting advice for [onetoonename]';
...
$string['setting:sessionroles'] = 'Users assigned to the selected roles in a course can be tracked with each one-to-one session';
...
$string['showoncalendar_help'] = 'When **Site** is selected the one-to-one activity sessions will be displayed on the site calendar as a Global Event.  All site users will be able to view these sessions.

When **Course** is selected all of the one-to-one activity sessions will be displayed on the course calendar and as Course Event on the site level calendar and visible to all users enrolled in the course.

When **None** is selected, one-to-one activity sessions will only be displayed as User Events on a confirmed attendee\'s calendar, provided the **Show on user\'s calendar** option has been selected.';
...
$string['signupforthissession'] = 'Sign-up for this One-to-one session';
...
$string['suppressemail_help'] = 'Use this option if you want to silently add/remove users from a One-to-one session. When this option is toggled, the usual email
...
$string['upcomingsessionslist'] = 'List of all upcoming sessions for this One-to-one activity';
$string['updaterequests'] = 'Update requests';
$string['upgradeprocessinggrades'] = 'Processing One-to-one grades, this may take a while if there are many sessions...';
$string['usercalentry'] = 'Show entry on user\'s calendar';
$string['usercalentry_help'] = 'When active this setting adds a User Event entry to the calendar of an attendee of a one-to-one session. When turned off this prevents a duplicate event appearing in a session attendee\'s calendar, where you have calendar display settings set to Course or Site.';
