...
/**
 * Strings for component 'report_trainingsessions', language 'en', version '4.3'.
 *
...
$string['coursetime_help'] = '<p>this summarizes the time passed in general screens of the course but OUTSIDE activities.';
...
$string['elapsed_help'] = '<p>This summarizes all time spent in the course or any dependancy of the course.</p>';
...
$string['elapsedlastweek_help'] = 'The extended course time calculates the time strictly spent inside the course context limited to the last week timerange.';
$string['elapsedoutofstructure'] = 'Other course use time';
$string['elapsedoutofstructure_help'] = 'Time spent in the course scope, but not assignable to any "structural element" of the course (section, page, module).';
$string['email'] = 'Email';
...
$string['extelapsed_help'] = 'The extended course time calculates the time strictly spent in the course context, plus time spent to get down to the course
...
$string['extelapsedlastweek_help'] = 'The extended course time calculates the time strictly spent in the course context, plus time spent to get down to the course
...
$string['extotherelapsed_help'] = '<p>Elapsed time outside of this course, but attached to this course sessions. They are usually spent in user pages, or in global site scope.</p>';
...
$string['lineaggregators_help'] = '<p>Define aggregators as a list of aggregators switches starting from left most columns in the
...
$string['proversionrequired'] = '<p>You are trying to use a feature that is only available in the "Pro" version of this plugin. The "Pro" version of this plugin
...
$string['summarycolumns_desc'] = '<p>Choose columns by commenting with # any line. You can reorder lines to change the output order.</p>
...
$string['timegraderanges_help'] = 'Time grade ranges let you cut the elapsed time into pieces for achieving a discrete time grade effect. binay modes will need
