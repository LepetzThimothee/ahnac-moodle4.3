...
/**
 * Strings for component 'block_videochat', language 'en', version '4.3'.
 *
 * @package     block_videochat
 * @category    string
...
$string['currentbusy'] = 'User {$a} is currently busy';
...
$string['invalidcall'] = 'This call is no longer valid';
$string['invaliduser'] = 'Invalid call to user';
$string['outgoingcall'] = 'Outgoing call';
$string['periodnminutes'] = 'last {$a} minutes';
$string['pluginname'] = 'Video chat';
