...
/**
 * Strings for component 'local_glossary_wordimport', language 'en', version '4.3'.
 *
...
$string['wordinstructions_help'] = 'Separate Categories, Keywords and Tags fields with commas (not newlines).';
