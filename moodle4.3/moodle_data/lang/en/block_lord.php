...
/**
 * Strings for component 'block_lord', language 'en', version '4.3'.
 *
 * @package     block_lord
 * @category    string
...
$string['docs:publications'] = 'Related Publications';
$string['docs:pubs1'] = 'Rita Kuo, Radomir Wasowski, Ted Krahn, and Maiga Chang. (2022). LORD: A Moodle Plug-in Helps to Find the Relations among Learning Objects. In: 18th International Conference on Intelligent Tutoring Systems, (ITS 2022), Hybrid, Bucharest, Romania, June 29-July 1, 2022. (Springer) <a href="http://maiga.athabascau.ca/publication/Conference-2022-ITS2022-LORD.pdf">(PDF)</a>';
...
$string['maxbpm'] = 'Use maximum bipartite matching?';
...
$string['ngrampos'] = 'Use N-gram and part of speech tagging service?';
...
$string['privacy:metadata:block_lord:canonical'] = 'Whether or not to use canonical method.';
...
$string['privacy:metadata:block_lord:language'] = 'Which language to use.';
$string['privacy:metadata:block_lord:matrix'] = 'The similarity matrix for this comparison.';
$string['privacy:metadata:block_lord:maxbpm'] = 'Whether or not to use maximum bipartite matching.';
...
$string['privacy:metadata:block_lord:ngrampos'] = 'Whether or not to use Ngram-POS service.';
