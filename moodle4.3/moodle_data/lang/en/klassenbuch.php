...
/**
 * Strings for component 'klassenbuch', language 'en', version '4.3'.
 *
 * @package     klassenbuch
 * @category    string
...
$string['backtochapter'] = 'Back to chapter';
...
$string['eventsubscriptioncreated'] = 'Klassenbuch subscrition created';
$string['eventsubscriptiondeleted'] = 'Klassenbuch subscrition deleted';
...
$string['mailsent'] = '{$a->count} participants sent chapter {$a->chapter}';
...
$string['showclassplan'] = 'Show class plan in menu';
...
$string['viewclassplan'] = 'View Class Plan';
