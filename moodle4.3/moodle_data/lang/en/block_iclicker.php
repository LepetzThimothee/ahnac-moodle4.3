...
/**
 * Strings for component 'block_iclicker', language 'en', version '4.3'.
 *
...
$string['admin.search.id'] = 'i>clicker/Remote ID:';
...
$string['reg.registered.clickerId.go.invalid'] = 'This i>clicker ID ({$a}) is not valid. Please enter a valid i>clicker ID.';
$string['reg.registered.clickerId.go.wrong.lastname'] = 'This i>clicker ID is assigned to a student with a different name. Please check that your name in your i>clicker account matches your name in this LMS and try again.';
$string['reg.registered.clickerId.invalid'] = 'This i>clicker Remote ID ({$a}) is not valid. Please enter a valid i>clicker ID.';
$string['reg.registered.clickerId.wrong.length'] = 'i>clicker Remote IDs must be 8 characters in length. Please check your entry and try again.';
...
$string['reg.remote.faq6.question'] = 'I registered my remote, why is my registration still not appearing in class?';
...
$string['reg.remote.faq9.answer'] = 'Yes, your votes still count. Your in-class votes were recorded by i>clicker and, once you register your remote/i>clicker account, these votes will be associated with you the next time your instructor syncs the course gradebook or roster.';
