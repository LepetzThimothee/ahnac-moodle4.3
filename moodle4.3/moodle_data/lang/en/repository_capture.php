...
/**
 * Strings for component 'repository_capture', language 'en', version '4.3'.
 *
...
$string['record_ffmpeg_help'] = 'The path to ffmpeg (or avconv depending on your system). Generally <b>ffmpeg</b> is enough but on some servers, you need to specify the full path like <b>"C:\\Program Files\\ffmpeg\\bin\\ffmpeg.exe"</b> (quotes are important if there are spaces in the path)';
