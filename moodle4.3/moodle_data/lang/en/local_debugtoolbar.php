...
/**
 * Strings for component 'local_debugtoolbar', language 'en', version '4.3'.
 *
...
$string['filters_created_X'] = 'Filters created: {$a}';
$string['general_type_X'] = 'General type: {$a}';
$string['get_string_calls_X'] = 'get_string() calls: {$a}';
$string['http_response_code_X'] = 'HTTP response code: {$a}';
$string['included_X_files'] = 'Included {$a} files';
