...
/**
 * Strings for component 'videofile', language 'fr', version '4.3'.
 *
 * @package     videofile
 * @category    string
...
$string['captions_help'] = 'Ajoutez ici des transcriptions du dialogue au format  WebVTT. Vous pouvez ajouter plusieurs fichiers afin de fournir des sous-titres multilingues. Les noms des fichiers, sans les extensions, seront utilisés pour les titres des options de sous-titres de vidéo. Si les fichiers sont nommés conformément à la norme ISO 6392 (p. ex. eng.vtt et swe.vtt), les options seront affichées en tant que noms entiers dans la langue correspondante conformément aux préférences de langue de l’utilisateur (p. ex. anglais et suédois, dans l’hypothèse où la langue préférée de l’utilisateur est paramétré sur l’anglais).';
$string['err_positive'] = 'Vous devez saisir un nombre positif.';
$string['filearea_captions'] = 'Légendes';
$string['filearea_posters'] = 'Affiches';
$string['filearea_videos'] = 'Vidéos';
$string['height'] = 'Hauteur';
$string['height_explain'] = 'Indique la hauteur par défaut du lecteur vidéo.';
$string['height_help'] = 'La hauteur de la vidéo (par exemple, 500 pour une hauteur de 500 pixels).';
$string['limitdimensions'] = 'Limiter la taille en mode adaptatif ?';
$string['limitdimensions_explain'] = 'Indique si la largeur et la hauteur doivent être utilisés comme taille maximale en mode adaptatif.';
$string['modulename'] = 'Fichier vidéo';
$string['modulename_help'] = 'Utilisez le plugin Fichier vidéo pour ajouter des vidéos HTML5 avec flash comme solution de secours (en utilisant video.js). Ce plugin permet également les sous-titres multilingues.';
$string['modulenameplural'] = 'Fichiers vidéos';
...
$string['responsive_help'] = 'Vérifiez que la vidéo est automatiquement redimensionnée à la taille de fenêtre du navigateur.nnUtilisez les champs hauteur et largeur pour définir les proportion de la vidéo (p. ex. 16/9 ou 800/450).';
...
$string['videos_help'] = 'Ajoutez ici le fichier vidéo.nnVous pouvez ajouter des formats alternatifs afin d’être sûr qu’ils peuvent être lus indépendamment du navigateur qui est utilisé (habituellement .mp4, .ogv et .webm).';
