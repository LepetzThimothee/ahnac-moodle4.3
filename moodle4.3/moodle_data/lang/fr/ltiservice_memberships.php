...
/**
 * Strings for component 'ltiservice_memberships', language 'fr', version '4.3'.
 *
...
$string['ltiservice_memberships'] = 'Provisionnement des noms et rôles IMS LTI';
$string['ltiservice_memberships_help'] = 'Permettre à l’outil d’obtenir les informations des membres à partir du cours, en utilisant le service de provisionnement des noms et rôles IMS LTI. Les requêtes au niveau du cours seront basées sur les réglages de l’outil. Si vous voulez que ces informations soient systématiquement envoyées, ne déléguez pas le choix aux enseignants. Les requêtes au niveau des liens respecteront toujours les réglages de confidentialité s’appliquant au lien.';
$string['notallow'] = 'Ne pas utiliser ce service';
$string['pluginname'] = 'Service de provisionnement des noms et rôles IMS LTI';
