...
/**
 * Strings for component 'attendance', language 'fr', version '4.3'.
 *
 * @package     attendance
 * @category    string
...
$string['attendance:import'] = 'Importer des sessions à partir d’un fichier (csv)';
...
$string['attendance:manualautomark'] = 'Autoriser le processus d’auto-marquage manuel';
...
$string['attendancereport'] = 'Présence';
...
$string['attendanceuserreport'] = 'Rapport de présence';
...
$string['autoassignstatus_help'] = 'Si cette option est sélectionnée, les étudiants se verront automatiquement attribuer la note la plus élevée disponible.';
...
$string['automarkingcomplete'] = 'Marquage automatique complet';
$string['automarkingnotavailableyet'] = 'Cette session utilise le marquage automatique à la clôture de la session et la session n’est pas encore terminée.';
...
$string['availability'] = 'Disponibilité de l’auto-marquage';
$string['availability_help'] = 'Restreindre la disponibilité de ce statut. <br> Si l’option « Limité » est sélectionnée, indiquez le nombre de minutes pendant lesquelles ce statut est disponible après le démarrage de la session. Cela s’applique lorsque les étudiants marquent leur propre présence.';
...
$string['availablebeforesession_help'] = 'Lorsque les étudiants notent eux-mêmes leur présence, ce statut peut être choisi avant le début de la session.';
...
$string['cannottakethisgroup'] = 'Vous n’êtes pas membre du groupe de cours auquel se rapporte cette session de présence, votre présence n’a pas été enregistrée.';
$string['cantaddstatus'] = 'Vous devez définir un acronyme et une description lorsque vous ajoutez un nouveau statut.';
$string['canthidestatus'] = 'Vous ne pouvez pas masquer ce statut car il est déjà utilisé dans cette activité de participation';
...
$string['error:usernotfound'] = 'Un utilisateur avec le {$a->userfield} défini sur {$a->extuser} est introuvable dans ce cours';
...
$string['indicator:cognitivedepth_help'] = 'Cet indicateur est basé sur la profondeur cognitive atteinte par l’étudiant dans une activité Présence.';
...
$string['lasttaken'] = 'Dernier relevé des présences';
...
$string['messagedselecteduserfailed'] = 'Échec de l’envoi d’un message à un ou plusieurs utilisateurs. Activez le débogage pour en savoir plus.';
...
$string['passwordheader'] = 'Utilisez le mot de passe indiqué ci-dessous pour prendre vos présences';
...
$string['percentagesessionscompleted'] = 'Pourcentage de sessions dépassées';
...
$string['reportsessionlasttaken'] = 'Heure de la dernière séance (enseignant)';
...
$string['rotateqrcodeexpirymargin_desc'] = 'Intervalle de temps (secondes) pour permettre d’utiliser un code QR/mot de passe échu.';
...
$string['saveandshownext'] = 'Enregistrer et afficher la page suivante';
...
$string['sessiondescription'] = 'Description de la session';
...
$string['statustotalcount'] = 'Statut {$a} - Nombre total';
$string['statustotalcountcurrentweek'] = 'Statut {$a} - Nombre total pour la semaine en cours';
$string['statustotalcountpreviousweek'] = 'Statut {$a} - Nombre total pour la semaine précédente';
...
$string['studentscanmarksessiontimeend_desc'] = 'Si la session n’a pas d’heure de fin, combien de minutes la session devrait-elle être disponible pour que les étudiants puissent enregistrer leur présence.';
$string['studentsearlyopentime'] = 'Ouverture anticipée de la session pour la saisie';
$string['studentsearlyopentime_help'] = 'Cela permet aux enseignants d’ouvrir la session plus tôt, ce qui permet de prendre les présences avant l’heure réelle de début de la session.';
$string['submit'] = 'Envoyer';
$string['submitattendance'] = 'Envoyer le statut de présence';
$string['submitattendancefuture'] = 'Signaler une future absence';
...
$string['timetaken'] = 'Heure de la prise de présence';
$string['to'] = 'à :';
$string['todate'] = 'jusqu’à ce jour';
$string['totalnumsessions'] = 'Nombre total de sessions';
...
$string['updateattendance'] = 'Modifier les présences';
...
$string['userexistingstatus'] = 'Votre présence a déjà été marquée comme : <strong>{$a}</strong>, utilisez le formulaire ci-dessous pour la modifier si nécessaire.';
...
$string['usersessiongrade'] = 'Note de session de l’utilisateur';
$string['usersessionremarks'] = 'Remarques sur la session de l’utilisateur';
$string['usersessiontaken'] = 'Session utilisateur prise';
$string['userstatus'] = 'Status de la session de l’utilisateur';
