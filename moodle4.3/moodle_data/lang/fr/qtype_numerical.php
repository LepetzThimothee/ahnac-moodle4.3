...
/**
 * Strings for component 'qtype_numerical', language 'fr', version '4.3'.
 *
...
$string['answermustbenumberorstar'] = 'La réponse doit être un nombre, par exemple -1.234 ou 3e8, ou un astérisque (*).';
...
$string['selectunit'] = 'Veuillez choisir une unité';
