...
/**
 * Strings for component 'stickynotes', language 'fr', version '4.3'.
 *
 * @package     stickynotes
 * @category    string
...
$string['completionstickynotesenabled'] = 'Les étudiants doivent créer un nombre de notes pour compléter l’activité.';
...
$string['deletecolumnsure'] = 'Voulez-vous vraiment supprimer cette colonne et son contenu ? Les notes supprimées ne seront pas récupérables.';
$string['deletenote'] = 'Supprimer une note';
$string['deletenotesure'] = 'Voulez-vous vraiment supprimer cette note ?';
