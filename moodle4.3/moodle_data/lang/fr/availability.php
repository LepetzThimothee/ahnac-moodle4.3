...
/**
 * Strings for component 'availability', language 'fr', version '4.3'.
 *
...
$string['disabled_verb'] = 'Impossible à modifier, car le jeu de règles comprend un règle contenant des données privées.';
$string['editsettings'] = 'Modifier les restrictions';
