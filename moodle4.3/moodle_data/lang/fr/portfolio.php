...
/**
 * Strings for component 'portfolio', language 'fr', version '4.3'.
 *
 * @package     portfolio
 * @category    string
...
$string['privacy:metadata'] = 'Le sous-système portfolio agit comme un canal, transmettant des requêtes de plugins aux divers plugins de portfolio.';
