...
/**
 * Strings for component 'enrol_self', language 'fr', version '4.3'.
 *
 * @package     enrol_self
 * @category    string
...
$string['maxenrolledreached'] = 'Le nombre maximum d’utilisateurs pouvant s’inscrire eux-mêmes est atteint.';
$string['messageprovider:expiry_notification'] = 'Notifications d’échéance d’auto-inscription';
$string['newenrols'] = 'Permettre de nouvelles auto-inscriptions';
