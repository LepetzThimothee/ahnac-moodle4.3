...
/**
 * Strings for component 'theme_magazine', language 'fr', version '4.3'.
 *
...
$string['linkhover'] = 'Couleur des liens survolés';
$string['linkhoverdesc'] = 'Couleur des liens survolés (utiliser le code hexadécimal HTML)';
$string['logo'] = 'Logo';
...
$string['maincoloraccentdesc'] = 'Couleur de mise en évidence du dock et des bordures de l’en-tête. Devrait être un peu plus sombre que la couleur principale.';
$string['maincolordesc'] = 'Indiquez le code hexadécimal de la couleur de l’en-tête, du dock et d’autres zones. Une couleur sombre ou saturée donne un meilleur résultat.';
