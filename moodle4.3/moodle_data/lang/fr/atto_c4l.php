...
/**
 * Strings for component 'atto_c4l', language 'fr', version '4.3'.
 *
 * @package     atto_c4l
 * @category    string
...
$string['contextual'] = 'Contexte';
$string['dialogtitle'] = 'Choisir un composant';
$string['dodontcards'] = 'Cartes à faire/à ne pas faire';
$string['duedate'] = 'Date d’échéance';
$string['enableattoc4l'] = 'Activer les composants pour l’apprentissage';
...
$string['figure'] = 'Forme';
$string['generalheading'] = 'Paramètres généraux';
...
$string['privacy:metadata'] = 'Le plugin Atto Components for learning n’enregistre aucune donnée personnelle.';
