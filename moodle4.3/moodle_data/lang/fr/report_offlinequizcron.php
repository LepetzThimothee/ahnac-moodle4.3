...
/**
 * Strings for component 'report_offlinequizcron', language 'fr', version '4.3'.
 *
...
$string['intro'] = 'Ce rapport vous permet d’administrer la tâche cron du test hors-ligne pour l’évaluation du formulaire de réponse.';
$string['jobid'] = 'Identifiant';
$string['nofiles'] = 'Aucun fichier trouvé';
$string['offlinequizcron:view'] = 'Afficher le rapport d’administration du cron des tests hors-ligne';
$string['offlinequizjobdetails'] = 'Détails de l’évaluation du travail {$a}';
$string['offlinequizjobs'] = 'Liste des travaux d’évaluation de quiz hors ligne';
