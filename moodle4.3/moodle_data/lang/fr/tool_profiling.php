...
/**
 * Strings for component 'tool_profiling', language 'fr', version '4.3'.
 *
...
$string['calls'] = 'Appel de fonctions';
$string['cannotfindanyrunforrunid'] = 'Impossible de trouver le profilage « {$a} ».';
...
$string['lastrun'] = 'Résumé de la dernière exécution';
...
$string['pluginname'] = 'Profilages';
$string['privacy:metadata'] = 'Le plugin Profilages n’enregistre aucune donnée personnelle.';
$string['profilingfocusscript'] = 'Afficher les profilages du script {$a}';
$string['profilingruns'] = 'Profilages';
$string['profilingrunsfor'] = 'Profilages pour {$a}';
$string['referencerun'] = 'Profilage de référence/commentaire';
