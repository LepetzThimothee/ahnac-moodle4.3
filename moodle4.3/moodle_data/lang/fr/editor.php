...
/**
 * Strings for component 'editor', language 'fr', version '4.3'.
 *
 * @package     editor
 * @category    string
...
$string['acteditorshhdr'] = 'Éditeurs de texte actifs';
...
$string['configeditorplugins'] = 'Veuillez sélectionner les plugins d’éditeurs de texte que vous désirez utiliser et les classer dans l’ordre que vous recommandez.';
...
$string['multi'] = 'Multi';
$string['mustenterurl'] = 'Vous devez saisir l’URL';
...
$string['pleaseenteralt'] = 'Veuillez saisir le texte alternatif';
$string['popupeditor'] = 'Passer l’éditeur en mode fenêtre';
$string['preformatted'] = 'Préformatté';
$string['preview'] = 'Prévisualiser';
$string['privacy:metadata:preference:htmleditor'] = 'Préférence de l’éditeur de texte.';
$string['privacy:preference:htmleditor'] = 'Votre éditeur préféré pour écrire du texte HTML est {$a}';
