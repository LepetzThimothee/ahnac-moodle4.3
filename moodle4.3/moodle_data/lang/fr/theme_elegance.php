...
/**
 * Strings for component 'theme_elegance', language 'fr', version '4.3'.
 *
...
$string['bannercolor'] = 'Couleur de la diapo';
...
$string['bannerlinkurl'] = 'Adresse URL';
$string['bannerlinkurldesc'] = 'Adresse du lien dans la diapo';
$string['bannersettings'] = 'Paramètres du diaporama';
$string['bannersettingsdesc'] = 'Activer et déterminer les paramètres de chaque diapositive';
$string['bannersettingssub'] = 'Ces paramètres contrôlent le diaporama qui apparaît sur la première page Moodle';
$string['bannertext'] = 'Texte de la diapo';
...
$string['blogdesc'] = 'Entrer l’URL de votre organisation (par ex. http://www.monsite.fr';
...
$string['categoryicondesc'] = 'Choisissez l’icône pour cette catégorie';
...
$string['categoryiconinfodesc'] = 'Chaque icône est définie par un "ID de catégorie". Vous gagnez en regardant l’URL ou chaque catégorie. La liste est <a href="https://fontawesome.com/v4/cheatsheet/">ici</a>. Saisir seulement ce qui est après "fa-".';
...
$string['defaultcategoryicondesc'] = 'Si vous n’entrez pas de valeur dans l’une de vos catégories ci-dessous, la valeur par défaut sera utilisée. C’est un moyen facile de changer rapidement les icônes des nombreuses catégorie.';
...
$string['enablebanner'] = 'Activez cette diapositive';
...
$string['headerbgdesc'] = 'Si vous voulez remplacer l’arrière-plan par défaut vous pouvez télécharger votre propre image ici. <br>
La taille recommandée est 110 px de haut par 1 600 px de large. L’image sera tuilée si petit. <br>
<strong>Astuce  cool</ strong>: Si votre image utilise la transparence, la couleur du thème se verra au travers.';
...
$string['loginsettingssub'] = 'Paramètres de l’écran personnalisé de login';
$string['logo'] = 'Logo';
...
$string['marketingicondesc'] = 'Nom de l’icône que vous souhaitez utiliser. La liste des icônes disponibles est <a href="https://fontawesome.com/v4/cheatsheet/" target="_new">ici</a>. Il suffit de saisir ce qui est après le « fa- ».';
...
$string['marketingtitleicondesc'] = 'Nom de l’icône que vous souhaitez utiliser dans le titre du spot marketing. La liste se trouve <a href="https://fontawesome.com/v4/cheatsheet/" target="_new">ici</a>. Il suffit de saisir ce qui est après le « fa- ».';
...
$string['quicklinkbuttoncolordesc'] = 'Couleur du bouton lien rapide';
$string['quicklinkbuttontext'] = 'Texte du lien';
$string['quicklinkbuttontextdesc'] = 'Texte à afficher sur le bouton.';
$string['quicklinkbuttonurl'] = 'URL du lien';
$string['quicklinkbuttonurldesc'] = 'URL vers laquelle pointera le bouton';
...
$string['quicklinkicondesc'] = 'Nom de l’icône que vous souhaitez utiliser. La liste est <a href="https://fontawesome.com/v4/cheatsheet/" target="_new">ici</a>. Il suffit de saisir ce qui est après le « fa- ».';
...
$string['quicklinksicondesc'] = 'Nom de l’icône que vous souhaitez utiliser dans le titre des zones Liens rapides. La liste est <a href="https://fontawesome.com/v4/cheatsheet/" target="_new">ici</a>. Il suffit de saisir ce qui est après le « fa- ».';
...
$string['quicklinkstitle'] = 'Zone d’en-tête';
$string['quicklinkstitledesc'] = 'Le nom associé à la zone Liens rapides sur la page d’accueil.';
$string['reader'] = 'Lecteur';
$string['region-hidden-dock'] = 'Administrateur uniquement';
...
$string['slidenumberdesc'] = 'Le nombre de diapos ne changera pas jusqu’à ce que vous enregistriez les modifications de cette page';
$string['slidespeed'] = 'Durée d’affichage d’une diapo';
$string['slidespeeddesc'] = 'Définit la durée d’affichage de la diapositive en millisecondes';
$string['socialdesc'] = 'Fournit des liens directs vers les principaux réseaux sociaux, afin de promouvoir votre marque. Les liens apparaissent dans l’en-tête de chaque page.';
...
$string['tumblrdesc'] = 'Saisir l’URL de votre Tumblr';
$string['twitter'] = 'URL Twitter';
$string['twitterdesc'] = 'Saisir l’URL de votre flux Twitter';
...
$string['vimeodesc'] = 'Saisir l’URL de votre chaîne Vimeo';
