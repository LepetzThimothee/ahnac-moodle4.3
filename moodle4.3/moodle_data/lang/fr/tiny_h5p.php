...
/**
 * Strings for component 'tiny_h5p', language 'fr', version '4.3'.
 *
 * @package     tiny_h5p
 * @category    string
...
$string['buttontitle'] = 'Configurer contenu H5P';
...
$string['helplinktext'] = 'Aide H5P';
$string['insert'] = 'Insérer contenu H5P';
