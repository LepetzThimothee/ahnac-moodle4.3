...
/**
 * Strings for component 'mumie', language 'fr', version '4.3'.
 *
 * @package     mumie
 * @category    string
...
$string['completionpass_help'] = 'Si cette option est activée, l’activité est considérée comme terminée lorsque l’étudiant reçoit une note de passage, la note de passage étant définie dans le carnet de notes.
<br><br><b>Veuillez noter :</b><br>
Les notes des activités MUMIE ne sont mises à jour que lorsque le carnet de notes est ouvert. Si vous souhaitez connaître l’état d’avancement actuel de tous les étudiants, n’oubliez pas d’ouvrir d’abord la page de présentation du carnet de notes';
...
<li><strong>Multiples langages</strong><br /> La plupart des contenus des serveurs MUMIE sont disponibles en plusieurs langues. Vous pouvez changer la langue dans laquelle une activité MUMIE est affichée pour tous les étudiants en cliquant sur un bouton.</li>
