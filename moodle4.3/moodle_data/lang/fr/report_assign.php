...
/**
 * Strings for component 'report_assign', language 'fr', version '4.3'.
 *
...
$string['assign:export'] = 'Exporter les utilisateurs vers Excel';
$string['assign:shownames'] = 'Vue globale (non anonymisée)';
$string['assign:view'] = 'Afficher le rapport de remise des devoirs';
...
$string['group'] = 'Groupe';
$string['groupsubmission'] = 'Remise de groupe';
$string['log'] = 'Journal';
$string['name'] = 'Nom';
$string['noassignments'] = 'Il n’y a aucun devoir dans ce cours';
...
$string['privacy:metadata'] = 'Le rapport de remise montre uniquement des données enregistrées dans d’autres endroits.';
$string['profilefields'] = 'Champs de profil';
$string['profilefields_desc'] = 'Inclure ces champs de profil additionnels dans le rapport';
$string['released'] = 'Publié';
$string['revealidentities'] = 'Identités révélées';
$string['selectassignment'] = 'Choisir un devoir pour voir le rapport de remise';
$string['status'] = 'Statut';
$string['statusdraft'] = 'Brouillon';
$string['statusnew'] = 'nouveau';
$string['statusreopened'] = 'réouvert';
$string['statussubmitted'] = 'rendu';
$string['submissions'] = 'Devoirs';
$string['submitdate'] = 'Date de remise';
