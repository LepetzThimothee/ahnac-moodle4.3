...
/**
 * Strings for component 'assignsubmission_maharaws', language 'fr', version '4.3'.
 *
...
$string['errorinvalidapistring'] = 'L’instance Mahara a renvoyé une chaîne API avec un format inattendu.';
...
$string['forceglobalcredentialserror'] = 'L’URL et les informations d’identification Mahara ont été forcées mais ne sont pas définies au niveau du site - veuillez demander à votre administrateur de configurer correctement le plugin de soumission Mahara.';
$string['forceglobalcredentialswarning'] = 'L’URL et les informations d’identification de Mahara ont été définies globalement';
