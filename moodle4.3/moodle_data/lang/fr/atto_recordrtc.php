...
/**
 * Strings for component 'atto_recordrtc', language 'fr', version '4.3'.
 *
...
$string['gumnotsupported'] = 'Votre navigateur n’accepte pas l’enregistrement à travers une connexion non sécurisée et doit fermer le plugin';
...
$string['gumsecurity'] = 'Votre navigateur ne permet pas l’enregistrement lors d’une connexion non sécurisée.';
...
$string['nowebrtc'] = 'Votre navigateur ne supporte pas encore ou partiellement seulement les technologies WebRTC et ne peut donc utiliser cette fonctionnalité. Veuillez mettre à jour votre navigateur ou en utiliser un autre.';
...
$string['recordrtc:recordaudio'] = 'Enregistrer le son directement dans l’éditeur de texte';
$string['recordrtc:recordvideo'] = 'Enregistrer la vidéo directement dans l’éditeur de texte';
