...
/**
 * Strings for component 'block_activity_results', language 'fr', version '4.3'.
 *
...
$string['bestgroupgrades'] = 'Les {$a} groupes avec la moyenne la plus élevée :';
$string['config_decimalplaces'] = 'Nombre de décimales à afficher';
$string['config_format_absolute'] = 'Nombres absolus';
...
$string['config_name_format'] = 'Confidentialité des résultats';
$string['config_names_anon'] = 'Résultats anonymes';
$string['config_names_full'] = 'Afficher les noms';
$string['config_names_id'] = 'Afficher les ID numériques';
$string['config_no_activities_in_course'] = 'Ce cours ne comporte encore aucune activité.';
...
$string['worstgroupgrade'] = 'Groupe avec la moyenne la plus basse';
