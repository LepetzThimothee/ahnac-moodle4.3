...
/**
 * Strings for component 'factor_role', language 'fr', version '4.3'.
 *
 * @package     factor_role
 * @category    string
...
$string['pluginname'] = 'Rôle';
$string['privacy:metadata'] = 'Le plugin Facteur rôle n\'enregistre aucune donnée personnelle.';
