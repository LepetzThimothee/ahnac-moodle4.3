...
/**
 * Strings for component 'theme_more', language 'fr', version '4.3'.
 *
 * @package     theme_more
 * @category    string
...
$string['smalllogodesc'] = 'Le petit logo est affiché dans la barre de navigation. Si un logo d’en-tête est défini pour la page d’accueil et la page de connexion, le petit logo n’est pas affiché sur ces pages.  Si un logo n’est pas défini ici, le logo défini dans Présentation > Logos sera utilisé.';
