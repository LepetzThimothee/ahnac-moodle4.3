...
/**
 * Strings for component 'local_obf', language 'fr', version '4.3'.
 *
 * @package     local_obf
 * @category    string
...
$string['addnew'] = 'Ajouter';
$string['addnewclient'] = 'Ajouter un nouveau client';
$string['addnewcriterion'] = 'Ajouter le cours';
$string['addnewlegacy'] = 'Ajouter une nouvelle connexion legacy API';
$string['addnewoauth2'] = 'Ajouter une nouvelle connexion OAuth2 API';
$string['addrulelabel'] = 'Vous pouvez définir ici où vos badges seront disponibles en associant les catégories OBF aux catégories de cours Moodle. Par défaut, sans règle spécifique, vos badges OBF seront disponibles dans toutes vos catégories de cours Moodle.';
$string['addrules'] = 'Ajouter une règle';
$string['alluseralreadyrevoke'] = 'Tous les utilisateurs ont été révoqués ou ne sont plus enregistrés sur la plateforme.';
...
$string['backpackemail_help'] = 'Adresse de courriel associée à votre compte Open Badge Passport';
...
$string['backpackgroups_help'] = 'Sélectionnez les groupes de badges que vous souhaitez afficher.';
...
$string['badgeissuedbody'] = 'Le badge <b>{$a->badgename}</b> a été attribué à <b>{$a->firstname} {$a->lastname}</b>.<br>Le badge a été attribué dans le cours <b>{$a->courselink}.</b>';
$string['badgeissuedsubject'] = 'Le badge {$a->badgename} a été attribué aux utilisateurs...';
...
$string['badgerevokedbody'] = 'Le badge <b>{$a->badgename}</b> a été révoqué à <b>{$a->firstname} {$a->lastname}</b>.';
$string['badgerevokedsubject'] = 'Le badge {$a->badgename} a été révoqué pour les utilisateurs ...';
$string['badgesonprofiledescri0'] = 'Ne pas afficher les badges sur la page de profil';
$string['badgesonprofiledescri1'] = 'Afficher les badges sur la page de profil';
$string['badgesplatform'] = 'Badges obtenus sur {$a->nameinstance}';
$string['badgetags'] = 'Mots-clés';
$string['badgewasautomaticallyissued'] = 'Après examen, le badge a été attribué à {$a} destinataire(s).';
$string['blacklistbadge'] = 'Ne pas afficher le badge';
$string['blacklistdescription'] = 'Sélectionnez les badges que vous ne voulez pas afficher sur votre page de profil.';
...
$string['choosecategories'] = 'Sélectionnez vos catégories de cours Moodle';
$string['chooseurbadgecategories'] = 'Sélectionnez vos catégories de badges OBF';
$string['client'] = 'Client';
$string['clientdeleted'] = 'Connexion API supprimée';
$string['clientid'] = 'ID client';
$string['clientid_help'] = 'ID client de votre compte OBF';
$string['clientname'] = 'Nom du client';
$string['clientsecret'] = 'Client secret';
$string['clientsecret_help'] = 'Connectez-vous à votre compte Factory et accédez à « Outils d’administration > API ». Cliquez sur « Générer une nouvelle clé secrète »';
...
$string['congratsbadgeearned'] = 'Félicitations ! Vous avez obtenu un nouveau badge : {$a}';
...
$string['contact_openbadgefactory'] = 'Les bénéficiaires de badges peuvent accéder à leurs données personnelles et demander leur effacement en utilisant le lien : <a href="https://openbadgefactory.com/fr/demande-de-donnees/" target="_blank">https://openbadgefactory.com/fr/demande-de-donnees/</a>';
...
$string['courserequired'] = 'Vous devez sélectionner au minimum un cours';
$string['coursereset'] = 'Supprimer les règles d’attribution lorsque le cours est réinitialisé.';
$string['courseuserbadges'] = 'Badges de l’utilisateur';
$string['createcsv'] = 'Télécharger l’historique d’attribution en CSV';
$string['criteria_3'] = 'Champs de profil';
$string['criteria_3_help'] = 'Quels champs de profils doivent être renseignés pour déclencher l’attribution du badge.';
...
$string['criteriacompletedwhenall'] = 'Tous les cours suivant doivent être achevés :';
$string['criteriacompletedwhenany'] = 'L’un des cours suivant doit être achevé :';
...
$string['criteriacourses'] = 'Critère dans cette règle';
...
$string['criteriatypeactivity'] = 'Achèvement d’activités';
$string['criteriatypecourse'] = 'Achèvement de cours';
$string['criteriatypecourseset'] = 'Achèvement de cours';
...
$string['delete_rule_button'] = 'Supprimer cette règle';
$string['deleteclientconfirm'] = 'Voulez-vous vraiment supprimer cette connexion API ?';
...
$string['exportbadgename'] = 'Nom du badge';
$string['exportexpiresby'] = 'Expire le';
$string['exportextrasettings'] = 'Réglages avancés';
$string['exportissuedfrom'] = 'Délivré depuis';
$string['exportissuedon'] = 'Délivré le';
$string['exportrecipients'] = 'Destinataires';
$string['exportsettings'] = 'Export de badges';
...
$string['image_not_found'] = 'Erreur : impossible de récupérer le lien vers l’image du badge.';
$string['infoconnectapi'] = 'Sélectionner la méthode d’authentification API.  OAuth2 recommandé en niveau Pro.';
$string['invalidclientsecret'] = 'Cet ID client ou clé secrète est invalide.';
$string['invalidcriterion'] = 'Cette règle d’attribution n’est pas valide. Une ou plusieurs conditions ne peuvent pas être remplies et le badge ne sera pas délivré. Cette règle devrait être supprimée.';
...
$string['issuebadge'] = 'Émettre un badge';
$string['issuedfrom'] = 'Émis par';
...
$string['issuerroles'] = 'Permissions';
$string['issuerroles_help'] = 'Rôles autorisés à émettre des badges :';
$string['issuerurl'] = 'URL';
$string['issuethisbadge'] = 'Décerner ce badge';
$string['localevents'] = 'L’historique est limité aux badges délivrés sur cette plateforme';
$string['makeexporteddrafts'] = 'Les badges exportés sont en mode brouillon par défaut';
$string['messageprovider:issued'] = 'Un nouveau badge a été attribué';
$string['messageprovider:issuedbadgetostudent'] = 'Un nouveau badge a été attribué à un étudiant.';
$string['messageprovider:revoked'] = 'Un badge délivré est révoqué';
$string['messageprovider:revokedbadgetostudent'] = 'Le badge d’un étudiant a été révoqué.';
$string['minimumgrade'] = 'Note minimale';
$string['newbadgeearned'] = '<b>{$a->courselink}</b><br><hr><br>Vous avez obtenu un nouveau badge : <b>{$a->badgelink}</b><br><br>Veuillez vérifier votre e-mail pour plus d’informations.';
$string['nobackpackgroups'] = 'Vous n’avez pas de badges publics sur votre Open Badge Passport. Veuillez partager vos badges publiquement afin de pouvoir les afficher sur votre profil Moodle.';
$string['nobadgehistory'] = 'Ce badge n’a pas encore été émis.';
$string['nobadges'] = 'Pas de badges pour l’instant.';
$string['nobadgesearned'] = 'Aucun badge obtenu pour le moment';
...
$string['nocriteriayet'] = 'Pas encore de règles automatiques créées.';
$string['nohistory'] = 'Pas encore de badges émis.';
...
$string['obf:earnbadge'] = 'Obtenez un open badge';
...
$string['obf:viewspecialnotif'] = 'Cette permission permet d’activer l’envoi de notifications lorsqu’un utilisateur reçoit un badge ou lorsque celui-ci est révoqué.';
$string['obfconnectionconfig'] = 'Paramètres de connexion API';
$string['obfurl'] = 'URL de l’API';
$string['obfuserpreferences'] = 'Paramètres open badges';
$string['obpbackpacksettings'] = 'Open Badge Passport';
...
$string['privacy:metadata:activity_name'] = 'Nom de l’activité';
$string['privacy:metadata:backpack_provider'] = 'Fournisseur backpack';
$string['privacy:metadata:badge_blacklists'] = 'Liste noire des badges';
$string['privacy:metadata:badge_groups'] = 'Groupes de badges';
$string['privacy:metadata:completion_method'] = 'Méthode d’achèvement';
$string['privacy:metadata:course_id'] = 'ID du cours';
$string['privacy:metadata:course_name'] = 'Nom du cours';
$string['privacy:metadata:courseid'] = 'ID du cours';
$string['privacy:metadata:criteria_addendum'] = 'Addendum de critères';
$string['privacy:metadata:criteria_type'] = 'Type de critères';
$string['privacy:metadata:criterion'] = 'Critère';
$string['privacy:metadata:email_templates'] = 'Modèles de courriel';
$string['privacy:metadata:expiration_date'] = 'Date d’expiration';
$string['privacy:metadata:footer'] = 'Pied de page';
$string['privacy:metadata:issue_date'] = 'Date de délivrance';
...
$string['profilebadgelistobp'] = 'Badges Open Badge Passport';
...
$string['recipients'] = 'Bénéficiaires';
...
$string['selectbadgestoexport'] = 'Sélectionner les badges à exporter vers Open Badge Factory';
...
$string['showbadgecriteria'] = 'Critères open badge';
...
$string['showconnectionconfig'] = 'Je sais que c’est fonctionnel mais je souhaite tout de même changer le token.';
$string['showmore'] = 'Afficher plus';
$string['showmorerecipients'] = 'plus';
$string['siteadmin'] = 'Administration du site';
...
$string['upgradelegacyapi'] = 'Vous pouvez passer sur l’authentification Oauth2 au niveau Pro.';
$string['urlgroup'] = 'URL';
...
$string['userremoved'] = 'Utilisateur supprimé';
...
$string['verifytokendescription'] = 'Un courriel a été envoyé à l’adresse fournie. Consultez le courriel pour obtenir votre code de vérification.';
