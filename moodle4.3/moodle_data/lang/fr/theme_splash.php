...
/**
 * Strings for component 'theme_splash', language 'fr', version '4.3'.
 *
...
$string['defaulttagline'] = 'Environnement d’apprentissage en ligne';
$string['footnote'] = 'Pied de page';
$string['footnotedesc'] = 'Le contenu de ce champ sera affiché dans le pied-de-page de chaque page.';
$string['hide_tagline'] = 'Cacher le slogan';
$string['hide_taglinedesc'] = 'Cocher cette case pour cacher le slogan sous le logo.';
$string['loginhere'] = 'login !';
$string['logo'] = 'Logo';
$string['logodesc'] = 'Saisissez l’URL d’une image à utiliser comme logo pour ce site, par exemple http://www.monsite.fr/chemin/vers/logo.png. L’image ne devrait pas excéder 230 pixels de largeur.';
$string['pluginname'] = 'Splash';
$string['region-side-post'] = 'Droite';
$string['region-side-pre'] = 'Gauche';
$string['tagline'] = 'Slogan';
$string['taglinedesc'] = 'Un bref slogan à afficher sous le logo du site sur la page d’accueil.';
