...
/**
 * Strings for component 'gradereport_singleview', language 'fr', version '4.3'.
 *
...
$string['gradeitem'] = 'Affichage des notes pour {$a}';
$string['gradeitemcannotbeoverridden'] = 'Cet élément d’évaluation ne peut pas être modifié.';
$string['gradeitemedit'] = 'Modification des notes pour {$a}';
$string['gradeuser'] = 'Affichage des notes de {$a}';
$string['gradeuseredit'] = 'Modification des notes de {$a}';
