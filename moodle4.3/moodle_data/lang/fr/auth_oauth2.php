...
/**
 * Strings for component 'auth_oauth2', language 'fr', version '4.3'.
 *
 * @package     auth_oauth2
 * @category    string
...
$string['plugindescription'] = 'Ce plugin d’authentification affiche une liste de fournisseurs d’identité sur la page de connexion de Moodle. En choisissant un fournisseur d’identité, les utilisateurs peuvent se connecter avec leur accréditation chez d’un fournisseur OAuth 2.';
