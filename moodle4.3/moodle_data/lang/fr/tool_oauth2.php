...
/**
 * Strings for component 'tool_oauth2', language 'fr', version '4.3'.
 *
 * @package     tool_oauth2
 * @category    string
...
$string['acceptrisk'] = 'Je comprends que la désactivation de la vérification par courriel constitue un risque de sécurité.';
$string['acceptrisk_help'] = 'La désactivation de la vérification par courriel constitue un risque de sécurité, car elle peut permettre à des utilisateurs de se connecter sous le nom d’autres utilisateurs.';
