...
/**
 * Strings for component 'block_microsoft', language 'fr', version '4.3'.
 *
...
$string['configure_reset'] = 'Choisir l’action Microsoft Team sur la réinitialisation du cours';
...
$string['course_connected_to_group_pending'] = 'Le cours est configuré pour être connecté à une <b>équipe</b>, mais la création du groupe est <span class="notifyproblem">en attente</span>';
$string['course_connected_to_team'] = 'Le cours est <span class="notifysuccess">connecté</span> à une <b>équipe</b>.';
$string['course_connected_to_team_pending'] = 'Le cours est configuré pour être connecté à une <b>équipe</b>, mais la création de l’équipe est <span class="notifyproblem">en attente</span>.';
...
$string['course_reset_disconnect_and_create_new'] = 'Lorsque le cours est réinitialisé, l’équipe connectée au cours sera renommée comme configurée et archivée. Une nouvelle équipe sera créée et connectée au cours.';
$string['course_reset_disconnect_only'] = 'Lorsque le cours est réinitialisé, l’équipe connectée au cours sera renommée comme configurée, et archivée. Aucune nouvelle équipe ne sera créée.';
$string['course_reset_do_nothing'] = 'Lorsque le cours est réinitialisé, la connexion entre le cours et l’équipe est maintenue. Toutes les modifications apportées par l’utilisateur au cours seront synchronisées avec l’équipe.';
$string['course_reset_option'] = 'Action de l’équipe lors de la réinitialisation du cours';
$string['course_sync_option'] = 'Option de synchronisation';
$string['course_sync_option_disabled'] = 'Désactivé';
$string['course_sync_option_enabled'] = 'Activé';
...
$string['install_office'] = 'Installer Office';
...
$string['reset_option_disconnect_and_create_new'] = 'Se déconnecter et créer une nouvelle équipe.<br/>L’équipe existante connectée au cours sera renommée comme configurée et archivée. Une nouvelle équipe sera créée et connectée au cours.';
$string['reset_option_disconnect_only'] = 'Se déconnecter uniquement.<br/>L’équipe existante connectée au cours sera renommée comme configurée et archivée. Aucune nouvelle équipe ne sera créée.';
$string['reset_option_do_nothing'] = 'Ne rien faire.<br/>L’équipe sera toujours connectée au cours. Les désinscriptions d’utilisateurs entraîneront la suppression de la propriété/du statut de membre de l’utilisateur.';
$string['reset_page_heading'] = 'Remise à zéro de l’action pour {$a}';
