...
/**
 * Strings for component 'pdfannotator', language 'fr', version '4.3'.
 *
...
$string['add_private_comment'] = 'Ajouter un commentaire à une note personnelle';
$string['add_protected_comment'] = 'Ajouter un commentaire à une question privée';
$string['ago'] = 'Il y a {$a}';
$string['all'] = 'tous';
$string['all_answers'] = 'Toutes les réponses';
$string['all_questions'] = 'Toutes les questions';
...
$string['answerstabicon_help'] = 'Cette page peut afficher toutes les réponses ou uniquement les réponses aux questions auxquelles vous vous êtes abonné*. La liste couvre tous les annotateurs de ce cours.<br>*Lorsque vous postez vous-même une question, vous y êtes automatiquement abonné tant que vous ne vous désabonnez pas.';
...
$string['chart_title'] = 'Questions et réponses dans les annotateurs de ce cours';
$string['clicktoopen2'] = 'Cliquer sur le lien {$a} pour afficher le fichier.';
$string['closedquestions'] = 'résolu';
$string['colorPicker'] = 'Choisir une couleur';
$string['comment'] = 'Commentaire';
$string['commentDeleted'] = 'Commentaire supprimé';
$string['comments'] = 'Commentaires';
$string['configmaxbytes'] = 'Taille maximale du fichier';
...
$string['day'] = 'jour';
$string['days'] = 'jours';
$string['decision'] = 'Prendre une décision';
$string['decision:overlappingAnnotation'] = 'Vous avez cliqué sur une zone contenant plusieurs annotations. Indiquez sur laquelle vous vouliez cliquer.';
...
$string['editAnnotation'] = 'L’annotation sera déplacée. <br>Cela pourrait changer le contexte de la question.';
...
$string['error:getimageheight'] = 'Une erreur s’est produite lors de l’obtention d’une hauteur d’image de {$a}.';
$string['error:getimagewidth'] = 'Une erreur s’est produite lors de l’obtention d’une largeur d’image de {$a}.';
$string['error:hideComment'] = 'Une erreur s’est produite lors de la tentative de masquage du commentaire de la vue des participants.';
...
$string['error:markcorrectanswer'] = 'Une erreur s’est produite lors du marquage de la réponse comme correcte.';
$string['error:maximalsizeoffile'] = 'Votre fichier {$a->filename}, car il dépasse {$a->filesize} comme taille maximale des fichiers. Vous pouvez joindre à un commentaire des fichiers d’au plus {$a->maxfilesize}.';
$string['error:missingAnnotationtype'] = 'Le type d’annotation n’existe pas. Il est possible que l’entrée dans la table pdfannotator_annotationtypes soit manquante.';
...
$string['error:printcomments'] = 'Une erreur s’est produite lors de l’ouverture des commentaires d’un fichier PDF.';
...
$string['error:unsupportedextension'] = 'L’extension des données envoyées n’est pas prise en charge. Veuillez sélectionner une autre extension.';
...
$string['modulenameplural'] = 'Annotations PDF';
$string['month'] = 'mois';
$string['months'] = 'mois';
...
$string['pdfannotatorpost'] = 'Commentaires et questions';
