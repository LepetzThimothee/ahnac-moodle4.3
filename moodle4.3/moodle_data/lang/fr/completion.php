...
/**
 * Strings for component 'completion', language 'fr', version '4.3'.
 *
 * @package     completion
 * @category    string
...
$string['all'] = 'Tous';
$string['allconditions'] = 'L\'activité est achevée quand les étudiants font tout ce qui suit :';
...
$string['badautocompletion'] = 'Vous devez sélectionner au moins une condition.';
...
$string['completion_automatic'] = 'Ajouter des conditions';
...
$string['completion_manual'] = 'Les étudiants doivent marquer manuellement cette activité comme terminée';
$string['completion_none'] = 'Aucun';
$string['completionactivitydefault'] = 'Utiliser le réglage par défaut de l’activité';
$string['completionanygrade_desc'] = 'N\'importe quelle note';
...
$string['completionexpected'] = 'Définir un rappel dans la Chronologie';
$string['completionexpected_help'] = 'Ce réglage permet de définir pour les étudiants un rappel qu\'il est temps de travailler sur cette activité. Le rappel « {$a} nécessite une action » est alors indiqué dans le bloc Chronologie sur leur tableau de bord.';
...
$string['completionpassgrade_desc'] = 'Note de réussite';
...
$string['coursecompletionsettings'] = 'Réglages d\'achèvement de cours';
...
$string['defaultactivitycompletioncourse'] = 'Les conditions d\'achèvement par défaut pour les activités de ce cours.';
$string['defaultactivitycompletionsite'] = 'Les conditions d\'achèvement par défaut pour les activités de tous les cours.';
...
$string['emptyconditionsinfo'] = 'Il n\'y a pas de condition d\'achèvement pour cette activité.';
...
$string['incompatibleplugin'] = 'Cette activité ne prend pas en charge';
