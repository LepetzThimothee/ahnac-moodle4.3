...
/**
 * Strings for component 'tool_uploaduser', language 'fr', version '4.3'.
 *
...
$string['invaliduserdatavalues'] = 'Données non valides détectées pour l\'utilisateur « {$a->username} » ({$a->values}) ; elles ont été nettoyées automatiquement.';
