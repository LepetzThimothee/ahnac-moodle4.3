...
/**
 * Strings for component 'local_amos', language 'fr', version '4.3'.
 *
 * @package     local_amos
 * @category    string
...
$string['filtermisfworkplace'] = 'seulement chaînes utilisées dans Moodle Workplace';
...
$string['logfiltersourcebot'] = 'bot (opérations par lots exécutées par un script)';
