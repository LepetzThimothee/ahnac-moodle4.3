...
/**
 * Strings for component 'local_moodleorg', language 'fr', version '4.3'.
 *
...
$string['heroslide_getstarted40_description'] = 'Le LMS Moodle a une nouvelle personnalité et une expérience utilisateur redéfinie, qui améliore l’enseignement et l’apprentissage en ligne pour les enseignants, apprenants et administrateurs.';
$string['heroslide_getstarted40_headline'] = 'Moodle 4.0 – Nouveau look, meilleure expérience utilisateur !';
$string['heroslide_getstarted40_slidecontrol'] = 'Moodle 4.0 est arrivé !';
$string['heroslide_getstarted_description'] = 'Moodle est l’environnement d’apprentissage le plus répandu au monde. Lancez votre propre plateforme d’enseignement en quelques minutes&nbsp;!';
$string['heroslide_getstarted_headline'] = 'Débuter est facile';
$string['heroslide_getstarted_slidecontrol'] = 'Commencez aujourd’hui';
...
$string['heroslide_link_getstarted'] = 'Commencez aujourd’hui';
$string['heroslide_link_getstarted40'] = 'En savoir plus sur Moodle 4.0';
