...
/**
 * Strings for component 'wavefront', language 'fr', version '4.3'.
 *
 * @package     wavefront
 * @category    string
...
$string['editmodel'] = 'Éditer le modèle';
$string['errornomodel'] = 'Aucun fichier de modèle n’a été trouvé dans la galerie';
$string['nocomments'] = 'Pas de commentaires';
$string['stageheight'] = 'Hauteur';
