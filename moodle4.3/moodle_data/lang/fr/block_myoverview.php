...
/**
 * Strings for component 'block_myoverview', language 'fr', version '4.3'.
 *
...
$string['aria:coursesummary'] = 'Résumé du cours :';
$string['aria:customfield'] = 'Afficher {$a} cours';
$string['aria:displaydropdown'] = 'Afficher le menu déroulant';
$string['aria:favourites'] = 'N’afficher que les cours favoris';
$string['aria:future'] = 'Afficher les cours à venir';
$string['aria:groupingdropdown'] = 'Menu déroulant de filtre';
...
$string['future'] = 'À venir';
$string['hidden'] = 'Cours retirés de l’affichage';
$string['hiddencourses'] = 'Retirés de l’affichage';
$string['hidecourse'] = 'Retirer de l’affichage';
...
$string['privacy:metadata:overviewgroupingpreference'] = 'Le réglage du filtre du bloc Vue d’ensemble des cours.';
$string['privacy:metadata:overviewpagingpreference'] = 'La préférence de pagination du bloc Vue d’ensemble des cours.';
$string['privacy:metadata:overviewsortpreference'] = 'Le réglage de tri du bloc Vue d’ensemble des cours.';
