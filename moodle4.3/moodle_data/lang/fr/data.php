...
/**
 * Strings for component 'data', language 'fr', version '4.3'.
 *
 * @package     data
 * @category    string
...
$string['choosepreset'] = 'Ficher de préréglage';
...
$string['createactivity'] = 'Créer vos propres champs pour collecter des données, ou utiliser un préréglage incluant déjà des champs.';
...
$string['datemodified'] = 'Dernière modification :';
...
$string['emptypresetname'] = 'Le nom et le fichier du préréglage ne peuvent pas être vides';
...
$string['errorpresetexistsbutnotoverwrite'] = 'Un préréglage de ce nom existe déjà. Veuillez choisir un autre nom.';
$string['errorpresetnotfound'] = 'Préréglage de nom {$a} introuvable.';
...
$string['failedpresetdelete'] = 'Une erreur est survenue lors de la tentative de suppression du préréglage.';
...
$string['foundnorecords'] = 'Aucune fiche trouvée. <a href="{$a->reseturl}">Tout réinitialiser</a>';
$string['foundrecords'] = '{$a->num} fiches trouvées sur {$a->max}. <a href="{$a->reseturl}">Tout réinitialiser</a>';
$string['fromfile'] = 'Importer d’un fichier zip';
$string['fromfile_help'] = 'L\'importation depuis un ZIP permet d\'importer un préréglage de modèles et de champs enregistré précédemment en format ZIP.';
...
$string['id'] = 'ID de la fiche';
$string['importandapply'] = 'Importer le préréglage et l’appliquer';
...
$string['importpreset_desc'] = 'Le préréglage sera appliqué à cette activité, créant des champs et des modèles. Il n’apparaîtra pas dans la liste des préréglages.';
...
$string['listtemplate'] = 'Modèle vue liste';
...
$string['mapping:mapfields'] = 'Correspondance des champs';
$string['mapping:warningmessagedelete'] = 'Si des champs à supprimer sont du même type que de nouveaux champs dans le préréglage que vous appliquez, vous pouvez les faire correspondre dans Correspondance des champs.';
$string['mapping:warningmessagedeleteandcreate'] = 'Si des champs à supprimer sont du même type que des champs à créer, vous pouvez les faire correspondre dans Correspondance des champs.';
...
$string['nofields'] = 'Pas encore de champ';
$string['nolisttemplate'] = 'Le modèle vue liste n’est pas encore défini';
...
$string['saveaspreset'] = 'Publier le préréglage sur ce site';
...
$string['singletemplate'] = 'Modèle vue fiche unique';
$string['singleview'] = 'Vue fiche unique';
$string['startbuilding'] = 'Commencer à construire votre activité';
...
$string['templatereset'] = 'Modèle réinitialisé';
$string['templateresetall'] = 'Modèles tous réinitialisés';
...
$string['viewtemplates'] = 'Afficher les modèles';
