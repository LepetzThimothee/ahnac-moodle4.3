...
/**
 * Strings for component 'glossary', language 'fr', version '4.3'.
 *
 * @package     glossary
 * @category    string
...
$string['allowcomments_help'] = 'Si ce réglage est activé, tous les utilisateurs ayant les permissions requises pour créer des commentaires pourront en ajouter aux articles des glossaires.';
...
$string['explainalphabet'] = 'Consulter le glossaire à l’aide de cet index';
...
$string['filetoimport_help'] = 'Sélectionner le fichier XML contenant les articles de glossaire à importer.';
