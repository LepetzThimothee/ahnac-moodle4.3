...
/**
 * Strings for component 'ratingallocate', language 'fr', version '4.3'.
 *
...
$string['modify_choices_group_desc_ready'] = 'La phase d’évaluation est terminée, vous pouvez maintenant modifier le nombre d’étudiants de chaque choix ou désactiver certains choix pour faire varier le résultat de la répartition.';
$string['modify_choices_group_desc_ready_alloc_started'] = 'La phase de notation est terminée, vous pouvez maintenant modifier le nombre d’étudiants de chaque choix ou désactiver certains choix pour faire varier le résultat de la répartition';
...
$string['too_few_choices_to_rate'] = 'Il y a trop peu de choix pour évaluer! Les étudiants doivent classer au moins {$a} choix !';
