...
/**
 * Strings for component 'pulse', language 'fr', version '4.3'.
 *
 * @package     pulse
 * @category    string
...
$string['completionself'] = 'Marquer comme terminé par l\'élève pour achever cette activité';
...
$string['modulename_help'] = 'Pulse est le couteau suisse de l\'enseignant pour améliorer l\'engagement et le respect des élèves dans les cours Moodle :
...
<li>L\'activité Pulse est <b>disponible</b>. Pulse ne fonctionne que si l\'activité est accessible à l\'élève. C\'est le « déclencheur » ou la « condition » que nous utilisons pour déterminer si nous devons réellement faire quelque chose (par exemple, attribuer des crédits). —> Vérifiez si l\'activité Pulse est masquée ou comporte une restriction qui n\'est pas respectée par l\'étudiant ; dans les deux cas, il est « désactivé » et ne fonctionnera pas. Si vous n\'êtes pas sûr, connectez-vous simplement en tant qu\'étudiant et vérifiez si l\'étudiant voit l\'activité Pulse - s\'il la voit, elle est activée ; si l\'élève ne le voit pas, elle est désactivée.</li>
