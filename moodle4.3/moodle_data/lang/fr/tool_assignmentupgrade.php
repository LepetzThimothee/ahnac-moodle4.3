...
/**
 * Strings for component 'tool_assignmentupgrade', language 'fr', version '4.3'.
 *
...
$string['batchoperations'] = 'Opérations par lots';
$string['batchupgrade'] = 'Mettre à jour plusieurs devoirs';
$string['confirmbatchupgrade'] = 'Confirmer la mise à jour de plusieurs devoirs par lots';
...
$string['noassignmentsselected'] = 'Aucun devoir sélectionné';
