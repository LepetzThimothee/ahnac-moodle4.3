...
/**
 * Strings for component 'scheduler', language 'fr', version '4.3'.
 *
 * @package     scheduler
 * @category    string
...
$string['field-filecount'] = 'Nombre de fichiers déposés';
...
$string['groupbookings_help'] = 'Permettre aux étudiants de réserver un créneau pour tous les membres de leur groupe.
...
$string['groupmodeyourgroupsempty'] = 'Mode de groupe : {$a->groupmode}. Vous n’êtes pas membre d’un groupe, donc les étudiants ne peuvent pas prendre rendez-vous avec vous.';
...
$string['privacy:metadata:scheduler_appointment:appointmentnote'] = 'Annotation de l’enseignant (visible par l’étudiant)';
...
$string['registeredlbl'] = 'Étudiants enregistrés en rendez-vous';
$string['reminder'] = 'Rappel';
$string['requireupload'] = 'Un fichier à déposer est requis';
...
$string['studentfiles'] = 'Fichier(s) déposé(s)';
...
$string['studentprovided'] = 'Étudiant pourvu : {$a}';
...
$string['unattended'] = 'Étudiants à recevoir';
$string['unlimited'] = 'Sans limite';
$string['unregisteredlbl'] = 'Étudiants sans rendez-vous';
$string['upcomingslots'] = 'Prochains créneaux horaires';
$string['updategrades'] = 'Enregistrer les notes';
$string['updatesingleslot'] = '';
$string['uploadmaxfiles'] = 'Nombre maximum de fichiers déposés';
$string['uploadmaxfiles_help'] = 'Le nombre maximum de fichiers qu’un étudiant peut déposer dans le formulaire de réservation. Le dépôt de fichier est facultatif sauf si la case « Fichier à déposer requis » est cochée. Si cette option est définie sur 0, les étudiants ne verront pas la boîte de dépôt de fichier.';
$string['uploadmaxfilesglobal'] = 'Nombre maximum de fichiers déposés';
$string['uploadmaxfilesglobal_desc'] = 'Le nombre maximum de fichiers qu’un étudiant peut déposer dans un formulaire de réservation. Cela peut être réduit davantage au niveau des rendez-vous individuels.';
$string['uploadmaxsize'] = 'Taille maximale de fichier';
$string['uploadmaxsize_help'] = 'Taille maximale du fichier pour les dépôts par les étudiants. Cette limite s’applique par fichier.';
$string['uploadrequired'] = 'Vous devez déposer des fichiers avant de réserver ce créneau.';
$string['uploadstudentfiles'] = 'Déposer des fichiers';
$string['usebookingform'] = 'Utiliser le formulaire de réservation';
$string['usebookingform_help'] = 'Si activé, l’étudiant visualise un écran de réservation séparé avant de pouvoir réserver un créneau. L’écran de réservation peut lui demander de saisir des données, de déposer des fichiers ou de saisir un captcha (voir les options ci-dessous).';
