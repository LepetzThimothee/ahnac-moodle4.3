...
/**
 * Strings for component 'filter_poodll', language 'fr', version '4.3'.
 *
...
$string['audiotranscodedetails'] = 'Conversion des fichiers audio enregistrés ou déposés au format MP3 avant de les stocker dans Moodle. Fonctionne seulement lorsque vous utilisez le serveur tokyo.poodll.com, ou les enregistrements déposés si vous utilisez FFMPEG.';
...
$string['maxmonth'] = 'Mois le plus haut';
...
$string['ppn_speak_auto_grade'] = 'Parler (auto-classement)';
$string['ppn_tinymce_poodll'] = 'Poodll TinyMCE';
$string['ppn_voice_studio'] = 'Studio vocal';
$string['ppn_word_cards_standard'] = 'Fiches de mots (standard)';
...
$string['privacy:metadata'] = 'Le plugin filtre Poodll n’enregistre aucune donnée personnelle.';
...
$string['recui_uploading'] = 'dépôt en cours';
...
$string['videotranscodedetails'] = 'Convertir automatiquement au format MP4 les fichiers vidéo enregistrés ou déposés avant de les stocker dans Moodle. Fonctionne seulement lorsque vous utilisez le serveur tokyo.poodll.com, ou les enregistrements déposés si vous utilisez FFMPEG.';
