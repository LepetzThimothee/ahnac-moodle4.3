...
/**
 * Strings for component 'enrol_lti', language 'fr', version '4.3'.
 *
 * @package     enrol_lti
 * @category    string
...
$string['registerplatformdeleteconfirm'] = 'Voulez-vous vraiment supprimer l’enregistrement de la plateforme « {$a} » ? Cette opération supprimera aussi tous les déploiements d’outil associés à cet enregistrement.';
