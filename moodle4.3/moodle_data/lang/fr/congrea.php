...
/**
 * Strings for component 'congrea', language 'fr', version '4.3'.
 *
 * @package     congrea
 * @category    string
...
$string['attendencereport'] = 'État des présences';
$string['audio'] = 'Audio';
...
$string['congrea:attendance'] = 'État des présences';
...
$string['deleterecordingfile'] = 'Voulez-vous vraiment supprimer le fichier enregistré <br> « {$a} » ?';
$string['deleteschedule'] = 'Voulez-vous vraiment supprimer ?';
...
$string['srecordingsection_help'] = '<b>Paramètres Étudiant</b> - Ces paramètres auront une incidence sur les droits d’enregistrement des étudiants.';
