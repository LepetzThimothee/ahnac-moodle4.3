...
/**
 * Strings for component 'quiz', language 'fr', version '4.3'.
 *
 * @package     quiz
 * @category    string
...
$string['addarandomquestion_success'] = 'Des questions aléatoires ont été ajoutées';
...
$string['addselectedquestionstoquiz'] = 'Ajouter les questions sélectionnées au test';
...
$string['attempterrorcontentchange'] = 'La prévisualisation du test n’existe plus (lorsqu’un test est modifié, toutes les prévisualisations en cours sont supprimées).';
...
$string['attemptgradeddelay'] = 'Délai avant notification d’évaluation';
$string['attemptgradeddelay_desc'] = 'Un délai est appliqué avant d’envoyer à l’étudiant une notification d’évaluation, pour donner à l’enseignant le temps de modifier la note.';
...
$string['attemptquiz'] = 'Effectuer le test';
...
$string['attempts_help'] = 'Le nombre total de tentatives autorisées (pas le nombre de tentatives supplémentaires).';
...
$string['cannotremoveallsectionslots'] = 'Vous avez sélectionné toutes les questions sous l’en-tête de section « {$a} ». Il n’est pas permis de supprimer toutes les questions sous un en-tête de section.';
...
$string['cannotsetsumgrades'] = 'Impossible de modifier la somme des notes';
...
$string['categorynoedit'] = 'Vous n’avez pas les permissions requises pour modifier la catégorie « {$a} ».';
...
$string['completionattemptsexhausted'] = 'Note de réussite ou toutes les tentatives disponible terminées';
...
$string['completiondetail:passgrade'] = 'Obtenir une minimale de réussite';
$string['completiondetail:passorexhaust'] = 'Obtenir une note minimale de réussite ou terminer toutes les tentatives disponibles';
$string['completionminattempts'] = 'Minimum de tentatives';
$string['completionminattemptsdesc'] = 'Nombre minimal de tentatives requises : {$a}';
...
$string['completionpass'] = 'Requiert une note minimale de réussite';
$string['completionpass_help'] = 'Si ce réglage est activé, l’activité est considérée comme terminée lorsque l’étudiant reçoit la note minimale de réussite (définie ainsi dans la section Notes des réglages du test) ou une note supérieure.';
$string['completionpassdesc'] = 'L’étudiant doit atteindre une note minimale de réussite pour achever cette activité';
$string['completionpassorattemptsexhausteddesc'] = 'L’étudiant doit obtenir une note minimale de réussite ou épuiser toutes les tentatives disponibles pour achever cette activité';
...
$string['configattemptsallowed'] = 'La restriction du nombre de tentatives des participants est autorisée.';
...
$string['configdecimalplacesquestion'] = 'Le nombre de décimales à afficher lors de l’affichage des points pour chaque question.';
...
$string['configrequirepassword'] = 'Les étudiants doivent saisir ce mot de passe avant de pouvoir faire le test.';
...
$string['confirmclose'] = 'Une fois vos réponses envoyées, vous n’aurez plus la possibilité de les modifier.';
...
$string['decimalplacesquestion'] = 'Décimales dans les points des questions';
$string['decimalplacesquestion_help'] = 'Le nombre de décimales à afficher dans l’affichage des points pour chaque question.';
...
$string['edit_slotdisplaynumber_hint'] = 'Modifier le numéro de question (maximum 16 caractères)';
$string['edit_slotdisplaynumber_label'] = 'Nouvelle valeur pour {$a}';
...
$string['emailconfirmautosubmitsmall'] = 'Merci d’avoir envoyé vos réponses au test « {$a->quizname} »';
...
$string['emailconfirmbodyautosubmit'] = 'Bonjour {$a->username},

Le temps imparti pour le test « {$a->quizname} » dans le cours « {$a->coursename} » est arrivé à échéance. Vos réponses ont été envoyées automatiquement à {$a->submissiontime}.

Ce message confirme que vos réponses ont été enregistrées.

Vous pouvez accéder à ce test via l’adresse {$a->quizurl}.';
...
$string['emailmanualgradedbody'] = 'Bonjour {$a->studentname},
...
$string['eventattemptautosaved'] = 'Tentative de test enregistrée automatiquement';
$string['eventattemptdeleted'] = 'Tentative de test supprimée';
$string['eventattemptmanualgradingcomplete'] = 'Évaluation manuelle de la tentative de test terminée';
$string['eventattemptpreviewstarted'] = 'Prévisualisation de tentative de test commencée';
$string['eventattemptquestionrestarted'] = 'Tentative de test recommencée';
$string['eventattemptreviewed'] = 'Tentative de test relue';
$string['eventattemptsummaryviewed'] = 'Résumé de tentative de test consulté';
$string['eventattemptupdated'] = 'Tentative de test modifiée';
...
$string['eventpagebreakcreated'] = 'Saut de page créé';
$string['eventpagebreakdeleted'] = 'Saut de page supprimé';
...
$string['eventquizattemptregraded'] = 'Tentative de test recalculée';
$string['eventquizattemptreopened'] = 'Tentative de test réouverte';
...
$string['eventquizgradeupdated'] = 'Note de test modifiée';
$string['eventquizrepaginated'] = 'Test repaginé';
$string['eventreportviewed'] = 'Rapport de test consulté';
$string['eventsectionbreakcreated'] = 'Saut de section créé';
$string['eventsectionbreakdeleted'] = 'Saut de section supprimé';
$string['eventsectionshuffleupdated'] = 'Mélange de section modifié';
$string['eventsectiontitleupdated'] = 'Titre de section modifié';
$string['eventslotcreated'] = 'Créneau créé';
$string['eventslotdeleted'] = 'Créneau supprimé';
$string['eventslotdisplayedquestionnumberupdated'] = 'Numéro de question affiché modifié';
$string['eventslotmarkupdated'] = 'Marque de créneau modifiée';
$string['eventslotmoved'] = 'Créneau déplacé';
$string['eventslotrequirepreviousupdated'] = 'Valeur obligatoire antérieure du créneau modifiée';
...
$string['feedbackerrororder'] = 'Les limites des notes des feedbacks doivent être triées, la plus haute en premier. La valeur saisie pour la limite {$a} n’est pas dans l’ordre.';
$string['file'] = 'Fichier';
...
$string['filloutoneanswer'] = 'Vous devez fournir au moins une proposition. Les propositions laissées vides ne seront pas prises en compte. Le caractère * (joker) peut être utilisé pour correspondre à n’importe quel caractère. La première proposition correspondant à la réponse donnée par le participant sera utilisée pour déterminer la note et le feedback.';
...
$string['fillouttwochoices'] = 'Vous devez donner au moins deux propositions. Les propositions laissées vides ne seront pas prises en compte.';
...
$string['gradetopassmustbeset'] = 'La note de réussite ne peut pas être zéro, car l’achèvement de ce test requiert une note minimale de réussite. Veuillez indiquer une note non nulle.';
...
$string['indicator:socialbreadth_help'] = 'Cet indicateur se base sur l’interaction sociale atteinte par l’étudiant dans une activité Test.';
...
$string['info'] = 'Info';
$string['infoshort'] = 'i';
$string['initialnumfeedbacks'] = 'Nombre initial de champs pour le feedback global';
$string['initialnumfeedbacks_desc'] = 'Ce réglage détermine le nombre de champs vides pour le feedback global lors de la création d’un nouveau test. Une fois le test créé, le formulaire affiche le nombre de champs requis pour le nombre de feedbacks du test. Ce réglage doit être au minimum 1.';
...
$string['layoutshuffledsinglepage'] = 'Questions mélangées aléatoirement, toutes sur une seule page.';
$string['link'] = 'Lien';
...
$string['marks'] = 'Points';
$string['marks_help'] = 'Les points obtenus pour chaque question, ainsi que le nombre total de points de la tentative. Il n\'est possible de cocher « Points » que si « Maximum des points » est coché.';
...
$string['maxmarks'] = 'Maximum des points';
$string['maxmarks_help'] = 'Le maximum des points disponible pour chaque question.';
$string['messageprovider:attempt_grading_complete'] = 'Notification que votre tentative a été évaluée';
...
$string['navmethod_help'] = 'Lorsque la navigation séquentielle est activée, les étudiants doivent parcourir le test dans l’ordre et ne peuvent ni revenir à la page précédente, ni passer à une page ultérieure.';
...
$string['noquestionsinquiz'] = 'Il n’y a pas de question dans ce test.';
...
$string['noreviewshort'] = 'Relecture non autorisée';
...
$string['noview'] = 'L’utilisateur connecté n’a pas les permissions requises pour voir ce test';
...
$string['onlyteachersimport'] = 'Seuls les enseignants (éditeurs) peuvent importer des questions';
...
$string['previewquizstart'] = 'Prévisualiser le test';
...
$string['privacy:metadata:quiz_attempts'] = 'Informations sur chaque tentative d’un test.';
...
$string['privacy:metadata:quiz_attempts:gradednotificationsenttime'] = 'L’horodatage de la notification de l’utilisateur que l’évaluation manuelle de sa tentative de test est terminée';
...
$string['privacy:metadata:quiz_attempts:timefinish'] = 'La date et l’heure de la fin de la tentative.';
...
$string['publishedit'] = 'Pour ajouter ou modifier une question de cette catégorie, vous devez avoir les permissions requises dans le cours publiant cette catégorie.';
$string['qbrief'] = 'Q. {$a}';
$string['qname'] = 'nom';
...
$string['questiondraftonly'] = 'La question {$a} est dans l’état brouillon. Pour l’utiliser dans un test, visiter la banque de questions et changer son statut sur prêt.';
$string['questiondraftwillnotwork'] = 'La question est dans l’état brouillon. Pour l’utiliser dans un test, visiter la banque de questions et changer son statut sur prêt.';
...
$string['questionversionlatest'] = 'v{$a} (dernière)';
...
$string['quiz:emailnotifyattemptgraded'] = 'Recevoir une notification lorsque votre tentative a été évaluée';
...
$string['quiz:regrade'] = 'Recalculer les tentatives des tests';
$string['quiz:reopenattempts'] = 'Réouvrir les tentatives de test jamais envoyées';
$string['quiz:reviewmyattempts'] = 'Relire ses propres tentatives';
$string['quiz:view'] = 'Consulter les informations des tests';
...
$string['randomnosubcat'] = 'Questions aléatoires tirées de cette catégorie (sans les sous-catégories).';
$string['randomnumber'] = 'Nombre de questions aléatoires';
$string['randomqname'] = 'Questions aléatoires basées sur une condition de filtre';
$string['randomqnametags'] = 'Questions aléatoires basées sur une condition de filtre avec les tags : {$a}';
...
Les questions aléatoires seront sélectionnées parmi les questions qui ont tous ces tags.';
...
$string['regradecomplete'] = 'Toutes les tentatives ont été recalculées';
...
$string['regradenotallowed'] = 'Vous n’avez pas les permissions requises pour recalculer ce test';
...
$string['reopenattempt'] = 'Réouvrir';
$string['reopenattemptareyousuremessage'] = 'Voulez-vous vraiment réouvrir la tentative de test {$a->attemptnumber} de {$a->attemptuser} ?';
$string['reopenattemptareyousuretitle'] = 'Confirmer la réouverture ?';
$string['reopenattemptwrongstate'] = 'La tentative {$a->attemptid} est dans le statut {$a->state} incorrect pour permettre sa réouverture.';
$string['reopenedattemptwillbeinprogress'] = 'La tentative restera ouverte et peut être continuée.';
$string['reopenedattemptwillbeinprogressuntil'] = 'La tentative restera ouverte et peut être continuée jusqu\'à ce que le test se ferme le {$a}.';
$string['reopenedattemptwillbesubmitted'] = 'La tentative sera immédiatement envoyée pour évaluation.';
...
$string['requirepassword_help'] = 'Si un mot de passe est indiqué, les étudiants doivent le saisir avant de pouvoir faire le test.';
...
$string['selectquestionslot'] = 'Sélectionner la question {$a}';
...
$string['submission_confirmation'] = 'Envoyer toutes vos réponses et terminer ?';
$string['submission_confirmation_unanswered'] = 'Questions sans réponse : {$a}';
...
$string['subnetnotice'] = 'Ce test a été configuré de façon à ne pouvoir être effectué que depuis certains ordinateurs. Votre ordinateur n’est pas situé dans un sous-réseau autorisé. En tant qu’enseignant, vous pouvez toutefois le prévisualiser.';
...
$string['updatefilterconditon'] = 'Modifier les conditions de filtre';
$string['updatefilterconditon_success'] = 'Conditions de filtre modifiées';
