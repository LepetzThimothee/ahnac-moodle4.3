...
/**
 * Strings for component 'block_mrbs', language 'fr', version '4.3'.
 *
 * @package     block_mrbs
 * @category    string
...
$string['config_date_ddmmyy'] = '10 juillet';
$string['config_date_mmddyy'] = '10 juillet';
$string['confirmdel'] = 'Voulez-vous vraiment effacer cette réservation ?';
...
$string['mail_subject_delete'] = 'Réservation supprimée dans le système de réservation';
$string['mail_subject_entry'] = 'Réservation ajoutée/modifiée dans le système de réservation';
...
$string['sure'] = 'Voulez-vous vraiment continuer ?';
