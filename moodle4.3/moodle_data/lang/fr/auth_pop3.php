...
/**
 * Strings for component 'auth_pop3', language 'fr', version '4.3'.
 *
 * @package     auth_pop3
 * @category    string
...
$string['privacy:metadata'] = 'Le plugin d’authentification Serveur POP3 n’enregistre aucune donnée personnelle.';
