...
/**
 * Strings for component 'theme_boost_magnific', language 'fr', version '4.3'.
 *
...
$string['choosereadme'] = 'Boost Magnific est un thème moderne hautement personnalisable. Ce thème est destiné à être utilisé directement ou en tant que thème parent lors de la création de nouveaux thèmes à l’aide de Bootstrap 4.';
$string['contact_address'] = 'Adresse';
$string['contact_email'] = 'E-mail';
$string['contact_phone'] = 'Numéro de téléphone';
$string['content_pagefonts'] = 'Polices supplémentaires de Google';
$string['content_pagefonts_desc'] = 'Ajoutez ici le lien @import de Google pour les polices supplémentaires.<br>Vous pouvez ajouter plusieurs importations.<br><a href="https://fonts.google.com/selection/embed" target="google">Code d\'intégration</a><br><img src="{$a}" style="max-width: 100%;width: 420px;">';
