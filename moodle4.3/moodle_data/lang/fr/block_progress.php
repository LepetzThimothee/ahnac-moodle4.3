...
/**
 * Strings for component 'block_progress', language 'fr', version '4.3'.
 *
...
$string['config_header_showsubmitted'] = 'Afficher la remise avant l’action';
$string['config_icons'] = 'Utiliser les icônes de la barre';
$string['config_longbars'] = 'Comment présenter les longues barres';
...
$string['config_scroll'] = 'Défilement';
$string['config_squeeze'] = 'Écraser';
...
$string['config_warning_logstores'] = 'Avertissement : La journalisation est désactivée. Les actions s’appuyant sur des vues ne seront pas prises en considération.';
$string['config_wrap'] = 'En couches';
$string['coursenametoshow'] = 'Nom du cours à afficher sur le tableau de bord';
$string['cross'] = 'Barrer';
$string['data'] = 'Base de données';
$string['defaultlongbars'] = 'Présentation par défaut pour les longues barres';
...
$string['how_group_works_help'] = '<p>La sélection d’un groupe limitera l’affichage de ce bloc uniquement à ce groupe.</p>';
$string['how_longbars_works'] = 'Comment les longues barres sont présentées';
$string['how_longbars_works_help'] = '<p>Lorsque les barres dépassent une longueur définie, elles peuvent se présenter dans l’une des façons suivantes :</p>
<ul>
<li>Par écrasement dans une barre horizontale</li>
<li>Par défilement latéral pour montrer segments de la barre dépassant la limite</li>
<li>Par couches pour afficher tous les segments de la barre sur plusieurs lignes</li>
</ul>
<p>Notez que lorsque la barre est en plusieurs couches, l’indicateur MAINTENANT ne sera pas affiché.</p>';
...
$string['mouse_over_prompt'] = 'Placez la souris sur le bloc pour plus d’informations.';
...
$string['passedby'] = 'réussi par date limite';
...
$string['responded_to'] = 'répondu à';
$string['scorm'] = 'SCORM';
$string['selectitemstobeadded'] = 'Choisissez des activités/ressources';
$string['shortname'] = 'Nom abrégé du cours';
$string['showallinfo'] = 'Montrer toutes les informations';
$string['showinactive'] = 'Afficher les étudiants inactifs dans le tableau de bord';
$string['subcourse'] = '';
$string['submitted'] = 'envoyé';
$string['submittednotcomplete_colour'] = '#FFCC00';
$string['submittednotcomplete_colour_descr'] = 'Code couleur HTML pour les éléments envoyés, mais pas encore terminés';
$string['submittednotcomplete_colour_title'] = 'Couleur pour envoyé mais pas terminé';
$string['survey'] = 'Sondage';
$string['tick'] = 'Cocher';
...
$string['what_show_submitted_means'] = 'Ce que signifie « envoyé, en attente d’une action ».';
$string['what_show_submitted_means_help'] = 'Certaines activités permettent à l’étudiant d’envoyer des éléments. Lorsque les étudiants ont envoyé un document, mais qu’une action (comme l’évaluation) est attendue et que l’activité n’est donc pas totalement terminée, la barre de progression changera de couleur pour indiquer qu’un travail a été envoyé.';
$string['why_display_now'] = 'Pourquoi montrer/cacher l’indicateur « MAINTENANT »?';
...
$string['wrapafter'] = 'Si plusieurs couches, limite de lignes à';
