...
/**
 * Strings for component 'repository_skydrive', language 'fr', version '4.3'.
 *
...
$string['oauthinfo'] = '<p>Pour utiliser ce plugin, vous devez enregistrer votre site <a href="https://account.live.com/developers/applications/">chez Microsoft</a>.</p><p>Au cours du processus d’enregistrement, vous devrez saisir l’URL suivante sous « Domaine de redirection »:</p><p>{$a->callbackurl}</p><p>Une fois l’enregistrement effectué, un ID client et un secret vous seront fournis, que vous pourrez saisir dans ce formulaire.</p>';
