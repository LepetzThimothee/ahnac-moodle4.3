...
/**
 * Strings for component 'moodleoverflow', language 'fr', version '4.3'.
 *
...
$string['privacy:metadata:moodleoverflow_discussions'] = 'Information sur les discussions de forum. Cela inclut quelles discussions un utilisateur a lancées.';
$string['privacy:metadata:moodleoverflow_discussions:name'] = 'Le nom de la discussion.';
...
$string['re'] = 'Re :';
$string['reply'] = 'Commenter';
$string['replyfirst'] = 'Répondre';
