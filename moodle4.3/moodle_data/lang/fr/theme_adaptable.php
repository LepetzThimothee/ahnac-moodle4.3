...
/**
 * Strings for component 'theme_adaptable', language 'fr', version '4.3'.
 *
...
$string['activatetemplateoverride'] = 'Activer le remplacement du modèle pour « {$a} »';
...
$string['alertaccessadmins'] = 'Visible par les administrateurs';
...
$string['alertbordercolorinfo'] = 'Couleur de la bordure des informations';
$string['alertbordercolorinfodesc'] = 'Couleur de bordure des fenêtres d’alerte de type Info.';
$string['alertbordercolorsuccess'] = 'Couleur de la bordure de l\'annonce';
$string['alertbordercolorsuccessdesc'] = 'Couleur de bordure des fenêtres d’alerte de type Annonce.';
$string['alertbordercolorwarning'] = 'Couleur de la bordure des avertissements';
...
$string['alertcolorwarning'] = 'Couleur des alertes';
...
$string['alerthiddencourse'] = 'Alerte de cours cachés';
$string['alerthiddencoursedesc'] = 'Avertir les enseignants que les cours sont cachés.';
$string['alerthiddencoursetext-end'] = '.';
$string['alerthiddencoursetext-link'] = 'Cliquer ici pour mettre à jour les paramètres';
$string['alerthiddencoursetext-start'] = 'Ce cours est caché et les étudiants ne peuvent pas y avoir accès,';
...
$string['alerticonwarning'] = 'Icône pour les avertissements';
...
$string['blockicons'] = 'Icônes pour les blocs';
...
$string['blocklayoutlayoutrow'] = 'Ligne de la région de bloc';
...
$string['blockmainbordertopstyle'] = 'Style de la bordure principale de bloc';
...
$string['buttonfocuscolor'] = 'Couleur du bouton focus';
$string['buttonfocuscolordesc'] = 'La couleur que le bouton utilise lors du focus sur le bouton.';
$string['buttonfocuscoloropacity'] = 'Opacité de la couleur du bouton focus';
$string['buttonfocuscoloropacitydesc'] = 'L’opacité que le bouton utilise pour la couleur lors du focus sur le bouton.';
$string['buttonhovercolor'] = 'Couleur du bouton au survol';
...
$string['buttontexthovercolor'] = 'Couleur de survol du texte du bouton';
$string['buttontexthovercolordesc'] = 'La couleur que prend le texte du bouton au survol';
$string['cachedef_adaptablefontawesomeiconmapping'] = 'Masque les icônes FontAwesome';
...
$string['categoryheaderbgimagetextcolour'] = 'Couleur du texte de l\'image de fond de la catégorie « {$a->name} » avec l\'identifiant « {$a->id} »';
$string['categoryheaderbgimagetextcolourdesc'] = 'Définir une couleur de texte pour l\'image d\'arrière-plan de la catégorie de premier niveau « {$a->name} » avec l\'identifiant « {$a->id} » dans l\'en-tête.';
$string['categoryheaderbgimagetextcolourdescchildren'] = 'Définir une couleur d\'arrière-plan pour la catégorie de premier niveau « {$a->name} » avec l\'identifiant « {$a->id} » et ses enfants « {$a->children} » dans l\'en-tête.';
...
$string['courseindexitemhovercolordesc'] = 'La couleur de survol de l’élément sur l\'« Index du cours » dans un cours.';
$string['courseindexpageitembgcolor'] = 'Couleur d’arrière-plan de l’élément de la page';
$string['courseindexpageitembgcolordesc'] = 'La couleur d’arrière-plan de l’élément de la page sur l\'« Index du cours » dans un cours.';
$string['courseindexpageitemcolor'] = 'Couleur de l’élément de la page';
$string['courseindexpageitemcolordesc'] = 'La couleur de l’élément de la page sur l\'« Index du cours » dans un cours.';
$string['courseindexsettings'] = 'Index du cours';
$string['courseindexsettingsdesc'] = 'Personnaliser l’Index du cours';
$string['courseindexsettingsheading'] = 'Paramétrage de l’Index du cours';
...
$string['coursepageblocklayoutbuilder'] = 'Régions des blocs de pages de cours';
...
$string['coursepageblocksenabled'] = 'Activer les blocs de régions personnalisés sur la page du cours';
...
$string['coursepageheaderhidetitle'] = 'Masquer le titre de l\'en-tête sur les pages du cours';
$string['coursepageheaderhidetitledesc'] = 'Masquer le titre de l\'en-tête, le logo et la barre de recherche sur les pages de cours.  Utiliser cette option avec le paramètre de hauteur de l\'en-tête de la page pour afficher un en-tête plus petit sur les pages liées au cours.';
...
$string['customcoursesubtitle'] = 'Sous-titre du cours personnalisé';
$string['customcoursesubtitledesc'] = 'Nom du champ personnalisé du profil de l\'utilisateur pour le sous-titre du cours.';
...
$string['customcssjssettingsheading'] = 'Appliquer vos propres modifications';
$string['customcsssettings'] = 'CSS personnalisée';
$string['customcsssettingsdescription'] = 'Ici vous pouvez trouver différents paramètres pour ajouter votre propre CSS au thème.';
$string['customjs'] = 'JavaScript personnalisé';
$string['customjsdesc'] = 'Ajouter du JavaScript au site.';
$string['customjsfiles'] = 'Fichiers JavaScript personnalisés';
$string['customjsfilesdesc'] = 'Ajouter des fichiers JavaScript au site.';
$string['customjsrestricted'] = 'JavaScript conditionnel';
...
$string['editfont'] = 'Modifier et personnaliser la couleur de la police du bouton de cette page';
...
$string['editoffbk'] = 'Modifier et personnaliser l\'arrière-plan du bouton \'Off\' de cette page';
...
$string['enableblog'] = 'Activer mes blogs';
$string['enableblogdesc'] = 'Affiche un lien vers la page de blogs des utilisateurs.';
...
$string['enablecoursetitle'] = 'Titre du cours';
$string['enablecoursetitledesc'] = 'Définir le mode pour afficher le titre du cours.';
...
$string['fa6name'] = 'Thème FontAwesome 6 version gratuite';
$string['faivdesc'] = 'Lors de l\'utilisation des thèmes FontAwesome 6 Free pour les icônes, ajouter la prise en charge des noms de classe d\'icônes de la version 4.';
$string['fav'] = 'FontAwesome 6 gratuit';
$string['favdesc'] = 'Utiliser la version thématique de FontAwesome 6 Free pour les icônes. Remarque : Merci de consulter la licence dans le dossier des polices du thème.';
$string['favicon'] = 'Favicon';
$string['favicondesc'] = 'Charger une favicon à utiliser sur le site';
$string['favoff'] = 'Core FontAwesome 6 Version gratuite';
...
$string['headerbgimagetextcolour'] = 'Couleur du texte de l\'arrière-plan de l\'image';
$string['headerbgimagetextcolourdesc'] = 'En cas d\'image d\'arrière-plan, utiliser ce paramètre pour définir la couleur du texte qui y est placé.';
...
$string['informationsettingsdesc'] = 'Informations sur le thème Adaptable.';
...
$string['invalidcategorygeneratedscss'] = 'CSS généré personnalisé de catégorie non valide : \'{$a->scss}\'.';
$string['invalidcategoryscss'] = 'Catégorie SCSS personnalisée non valide pour la catégorie \'{$a->topcatname}\' avec l\'ID \'{$a->topcatid}\' : \'{$a->scss}\'.';
...
$string['marketingvisible'] = 'Afficher les blocs marketing lorsque';
$string['marketingvisibledesc'] = 'Afficher les blocs marketing lorsque vous êtes « Déconnecté », « Connecté » ou « Connecté ou déconnecté ».';
$string['marketingvisibleloggedin'] = 'Connecté';
$string['marketingvisibleloggedinout'] = 'Connecté ou déconnecté';
$string['marketingvisibleloggedout'] = 'Déconnecté';
...
$string['mobileprimarynav'] = 'Navigation principale mobile';
$string['mobileprimarynavdesc'] = 'Activer ou désactiver. Remarque : Il s\'agit du menu contrôlé par l\'icône du hamburger.';
...
$string['mysitessortoverridefield'] = 'Champs de profil personnalisé Mes Cours ou chaînes';
...
$string['navbarmycourses'] = 'Barre de navigation mes cours';
...
$string['newstickersettings'] = 'Téléscripteur d\'actualités';
...
$string['orphanedblock'] = '<em>BLOC ORPHELIN - S\'affiche à l\'origine dans : <strong>{$a}</strong></em>';
...
$string['privacy:closed'] = 'Fermé';
$string['privacy:fullin'] = 'Complet';
$string['privacy:metadata:preference:collapseblock'] = 'L\'état des blocs sur une page.';
$string['privacy:metadata:preference:draweropenblock'] = 'L\'état du tiroir de bloc.';
$string['privacy:metadata:preference:draweropenindex'] = 'L\'état de l\'index du cours.';
$string['privacy:metadata:preference:themeadaptablealertkey'] = 'L\'alerte donnée.';
$string['privacy:metadata:preference:themeadaptablefull'] = 'L\'état du plein écran.';
$string['privacy:metadata:preference:themeadaptablezoom'] = 'L\'état du zoom.';
$string['privacy:nofull'] = 'Incomplet';
$string['privacy:note'] = 'Remarque : Le thème Adaptable comporte des paramètres relatifs à sa configuration. Les paramètres utilisateur spécifiques sont décrits dans le « Registre de confidentialité du plugin » et, une fois installés, ils concerneront également le plugin local adaptable. Pour les autres paramètres, il est de votre responsabilité de vous assurer qu\'aucune donnée utilisateur n\'est saisie dans aucun des champs de texte libre. La définition d\'un paramètre entraînera la journalisation de cette action dans le système de journalisation principal de Moodle par rapport à l\'utilisateur qui l\'a modifié. Ceci est en dehors du contrôle des thèmes. Veuillez consulter le système de journalisation principal pour connaître la conformité en matière de confidentialité à ce sujet. Lorsque vous téléchargez des images, vous devez éviter de télécharger des images contenant des données de localisation intégrées (GPS EXIF) ou d\'autres données personnelles similaires. Il serait possible d’extraire n’importe quelle localisation/données personnelles des images. Veuillez examiner attentivement le code pour vous assurer qu\'il est conforme à votre interprétation de vos lois sur la confidentialité. Je ne suis pas avocat et mon analyse est basée sur mon interprétation. Si vous avez le moindre doute, supprimez le thème immédiatement.';
$string['privacy:open'] = 'Ouvert';
$string['privacy:request:preference:collapseblock'] = 'La préférence utilisateur « {$a->name} » pour l\'ID de bloc « {$a->blockid} « a la valeur « {$a->value} » qui représente « {$a->decoded} » pour l\'état du bloc.';
$string['privacy:request:preference:draweropenblock'] = 'La préférence utilisateur « {$a->name} » a la valeur « {$a->value} » qui représente « {$a->decoded} » pour l\'état du tiroir de blocs.';
$string['privacy:request:preference:draweropenindex'] = 'La préférence utilisateur « {$a->name} » a la valeur « {$a->value} » qui représente « {$a->decoded} » pour l\'état de l\'index du cours.';
$string['privacy:request:preference:themeadaptablealertkey'] = 'La préférence utilisateur « {$a->name} » pour l\'ID d\'alerte « {$a->alertid} » a la valeur « {$a->value} » pour l\'alerte donnée, « irrévocable » ou toute autre « clé d\'alerte ». représentant que l’alerte existait pour l’utilisateur.';
$string['privacy:request:preference:themeadaptablefull'] = 'La préférence utilisateur « {$a->name} » a la valeur « {$a->value} » qui représente « {$a->decoded} » pour l\'état du zoom.';
$string['privacy:request:preference:themeadaptablezoom'] = 'La préférence utilisateur « {$a->name} » a la valeur « {$a->value} » qui représente « {$a->decoded} » pour l\'état du zoom.';
...
$string['propertiesexport'] = 'Exporte les propriétés dans une chaîne JSON';
...
$string['responsiveheadertitle'] = 'Titre de l\'en-tête';
$string['responsiveheadertitledesc'] = 'Sur quelle taille d\'écran souhaitez-vous que le titre de l\'en-tête soit affiché ?';
...
$string['responsivesitetitle'] = 'Titre du site';
$string['responsivesitetitledesc'] = 'obsolète, utilisez plutôt « responsiveheadertitle ».';
...
$string['settingspagealertsettings'] = 'Alertes';
...
$string['sitetitlecustom'] = 'Utiliser le titre de site personnalisé (saisir dans la zone « sitetitletext » ci-dessous)';
...
$string['slidervisible'] = 'Afficher le curseur lorsque';
$string['slidervisibledesc'] = 'Afficher le curseur lorsque « Déconnecté », « Connecté » ou « Connecté ou déconnecté ».';
$string['slidervisibleloggedin'] = 'Connecté';
$string['slidervisibleloggedinout'] = 'Connecté ou déconnecté';
$string['slidervisibleloggedout'] = 'Déconnecté';
...
$string['toolsmenuheadingindex'] = 'Menu Outils {$a}';
