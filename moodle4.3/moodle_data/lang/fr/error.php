...
$string['myisamproblem'] = 'Les tables de la base de données utilisent le moteur MyISAM. Il est recommandé d’utiliser un moteur conforme au standard ACID, avec un support complet des transactions, par exemple InnoDB.';
...
$string['pluginunsupported'] = 'Le plugin « {$a->pluginname} » {$a->pluginversion} ne supporte pas cette version de Moodle {$a->moodleversion}. Veuillez consulter les informations du plugin pour trouver les versions supportées.';
...
$string['unsupportedstate'] = 'État d’achèvement non supporté';
$string['unsupportedwebserver'] = 'Ce logiciel serveur web ({$a}) n’est pas supporté.';
