...
/**
 * Strings for component 'block_course_overview', language 'fr', version '4.3'.
 *
...
$string['defaulttabdesc'] = 'Quel onglet sera affiché par défaut lors de l’ouverture du tableau de bord';
...
$string['morecoursestext'] = 'Lister plus de cours';
...
$string['pluginname'] = 'Vue d’ensemble des onglets de cours';
...
$string['setmaxcoursesdesc'] = 'Spécifie le nombre maximal de cours à afficher en une fois par défaut dans le bloc Résumé des cours';
$string['setmaxcoursesmax'] = 'Nombre maximal possible de cours';
$string['setmaxcoursesmaxdesc'] = 'Spécifie le nombre maximal de cours que les utilisateurs peuvent choisir d’afficher dans le bloc Résumé des cours';
...
$string['title'] = 'Vue d’ensemble des onglets de cours';
$string['unfavourite'] = 'Retirer des favoris';
$string['userchoosezero'] = '(utiliser la valeur par défaut)';
$string['usersetmaxcourses'] = 'Nombre de cours à afficher :';
