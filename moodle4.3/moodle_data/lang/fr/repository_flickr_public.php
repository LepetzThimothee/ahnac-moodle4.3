...
/**
 * Strings for component 'repository_flickr_public', language 'fr', version '4.3'.
 *
...
$string['backtosearch'] = 'Retour à l’écran de recherche';
$string['by'] = 'Paternité';
...
$string['commercialuse'] = 'Je veux utiliser les images commercialement';
...
$string['flickr_public:view'] = 'Utiliser un dépôt Flickr public dans le sélecteur de fichiers';
...
$string['modification'] = 'Je veux pouvoir modifier les images';
...
$string['privacy:metadata:repository_flickr_public'] = 'Le plugin de dépôt Flickr public n’enregistre aucune donnée personnelle, mais transmet des données des utilisateurs de Moodle vers le système distant.';
$string['privacy:metadata:repository_flickr_public:author'] = 'L’auteur du contenu du dépôt Flickr public.';
$string['privacy:metadata:repository_flickr_public:email_address'] = 'L’adresse de courriel de l’utilisateur du dépôt Flickr public.';
$string['privacy:metadata:repository_flickr_public:text'] = 'La requête de recherche utilisateur du dépôt Flickr public.';
$string['privacy:metadata:repository_flickr_public:user_id'] = 'L’identifiant de l’utilisateur du dépôt Flickr public.';
...
$string['watermark'] = 'Ajouter un filigrane aux photos';
