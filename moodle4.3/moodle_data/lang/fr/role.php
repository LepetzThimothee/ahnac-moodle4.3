...
/**
 * Strings for component 'role', language 'fr', version '4.3'.
 *
 * @package     role
 * @category    string
...
$string['cohort:configurecustomfields'] = 'Configurer les champs de cohorte personnalisés';
...
$string['confirmaddadmins'] = 'Voulez-vous vraiment ajouter les utilisateurs suivants à la liste des administrateurs ?';
...
$string['confirmremoveadmins'] = 'Voulez-vous vraiment retirer les utilisateurs suivants de la liste des administrateurs ?';
...
$string['contentbank:copyanycontent'] = 'Copier des contenus de la banque de contenus';
$string['contentbank:copycontent'] = 'Copier du contenu de la banque de contenus';
...
$string['course:configurecoursecommunication'] = 'Configurer les réglages de communication du cours';
...
$string['course:viewhiddengroups'] = 'Montrer les groupes cachés';
...
$string['group:configurecustomfields'] = 'Configurer les champs personnalisés de groupe et de groupement';
...
$string['moodlenet:shareactivity'] = 'Partager des activités sur MoodleNet';
$string['moodlenet:sharecourse'] = 'Partager le cours sur MoodleNet';
...
$string['siteadministratorsconfigphp'] = 'La liste des administrateurs du site ne peut pas être modifiée, car elle est définie dans config.php.';
