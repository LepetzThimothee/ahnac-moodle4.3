...
/**
 * Strings for component 'tool_migratehvp2h5p', language 'fr', version '4.3'.
 *
...
$string['keeporiginal_nothing'] = 'Conserver l’activité d’origine telle quelle';
...
$string['migrate_gradesoverridden_notdelete'] = 'L’activité mod_hvp originale  « {$a->name} », avec l’identifiant {$a->id}, a été migrée avec succès. Cependant, certaines informations de notation ont été remplacées, comme le feedback, qui n’a pas été migré parce que l’activité originale est configurée avec une note maximale invalide (elle doit être supérieure à 0 pour pouvoir être transférée dans le carnet de notes). L’activité originale a été masquée au lieu d’être supprimée.';
...
$string['privacy:metadata'] = 'La migration du contenu de mod_hvp vers mod_h5pactivity n’enregistre aucune donnée personnelle.';
