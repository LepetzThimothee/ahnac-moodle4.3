...
/**
 * Strings for component 'jclic', language 'fr', version '4.3'.
 *
 * @package     jclic
 * @category    string
...
$string['exiturl_help'] = 'Ceci est l’URL qui apparaît lorsque les étudiants terminent la dernière activité JClic.
...
$string['jclicurl'] = 'URL';
$string['jclicurl_help'] = 'Ce réglage permet de choisir le paquet JClic à travers une URL plutôt que par un fichier à déposer.';
$string['lang'] = 'Langue';
$string['lap'] = 'Tour';
...
Ce module permet aux enseignants d’ajouter des activités JClic à un cours et de suivre les résultats des étudiants (temps passé sur chacune des activités, nombre d’essais, score…).';
