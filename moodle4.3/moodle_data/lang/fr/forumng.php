...
/**
 * Strings for component 'forumng', language 'fr', version '4.3'.
 *
 * @package     forumng
 * @category    string
...
$string['alert_condition3'] = 'Contenu choquant (par exemple pornographie)';
...
$string['confirmbulkunsubscribe'] = 'Voulez-vous vraiment désinscrire les utilisateurs sélectionnés dans la liste ci-dessous ? (l’opération ne peut être annulée)';
$string['confirmdelete'] = 'Voulez-vous vraiment supprimer ce message ?';
...
$string['confirmdeletedraft'] = 'Voulez-vous vraiment supprimer les brouillons de la liste ci-dessous ?';
$string['confirmselection'] = 'Confirmer la sélection';
$string['confirmundelete'] = 'Voulez-vous vraiment restaurer ce message ?';
...
$string['convert_process_dashboard_done'] = 'Validé (OK {$a->yay}, Échec {$a->nay}).';
...
$string['editdiscussionoptions'] = 'Modifier les options de la discussion : {$a}';
...
$string['offerconvert'] = 'Si vous voulez créer un nouveau ForumNG comme copie de l’ancienne-version, veuillez ne pas utiliser ce formulaire. Utilisez plutôt, <a href=\'{$a}\'>Convertir les forums.';
