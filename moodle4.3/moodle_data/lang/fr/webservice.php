...
/**
 * Strings for component 'webservice', language 'fr', version '4.3'.
 *
 * @package     webservice
 * @category    string
...
$string['createservicedescription'] = 'Un service est un ensemble de fonctions web service. Vous devrez permettre à l’utilisateur d’accéder à un nouveau service. Sur la page <b>Ajouter service</b>, cochez les options « Activer » et « Utilisateurs autorisés ». Sélectionnez « Aucune capacité requise ».';
$string['createserviceforusersdescription'] = 'Un service est un ensemble de fonctions web service. Vous devrez permettre à l’utilisateur d’accéder à un nouveau service. Sur la page <b>Ajouter service</b>, cochez les options « Activer » et « Utilisateurs autorisés ». Sélectionnez « Aucune capacité requise ».';
...
$string['criteriaerror'] = 'Pas les permissions requises pour rechercher par critère.';
...
$string['requireauthentication'] = 'Cette méthode requiert une authentification avec la permission xxx.';
...
$string['restrictedusers_help'] = 'Ce réglage détermine si tous les utilisateurs ayant les permissions requises pour créer un jeton de services web peuvent générer un jeton pour ce service depuis leur page de clefs de sécurité ou si seuls les utilisateurs explicitement autorisés le peuvent.';
...
$string['step'] = 'Étape';
$string['supplyinfo'] = 'Plus d’infos';
