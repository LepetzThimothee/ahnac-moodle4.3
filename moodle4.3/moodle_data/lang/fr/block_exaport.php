...
/**
 * Strings for component 'block_exaport', language 'fr', version '4.3'.
 *
...
$string['accessoptions'] = 'Options d’accès';
$string['add'] = 'Ajouter';
...
$string['autofillview'] = 'Générer une vue basée sur tous artefacts disponibles';
...
$string['block_exaport_maxbytes'] = 'Taille maximale pour télécharger un fichier dans E-portfolio';
...
$string['cofigureblock_header'] = 'Choisir le titre';
...
$string['config_feature_copy_to_course'] = 'Autoriser les étudiants à copier leur E-portfolio vers leurs cours';
...
$string['exaport:addinstance'] = 'Ajouter Le portfolio Exabis au cours';
...
$string['exaport:myaddinstance'] = 'Ajouter Le portfolio Exabis à ma page';
...
$string['explaining'] = 'Le portfolio peut être utilisé pour archiver des adresses web, des fichiers, mais il est aussi possible de saisir des données qui peuvent contenir des notes.';
...
$string['externaccess'] = 'Lien vers un E-Portfolio externe';
...
$string['invalidcourseid'] = 'L’id du cours est invalide';
$string['invalidfileatthisassignment'] = 'Le fichier est introuvable dans ce devoir';
$string['invalidinstance'] = 'Cette instance est invalide';
$string['item'] = 'Elément';
...
$string['noemails'] = 'Il n’y a pas d’adresse mail valide';
...
$string['nomail'] = 'Pas d’adresse mail';
...
$string['resume_cover'] = 'Lettre de présentation';
...
$string['resume_exportto_europass_intro'] = 'Générer votre Curriculum Vitae depuis le résumé de votre portfolio<br>
Le fichier XML généré devra être inséré dans <a href="https://europass.cedefop.europa.eu/editors/en/cv-esp/upload" target="_blank">online europass CV editor</a><br><br>
...
<li>vérifiez toutes les dates</li>
...
<li>pour les attachements de fichiers, les formats acceptés sont : PDF, PNG, JPG; Taille limite supérieure : 2.5 Mo.</li>
</ul>';
...
$string['resume_institution'] = 'Etablissement';
...
$string['resume_mbrship'] = 'Affiliations professionnelles';
