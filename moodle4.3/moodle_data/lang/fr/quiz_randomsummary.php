...
/**
 * Strings for component 'quiz_randomsummary', language 'fr', version '4.3'.
 *
...
$string['showstudentresponse'] = 'Afficher la réponse de l’étudiant à la question';
$string['showstudentresponse_desc'] = 'Ce paramètre permet d’ajouter la réponse de l’étudiant à des questions particulières à la fin du rapport. Permets d’établir une liste séparée par des virgules en utilisant le numéro naturel de la question. Par exemple, si vous souhaitez que la réponse à la quatrième question à laquelle l’étudiant a répondu soit ajoutée à la fin du rapport, saisissez la valeur 4 dans ce champ.';
