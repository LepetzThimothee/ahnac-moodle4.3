...
/**
 * Strings for component 'qtype_essayautograde', language 'fr', version '4.3'.
 *
...
À chaque fois qu’une des erreurs est trouvée dans la réponse à la composition, la pénalité spécifiée sera déduite de la note de l’étudiant pour cette question.';
...
$string['privacy:metadata'] = 'Le plugin de question du type Composition (notation automatique) n’enregistre aucune donnée personnelle.';
...
$string['showfeedback_help'] = 'Si cette option est activée, un tableau de feedback exploitables sera affiché sur les pages d’évaluation et de révision. Le feedback exploitable est un feedback qui indique aux étudiants ce qu’ils doivent faire pour s’améliorer.';
