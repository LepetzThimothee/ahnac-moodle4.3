...
/**
 * Strings for component 'plagiarism_copyleaks', language 'fr', version '4.3'.
 *
...
$string['claccountkey'] = 'Clef de Copyleaks';
$string['claccountsecret'] = 'secret de Copyleaks';
$string['cladminconfig'] = 'Copyleaks configuration du plugin de plagiat';
$string['cladminconfigsavesuccess'] = 'Les paramètres de plagiat de Copyleaks ont été enregistrés avec succès.';
...
$string['cldraftsubmit'] = 'Soumettre les fichiers uniquement lorsque les étudiants cliquent sur le bouton d’envoi';
...
$string['clenablemodulefor'] = 'Activer Copyleaks pour {$a}';
$string['clfailtosavedata'] = 'Échec de l’enregistrement des données Copyleaks';
$string['clgenereportimmediately'] = 'Générer des rapports immédiatement';
...
$string['clplagiarisefailed'] = 'Manqué';
...
$string['clreportpagetitle'] = 'Rapport Copyleaks';
$string['clscoursesettings'] = 'Paramètres de Copyleaks';
...
$string['clstudentdisclosuredefault'] = '<span>En soumettant vos fichiers, vous acceptez la politique de confidentialité du service de détection de plagiat</span><a target="_blank" href="https://copyleaks.com/legal/privacypolicy"></a>';
...
$string['privacy:metadata:plagiarism_copyleaks_client:submittion_content'] = 'Le contenu de la soumission est envoyé à Copyleaks pour le traitement de l’analyse.';
