...
/**
 * Strings for component 'blog', language 'fr', version '4.3'.
 *
 * @package     blog
 * @category    string
...
$string['nopermissionstodeleteentry'] = 'Vous n’avez pas les permissions requises pour supprimer cet article de blog';
$string['norighttodeletetag'] = 'Vous n’avez pas les permissions requises pour supprimer ce tag : {$a}';
$string['nosuchentry'] = 'Aucun tel article de blog';
$string['notallowedtoedit'] = 'Vous n’avez pas les permissions requises pour modifier cet article';
...
$string['privacy:metadata:post:created'] = 'La date à laquelle l’article a été créé';
$string['privacy:metadata:post:lastmodified'] = 'La date à laquelle l’article a été modifié pour la dernière fois';
...
$string['privacy:metadata:post:summary'] = 'Le texte de l’article de blog';
$string['privacy:metadata:post:uniquehash'] = 'Un identifiant unique d’un article externe, typiquement une URL';
