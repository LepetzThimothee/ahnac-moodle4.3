...
/**
 * Strings for component 'qtype_algebra', language 'fr', version '4.3'.
 *
...
$string['compareby_help'] = 'Cela permet de sélectionner la méthode avec laquelle les réponses des étudiants sont comparées à toutes les réponses de la question. Les différentes possibilités sont :
...
Évaluation : cette méthode génère des nombres aléatoires pour les variables de la question et évalue à la fois la réponse de l’étudiant et la réponse de la question pour cet ensemble de valeurs.
...
$string['restoreqdbfailed'] = 'Échec de la restauration d’une question d’algèbre : erreur d’écriture dans la base de données';
$string['restorevardbfailed'] = 'Échec de la restauration d’une variable de question d’algèbre : erreur d’écriture dans la base de données';
$string['texdelimiters'] = 'Délimiteurs pour les expressions TeX';
$string['times'] = '\\times';
$string['tolerance'] = 'Tolérance pour les évaluations de contrôle';
$string['tolerance_help'] = 'Détermine la différence maximale entre les évaluations numériques de la réponse de l’étudiant et des réponses à la question qui sera autorisée à compter comme une correspondance.';
