...
/**
 * Strings for component 'choicegroup', language 'fr', version '4.3'.
 *
 * @package     choicegroup
 * @category    string
...
$string['allowupdate'] = 'Autoriser la modification du choix';
$string['and'] = 'et';
...
$string['fillinatleastoneoption'] = 'Vous devez indiquer au moins un choix possible.';
$string['fillinatleasttwooptions'] = 'Vous devez indiquer au moins deux choix possibles.';
$string['full'] = '(Complet)';
...
$string['hidegroupmembers'] = 'Masquer les membres du groupe';
$string['limit'] = 'Limite';
...
$string['nogroupincourse'] = 'Aucun groupe n’existe dans ce cours.';
...
<li><a href="{$a->linkcourse}">revenir au cours</a></li>
</ul>';
...
$string['publishanonymous'] = 'Publier les résultats anonymes, ne montre pas les noms des étudiants';
$string['publishnames'] = 'Publier les résultats complets, indique les noms et leurs choix';
$string['publishnot'] = 'Ne pas publier les résultats aux étudiants';
...
$string['samegroupused'] = 'Un même groupe ne peut pas être utilisé plusieurs fois.';
...
$string['showgroupmembers'] = 'Afficher les membres du groupe';
