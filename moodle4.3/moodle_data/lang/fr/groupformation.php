...
/**
 * Strings for component 'groupformation', language 'fr', version '4.3'.
 *
...
$string['groupoption_onlyactivestudents'] = 'Les étudiants sans réponses ne seront pas affectés à un groupe.';
...
$string['info_text_teacher_analysis'] = 'Avec ce plugin, vous avez la possibilité d’optimiser la formation de groupe de vos étudiants. Les trois étapes requises sont:<br>
        ...
        Un aperçu du questionnaire peut être trouvé plus tard en ouvrant l’activité comme un docent.<br>
...
$string['info_text_teacher_settings'] = 'Avec ce plugin, vous avez la possibilité d’optimiser la formation de groupe de vos étudiants. Les trois étapes requises sont:<br>
        1.) Ajoutez l’activité "groupformation" à votre cours.
        Dans les paramètres, vous pouvez choisir le scénario qui correspond le mieux à vos besoins (en cas de doute, choisissez des équipes de projet).
        Les autres paramètres vous permettent de spécifier la taille du groupe et/ou les connaissances préalables des étudiants. Si les connaissances préalables des étudiants doivent se compléter,
        vous pouvez le spécifier dans les paramètres.
...
$string['settings_import_export_description'] = 'Si cette option est activée, les étudiants peuvent exporter leurs réponses et importer des réponses dans un autre cas.';
