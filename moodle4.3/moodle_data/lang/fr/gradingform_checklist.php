...
/**
 * Strings for component 'gradingform_checklist', language 'fr', version '4.3'.
 *
...
$string['name'] = 'Nom';
$string['needregrademessage'] = 'La définition de la liste des tâches a été modifiée une fois que cet étudiant a été noté. L’étudiant ne peut pas voir cette liste des tâches tant que vous ne l’avez pas examinée et mis à jour la note.';
...
$string['regrademessage5'] = 'Vous êtes sur le point d’enregistrer des modifications importantes dans une liste des tâches qui a déjà été notée. La note dans le carnet de notes restera inchangée, mais la liste des tâches sera masquée aux étudiants jusqu’à ce que leurs éléments soient renotés.';
