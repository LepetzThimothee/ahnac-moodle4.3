...
/**
 * Strings for component 'assign', language 'fr', version '4.3'.
 *
 * @package     assign
 * @category    string
...
$string['activityattachments'] = 'Annexes de l’activité devoir';
...
$string['activityeditor'] = 'Instructions de l’activité';
$string['activityeditor_help'] = 'Les actions à effectuer par l’étudiant pour ce devoir. Ceci n’est affiché que sur la page de remise, où l’étudiant modifie et envoie son devoir.';
...
$string['assign:grantextension'] = 'Accorder des prolongations';
...
$string['batchoperationconfirmgrantextension'] = 'Accorder une prolongation pour tous les travaux sélectionnés ?';
...
$string['beginassignment'] = 'Commencer le devoir';
...
$string['cutoffdate_help'] = 'Si renseigné, les travaux ne seront pas acceptés après cette date, sauf octroi d’une prolongation. Sinon, les travaux seront toujours acceptés.';
...
$string['duedateaftersubmissionvalidation'] = 'La date limite doit être postérieure à la date à partir de laquelle les remises sont permises.';
$string['duedatecolon'] = 'Date limite : {$a}';
$string['duedatereached'] = 'La date limite de ce devoir est passée';
$string['duedatevalidation'] = 'La date limite ne doit pas être antérieure à la date à partir de laquelle les remises sont permises.';
...
$string['eventstatementaccepted'] = 'L\'utilisateur a accepté la déclaration de remise du travail.';
...
$string['gradebreakdown'] = 'Répartition des notes';
...
$string['gradedfollowupsubmit'] = 'Évalué - de nouveau remis';
...
$string['grantextensionforusers'] = 'Accorder une prolongation à {$a} étudiants';
...
$string['introattachments_help'] = 'Des fichiers supplémentaires à utiliser dans le devoir peuvent être ajoutés, par exemple des modèles de réponse.';
...
$string['nosubmissionyet'] = 'Aucun devoir n’a encore été remis';
...
$string['nouseroverrides'] = 'Il n’y a actuellement aucune dérogation utilisateur.';
...
$string['numberofsubmissionsneedgradinglabel'] = 'Nécessite évaluation : {$a}';
$string['numberofsubmittedassignments'] = 'Remis';
$string['numberofteams'] = 'Groupes';
$string['offline'] = 'Aucun travail à remettre requis';
$string['open'] = 'Ouvert';
$string['opensubmissionexists'] = 'Un travail en cours existe déjà';
...
$string['privacy:metadata:timestarted'] = 'Horodatage du début';
...
$string['removesubmissionconfirm'] = 'Voulez-vous vraiment supprimer votre travail remis ?';
$string['removesubmissionconfirmforstudent'] = 'Voulez-vous vraiment supprimer le travail remis de {$a} ?';
$string['removesubmissionconfirmforstudentwithtimelimit'] = 'Voulez-vous vraiment supprimer le travail remis de {$a} ? Veuillez noter que cette opération ne réinitialisera pas la limite de temps de l’étudiant. Vous pouvez lui donner plus de temps en ajoutant une dérogation de temps.';
$string['removesubmissionconfirmwithtimelimit'] = 'Voulez-vous vraiment supprimer votre travail remis ? Veuillez noter que cette opération ne réinitialisera pas votre limite de temps.';
...
$string['reverttodraftforgroup'] = 'Repasser le travail remis en brouillon pour le groupe {$a}.';
...
$string['submissionattachments'] = 'N’afficher les fichiers que durant la remise du devoir';
$string['submissionattachments_help'] = 'Si ce réglage est activé, les fichiers ne seront montrés que sur la page de remise du devoir. Sinon, les fichiers seront montrés tant sur la page du devoir que sur la page de remise.';
...
$string['submissionnotopen'] = 'Ce devoir n’est pas ouvert aux remises de travaux';
...
$string['submissionstatement'] = 'Déclaration de remise';
...
$string['submissionstatementteamsubmissionallsubmit_help'] = 'Déclaration que chaque étudiant doit accepter avant de remettre un travail en tant que membre d’un groupe.';
...
$string['submittedovertime'] = 'Le devoir a été remise {$a} après la durée limite';
$string['submittedundertime'] = 'Le devoir a été remise {$a} avant la durée limite';
...
$string['timelimit_help'] = 'Si ce réglage est activé, la durée limite est annoncée sur la page du devoir et un chronomètre est affiché durant le devoir.';
$string['timelimitnotenabled'] = 'Une durée limite n’est pas activée pour le devoir.';
$string['timelimitpassed'] = 'La durée limite est dépassée';
