...
/**
 * Strings for component 'lesson', language 'fr', version '4.3'.
 *
 * @package     lesson
 * @category    string
...
$string['activitylink_help'] = 'Afin de fournir un lien vers une autre activité de cours au terme de la leçon, choisir une activité dans le menu déroulant.';
...
$string['addessay'] = 'Créer une page question composition';
...
$string['allowofflineattempts'] = 'Permettre de suivre la leçon hors ligne au moyen de l’app mobile';
...
$string['cannotfindpagerecord'] = 'Ajout d’un fin de branchement : enregistrement de page non trouvé';
...
$string['completionendreached_desc'] = 'Si ce réglage est activé, l’étudiant doit atteindre la page de fin de la leçon pour achever cette activité';
$string['completiontimespent'] = 'L’étudiant doit travailler sur cette activité au moins durant';
...
$string['correctanswerjump'] = 'Saut après réponse correcte';
...
$string['displayleftif_help'] = 'Ce réglage détermine si un étudiant doit obtenir une note minimale pour que le menu de la leçon soit affiché. Ceci impose à l’étudiant de parcourir la totalité de la leçon lors de sa première tentative, puis lui permet d’utiliser le menu pour sa relecture, s’il a obtenu la note requise.';
...
$string['eventhighscoreadded'] = 'Meilleur résultat de leçon ajouté';
$string['eventhighscoresviewed'] = 'Meilleurs résultats de leçon consultés';
...
$string['jump'] = 'Saut';
$string['jumps'] = 'Sauts';
$string['jumps_help'] = 'Chaque réponse (pour les questions) ou description (pour les pages de contenu) possède un saut correspondant. Ce saut peut être relatif, comme cette page ou la page suivante, ou absolu, en spécifiant une des pages de la leçon.';
...
$string['manageoverrides'] = 'Gérer les dérogations';
...
$string['teacherjumpwarning'] = 'Un saut {$a->cluster} ou un saut {$a->unseen} est utilisé dans cette leçon. Un saut « Page suivante » sera utilisé à sa place. Veuillez vous connecter en tant qu’étudiant pour tester ces sauts.';
...
$string['thefollowingpagesjumptothispage'] = 'Les pages suivantes dirigent vers cette page';
