...
/**
 * Strings for component 'auth_fc', language 'fr', version '4.3'.
 *
 * @package     auth_fc
 * @category    string
...
$string['privacy:metadata'] = 'Le plugin d’authentification Serveur FirstClass n’enregistre aucune donnée personnelle.';
