...
/**
 * Strings for component 'auth_companion', language 'fr', version '4.3'.
 *
...
$string['companionrole_definition'] = 'Pour définir les rôles disponibles, définissez la capacité « auth/companion:useascompanion » sur « Autoriser ».';
...
$string['privacy:metadata'] = 'Le plugin d’authentification compagnon n’enregistre aucune donnée personnelle.';
