...
$string['aboutuscontentsetting_desc'] = 'Ce paramètre permet de rédiger contenu pour la page « À propos de nous ».';
...
$string['courseoverviewheading'] = 'Bloc « Vue d‘ensembe des cours »';
$string['courseoverviewshowcourseimagessetting'] = 'Afficher les images de cours';
$string['courseoverviewshowcourseimagessetting_desc'] = 'Ce paramètre permet d‘afficher ou non les images de cours dans le bloc « Vue d‘ensembe des cours ». Ce paramètre est réglable individuellement pour les différentes vues (Cartes, Liste et Résumé).';
$string['courseoverviewshowprogresssetting'] = 'Afficher la progression dans le cours';
$string['courseoverviewshowprogresssetting_desc'] = 'Ce paramètre permet d‘afficher ou non la progression dans le cours dans le bloc « Vue d‘ensembe des cours ».';
...
$string['enableaboutussetting'] = 'Activer la page « À propose de nous »';
...
$string['enablefooterbuttondesktop'] = 'Afficher uniqument sur ordinateur de bureau et tablette, masquer sur smartphone (comportement par défaut de Moodle)';
...
$string['enablepage1setting'] = 'Activer la page générique 1';
$string['enablepage2setting'] = 'Activer la page générique 2';
$string['enablepage3setting'] = 'Activer la page générique 3';
...
$string['footersuppresspoweredsetting'] = 'Supprimer le lien « Fourni pas Moodle »';
$string['footersuppresspoweredsetting_desc'] = 'Ce paramètre permet de supprimer l‘information « Fourni pas Moodle » dans le pied de page. Cette information précise que le site utilise Moodle et fournit un lien vers Moodle HQ.';
...
$string['footersuppressthemeswitchsetting_desc'] = 'Ce paramètre permet de supprimer les liens de changement de thème dans le pied de page. Le système de gestion de thèmes spécifiques pour les dispositifs a été supprime dans Moodle 4.3 mais les routines de rendu sont toujours présentes, mieux vaut donc prévenir que guérir.';
...
$string['settingsoverview_functionality_desc'] = 'Les paramétrage des fonctionnalités additionnelles globales ou relatives aux cours ser retrouvent ici.';
...
$string['showfullnameinusermenussetting_desc'] = 'Ce paramètre permet d\'afficher le nom complet de l‘utilisateur connecté en-haut du menu utilisateur. Cela peut être particulièrement utile aux enseignants lors d‘examens afin de vérfier que l‘étudiant est bien connecté avec son propre compte ; cela peut également être utilise pour l‘utilisateur. Contrairement au thème Classic qui affiche le nom complet de l‘utilisateur à côté de l‘avatar dans la barre de navigation, notre approche ne surcharge pas l‘espace précieux de la barre de navigation.';
