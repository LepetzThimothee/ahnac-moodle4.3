...
/**
 * Strings for component 'gradingform_guide', language 'fr', version '4.3'.
 *
...
$string['regrademessage1'] = 'Vous allez enregistrer des modifications d’un guide d’évaluation qui a déjà été utilisé pour donner des notes. Veuillez indiquer si les notes déjà données doivent être recalculées. Dans ce cas, ce guide ne sera visible pour les étudiants que lorsque leur note aura été recalculée.';
$string['regrademessage5'] = 'Vous allez enregistrer d’importantes modifications d’un guide d’évaluation qui a déjà été utilisé pour donner des notes. Les notes ne seront pas modifiées dans le carnet de notes, mais le guide ne sera visible pour les étudiants que lorsque leur note aura été recalculée.';
