...
/**
 * Strings for component 'theme_essential', language 'fr', version '4.3'.
 *
...
<p>
<h3>Essential pour Moodle 3.0 est sponsorisé par :</h3>
<ul>
<li>Leila Hiret</li>
...
<p>Si vous aimez ce thème et voudriez que je le personnalise, transpose certaines fonctionnalités dans un autre thème ou créé un nouveau thème, j’offre des tarifs compétitifs. Merci de me contacter via "http://moodle.org/user/profile.php?id=442195" pour discuter de vos besoins (en anglais).</p>
</div></div>';
...
$string['courselistteachericondesc'] = 'Nom de l’icône que vous souhaitez utiliser ou vide pour aucun. La liste est <a href="https://fontawesome.com/v4/cheatsheet/" target="_new">ici</a>. Entrer simplement ce qui est après le "fa-", e.g. "star".';
...
$string['displayeditingmenudesc'] = 'Affiche un bouton dans l’en-tête avec la même fonctionnalité que le bouton d’activation du mode édition.';
...
$string['headertitledesc'] = 'Configurez ici le titre à afficher dans l’en-tête. Remarque : le titre de l’en-tête ne sera utilisé que s’il n’y a pas de logo.';
...
$string['marketingicondesc'] = 'Nom de l’icône que vous souhaitez utiliser. La liste est <a href="https://fontawesome.com/v4/cheatsheet/" target="_new">ici</a>. Il suffit d’entrer ce qui est après "fa-".';
...
$string['siteicondesc'] = 'Vous n’avez pas de logo ? Entrez le nom de l’icône que vous souhaitez utiliser. La liste est <a href="https://fontawesome.com/v4/cheatsheet/" target="_new">ici</a>. Il suffit d’entrer ce qui est après "fa-".';
