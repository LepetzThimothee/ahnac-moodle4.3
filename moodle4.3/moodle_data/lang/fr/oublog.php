...
/**
 * Strings for component 'oublog', language 'fr', version '4.3'.
 *
 * @package     oublog
 * @category    string
...
$string['error_toomanycomments'] = 'Vous avez fait trop de commentaires durant la dernière heure à partir de cette adresse internet. S’il vous plait patientez un peu et essayez à nouveau';
...
$string['invalidblog'] = 'L’identifiant du blog est invalide';
$string['invalidcomment'] = 'L’identifiant du commentaire est invalide';
$string['invalidformat'] = 'Le format des flux doit être atom ou rss';
$string['invalidlink'] = 'L’identifiant du lien est invalide';
$string['invalidpost'] = 'L’identifiant de l’article est invalide';
