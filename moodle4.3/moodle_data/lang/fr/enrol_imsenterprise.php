...
/**
 * Strings for component 'enrol_imsenterprise', language 'fr', version '4.3'.
 *
...
$string['allowunenrol'] = 'Permettre aux données IMS de désinscrire les étudiants et enseignants';
...
$string['categoryidnumber_desc'] = 'Si ce réglage est activé, lMS Enterprise créera une catégorie avec l’identifiant.';
$string['categoryseparator'] = 'Caractère séparateur de catégorie';
$string['categoryseparator_desc'] = 'Requis si « Permettre les identifiants de catégorie » est activé. C’est le caractère de séparation entre le nom de la catégorie et l’identifiant.';
...
$string['disableenrolmentandremoveallroles'] = 'Suspendre l’inscription et retirer les rôles';
...
$string['logtolocation'] = 'Emplacement du journal (vide pour ne pas avoir de journal)';
...
$string['noaction'] = 'Aucune action';
$string['pluginname'] = 'Fichier IMS Enterprise';
$string['pluginname_desc'] = 'Ce plugin d’inscription vérifie l’existence d’un fichier texte spécialement formaté dans un emplacement choisi et le traite. Le fichier doit suivre les spécifications IMS Enterprise et contenir les éléments XML person, group et membership.';
...
$string['removeenrolmentandallroles'] = 'Supprimer l’inscription et les rôles';
...
$string['unenrolaction'] = 'Action à la désinscription';
$string['unenrolaction_desc'] = 'Action à effectuer lorsqu’un utilisateur est désinscrit du cours (n’est effective que si le réglage Désinscription ci-dessus est activé)';
