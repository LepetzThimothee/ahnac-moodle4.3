...
/**
 * Strings for component 'theme_boost', language 'fr', version '4.3'.
 *
 * @package     theme_boost
 * @category    string
...
$string['bootswatch_desc'] = 'Un bootswatch est un ensemble de variables et de règles CSS Bootstrap permettant de modifier le style de Bootstrap';
