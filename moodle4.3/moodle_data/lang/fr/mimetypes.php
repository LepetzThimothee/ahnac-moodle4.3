...
/**
 * Strings for component 'mimetypes', language 'fr', version '4.3'.
 *
 * @package     mimetypes
 * @category    string
...
$string['group:html_audio'] = 'Fichiers audio supportés nativement par les navigateurs';
$string['group:html_track'] = 'Fichiers de piste HTML';
$string['group:html_video'] = 'Fichiers vidéo supportés nativement par les navigateurs';
