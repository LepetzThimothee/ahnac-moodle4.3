...
/**
 * Strings for component 'media_videojs', language 'fr', version '4.3'.
 *
...
$string['configaudioextensions'] = 'Une liste d’extensions de fichiers audio supportés, séparées par des virgules. VideoJS essaiera d’utiliser le lecteur audio natif du navigateur, si disponible, ou la fonctionnalité native VideoJS.';
...
$string['configvideoextensions'] = 'Une liste d’extensions de fichiers vidéo supportés, séparées par des virgules. VideoJS essaiera d’utiliser le lecteur vidéo natif du navigateur, si disponible.';
...
$string['pluginname_help'] = 'Un script JavaScript pour la lecture des fichiers vidéo au moyen du lecteur vidéo natif du navigateur (le support des formats dépend du navigateur).';
