...
/**
 * Strings for component 'theme_decaf', language 'fr', version '4.3'.
 *
 * @package     theme_decaf
 * @category    string
...
$string['showuserpicturedesc'] = 'Ce paramètre ajoute l’image de l’utilisateur dans l’en-tête de la page';
