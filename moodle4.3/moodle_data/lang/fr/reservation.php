...
/**
 * Strings for component 'reservation', language 'fr', version '4.3'.
 *
 * @package     reservation
 * @category    string
...
$string['confirmdelete'] = 'Voulez-vous vraiment supprimer les demandes de réservations sélectionnées ?';
