...
/**
 * Strings for component 'verbalfeedback', language 'fr', version '4.3'.
 *
...
$string['additem'] = 'Ajouter un nouvel élément';
$string['allowundodecline'] = 'Permettre aux étudiants d’annuler les feedback refusés';
$string['allparticipants'] = 'Tous les étudiants';
...
$string['categoryplural'] = 'Catégories';
...
$string['declinereasonplaceholdertext'] = 'Saisir votre raison ici… (facultatif)';
...
$string['downloadtemplate'] = 'Télécharger le modèle';
...
$string['errorcannotadditem'] = 'Impossible d’ajouter l’élément de feedback verbal.';
...
$string['errorinvalidstatus'] = 'Statut non valide';
...
$string['errorquestionstillinuse'] = 'Cette question ne peut pas être supprimée car elle est utilisée par au moins une instance de feedback verbal.';
$string['errorreportnotavailable'] = 'Votre rapport de feedback n’est pas encore disponible';
$string['errorresponsesavefailed'] = 'Une erreur s’est produite lors de l’enregistrement des réponses. Veuillez réessayer plus tard.';
$string['errorroleconflict'] = 'L’utilisateur actuel est à la fois étudiant et enseignant dans cette instance, ce qui n’est pas autorisé';
...
$string['instancenotready'] = 'Cliquer sur le bouton « Rendre disponible » pour diffuser le questionnaire aux enseignants après avoir modifié les éléments de feedback verbal.';
$string['instancenotreadystudents'] = 'L’activité de feedback verbal n’est pas encore prête. Veuillez réessayer plus tard.';
...
$string['modulename_help'] = 'Le module d’activité de feedback verbal permet aux étudiants de fournir un feedback à tous les autres étudiants';
$string['modulenameplural'] = 'Feedbacks verbals';
$string['moveitemdown'] = 'Déplacer l’élément vers le bas';
$string['moveitemup'] = 'Déplacer l’élément vers le haut';
...
$string['noitemsyet'] = 'L’activité de feedback verbal n’a pas encore d’éléments. Ajouter des éléments en cliquant sur « Modifier les éléments du feedback verbal ».';
...
$string['pickfromquestionbank'] = 'Choisir une question dans la banque de questions';
$string['placeholderquestion'] = 'Saisir le texte de la question';
$string['pluginadministration'] = 'Administration des feedbacks verbaux';
$string['pluginname'] = 'Feedback verbal';
$string['position'] = 'Position';
$string['positive'] = 'Positif';
$string['preserveids'] = 'Preserver les IDs ?';
$string['previewinfo'] = 'Prévisualiser le questionnaire, cliquer sur <a href="{$a}">ici</a> pour revenir à la vue précédente.';
...
$string['privacy:metadata:verbalfeedback_response'] = 'Cette table enregistre les réponses du répondant aux questions de feedback au destinataire du feedback';
$string['privacy:metadata:verbalfeedback_response:value'] = 'La valeur de la réponse du répondant à la question de feedback';
$string['privacy:metadata:verbalfeedback_submission'] = 'Cette table enregistre les informations sur les statuts des réponses aux questions de feedback entre les participants';
...
$string['privacy:metadata:verbalfeedback_submission:status'] = 'Le statut de la remise du feedback';
...
$string['rel_closed'] = 'Fermé aux étudiants';
$string['rel_manual'] = 'Publication manuelle';
$string['rel_open'] = 'Ouvert aux étudiants';
$string['release'] = 'Publier le rapport aux étudiants';
$string['release_close'] = 'Fermer le rapport aux étudiants';
$string['releasetype'] = 'Publication';
$string['releasetype_help'] = 'S’il faut laisser les étudiants consulter le rapport des feedbacks qui leur ont été donnés.
<ul>
<li>Fermé aux étudiants. Les étudiants ne peuvent pas consulter leur propre rapport de feedback. Seuls ceux qui ont la capacité de gérer l’activité de feedback verbal (par exemple l’enseignant, le responsable, l’administrateur) peuvent voir les rapports de feedback des étudiants.
<li>Ouvert aux étudiants. Les étudiants peuvent consulter leur propre rapport de feedback à tout moment.</li>
<li>Publication manuelle. Les étudiants peuvent consulter leur propre rapport de feedback lorsqu’il est publié par un utilisateur qui a la capacité de gérer l’activité de feedback verbal.
<li>Publication après la fermeture de l’activité. Les étudiants peuvent consulter leur propre rapport de feedback après la fin de l’activité.</li>
</ul>';
$string['responses'] = 'Réponses';
$string['responsessaved'] = 'Vos réponses ont été enregistrées';
$string['saveandreturn'] = 'Enregistrer et retour';
...
$string['selectparticipants'] = 'Choisir participant';
...
$string['studentcomment'] = 'Remarques de l’étudiant';
$string['submissions'] = 'Soumissions';
$string['subrating'] = 'Subrating';
$string['subratingplural'] = 'Subratings';
$string['switchtouser'] = 'Changer vers l’étudiant…';
$string['teachers'] = 'Enseignants';
$string['template'] = 'Modèle';
$string['templatecategoryplural'] = 'Catégories pour les modèles';
$string['templatecriteriaplural'] = 'Critères pour les modèles';
$string['templateplural'] = 'Modèles';
$string['text'] = 'Texte';
...
$string['undodecline'] = 'Annuler le refus';
$string['valuation'] = 'Évaluation';
$string['value'] = 'Valeur';
$string['verbalfeedback:addinstance'] = 'Ajouter une nouvelle instance de feedback verbal';
$string['verbalfeedback:complete'] = 'Terminer un feedback verbal';
$string['verbalfeedback:edititems'] = 'Modifier les éléments de feedback verbal';
$string['verbalfeedback:editquestions'] = 'Modifier les questions de feedback verbal';
$string['verbalfeedback:mapcourse'] = 'Apparier le feedback verbal au cours';
$string['verbalfeedback:receive_rating'] = 'L’utilisateur peut être évalué';
$string['verbalfeedback:receivemail'] = 'Recevoir un courriel de feedback verbal';
$string['verbalfeedback:view'] = 'Consulter les feedbacks verbaux';
$string['verbalfeedback:view_all_reports'] = 'Consulter les rapports de feedback verbal de tous les étudiants';
$string['verbalfeedback:viewanalysepage'] = 'Consulter l’analyse du feedback verbal';
...
$string['verbalfeedbacktemplates'] = 'Modèles de feedback verbal';
$string['verynegative'] = 'Très négatif';
$string['verypositive'] = 'Très positif';
$string['viewfeedbackforuser'] = 'Voir feedback pour étudiant';
$string['viewfeedbackreport'] = 'Voir le rapport du feedback';
$string['weight'] = 'Poids';
$string['weightedaverage'] = 'Ø pondérée';
