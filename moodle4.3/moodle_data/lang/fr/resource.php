...
/**
 * Strings for component 'resource', language 'fr', version '4.3'.
 *
 * @package     resource
 * @category    string
...
$string['filterfilesexplain'] = 'Sélectionner le type des fichiers dont le contenu doit être filtré. Veuillez noter que ceci peut causer des problèmes pour certaines applications Flash et Java. Assurez-vous que l’encodage de tous les fichiers textes est UTF-8.';
