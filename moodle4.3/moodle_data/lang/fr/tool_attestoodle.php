...
/**
 * Strings for component 'tool_attestoodle', language 'fr', version '4.3'.
 *
...
$string['activity_header_coursename_type'] = 'Type d’activité suivie par cours';
...
$string['attestoodle:myaddinstance'] = 'Ajouter un bloc Attestoodle à mon Moodle';
...
$string['grp_type'] = 'Type d’activité';
...
$string['learner_details_notification_message_new'] = 'L’attestation a été créée sur le serveur';
...
$string['milestonenews'] = 'Liste des cours de la formation ayant reçu de nouvelles activités';
$string['milestoneorphan'] = 'Liste des jalons en erreur (leur activité est supprimée)';
$string['msgongoing'] = 'Traitement en cours';
$string['navlevel1'] = 'Formations';
$string['navlevel1b'] = 'Liste des modèles';
...
$string['nbnewactivity'] = 'Nombre d’activités nouvelles';
...
$string['nl_preactch1'] = 'Uniquement sur la 1ère page';
...
$string['privacy:metadata:tool_attestoodle_certif_log'] = 'Liens entre apprenant et les fichiers d’attestation le concernant';
$string['privacy:metadata:tool_attestoodle_certif_log:filename'] = 'Nom des fichiers d’attestation de l’apprenant';
...
$string['privacy:metadata:tool_attestoodle_launch_log'] = 'Journal des lancements de génération d’attestations';
...
$string['privacy:metadata:tool_attestoodle_launch_log:operatorid'] = 'Identifiant de l’utilisateur ayant généré un lot d’attestations';
$string['privacy:metadata:tool_attestoodle_launch_log:timegenerated'] = 'Date et heure de lancement de la génération du lot d’attestations';
$string['privacy:metadata:tool_attestoodle_user_style'] = 'Personnalisation du modèle d’attestation par apprenant';
$string['privacy:metadata:tool_attestoodle_user_style:enablecertificate'] = 'Indique si l’apprenant est exclu ou non de la génération d’attestations';
...
$string['privacy:metadata:tool_attestoodle_value_log'] = 'Temps crédité par jalons franchi.';
...
$string['settings_description'] = 'Vous permet de modifier certains paramètres du plugin Attestoodle';
$string['settings_header'] = 'Configuration d’Attestoodle';
$string['settings_student_role_helper'] = 'Id du rôle Étudiant dans la base de données';
$string['settings_student_role_label'] = 'Id du rôle Étudiant';
$string['showcompletiondate'] = 'Afficher la date d’achèvement';
$string['size'] = 'Taille :';
$string['stop'] = 'Stop';
...
$string['training_learners_list_notification_message_success_two'] = '{$a} nouveaux fichiers';
...
$string['trainings_list_warning_no_trainings'] = 'Pas de formation enregistrée';
...
$string['updatetraintemplate'] = 'Mise à jour du modèle de certificat réussie';
