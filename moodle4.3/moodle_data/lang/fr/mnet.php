...
/**
 * Strings for component 'mnet', language 'fr', version '4.3'.
 *
 * @package     mnet
 * @category    string
...
$string['name'] = 'Nom';
$string['net'] = 'MNet';
$string['networksettings'] = 'Réglages MNet';
$string['never'] = 'Jamais';
...
$string['nomodifyacl'] = 'Vous n’avez pas les permissions requises pour modifier les listes de contrôles d’accès MNet.';
...
$string['notpermittedtojump'] = 'Vous n’avez pas les permissions requises pour initier une session à distance depuis ce serveur Moodle.';
...
$string['notpermittedtoland'] = 'Vous n’avez pas les permissions requises pour initier une session à distance.';
...
$string['requiresopenssl'] = 'Le réseau MNet requiert l’extension OpenSSL';
...
$string['validated_by'] = 'Il a été validé par le réseau MNet : <code>{$a}</code>';
