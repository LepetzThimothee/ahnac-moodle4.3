...
/**
 * Strings for component 'zoom', language 'fr', version '4.3'.
 *
 * @package     zoom
 * @category    string
...
$string['accountid'] = 'Identifiant du compte Zoom';
$string['actions'] = 'Actions';
$string['activitydate:ended'] = 'Terminé :';
$string['activitydate:started'] = 'Démarré :';
$string['activitydate:starts'] = 'Démarre :';
...
$string['apiendpoint'] = 'Le point d’accès de l’API Zoom';
$string['apiendpoint_desc'] = 'Choisir le point d’accès de l’API Zoom que l’activité Zoom utilisera pour se connecter. Le point d’accès global de l’API doit fonctionner pour tous les utilisateurs. Le point d’accès de l’API de l’Union européenne (UE) est uniquement destiné aux utilisateurs disposant d’une licence Zoom avec l’option d’approvisionnement de l’UE. Si vous n’êtes pas sûr, utilisez le point d’accès global de l’API.';
$string['apiendpoint_eu'] = 'Point d’accès de l’API UE';
$string['apiendpoint_global'] = 'Point d’accès global de l’API';
$string['apiidentifier'] = 'Identifiant de l’API Zoom';
$string['apiidentifier_desc'] = 'Le champ identifiant à utiliser lors d’un appel à l’API Zoom';
...
$string['breakoutrooms'] = 'Salles de petits groupes';
$string['cachedef_oauth'] = 'Cache de jetons OAuth Zoom';
...
$string['clientid'] = 'Identifiant du client Zoom';
$string['clientsecret'] = 'Clé secrète du client Zoom';
...
$string['err_downloadicalrecurringempty'] = 'Le téléchargement du fichier iCal de la réunion Zoom n’est pas possible pour cette réunion car il ne contient pas au moins une seule occurrence.';
$string['err_downloadicalrecurringnofixed'] = 'Le téléchargement du fichier iCal de la réunion Zoom n’est pas possible pour cette réunion car il s’agit d’une réunion récurrente sans heure fixe.';
...
$string['err_start_time_past_recurring'] = 'Pour les réunions récurrentes, la partie date de ce champ est la date la plus proche possible pour la prochaine réunion. Cette date doit être aujourd’hui ou dans le futur.';
$string['err_weekly_days'] = 'Sélectionner le(s) jour(s) pour la réunion hebdomadaire récurrente';
$string['erroraddinstance'] = 'Impossible de créer une nouvelle réunion Zoom. Options non valides sélectionnées pour une réunion récurrente.';
...
$string['getmeetingrecordings'] = 'Obtenir des enregistrements de réunion à partir de Zoom';
...
$string['invitation_icallink'] = 'Modèle de message de lien iCal';
$string['invitation_icallink_help'] = 'Le modèle regex pour trouver le lien iCal de la réunion Zoom.';
...
$string['invitation_onetapmobile'] = 'Modèle mobile en un seul clic';
$string['invitation_onetapmobile_help'] = 'Le modèle regex pour trouver la réunion Zoom en un seul clic sur les détails du mobile.';
$string['invitation_sip'] = 'Motif SIP';
$string['invitation_sip_help'] = 'Le modèle regex pour trouver les informations SIP de la réunion Zoom. Si vos invitations ne contiennent pas d’éléments SIP ou H.323, définissez le modèle d’expression régulière correspondant sur une chaîne vide. (Cela s’applique particulièrement aux serveurs sur lesquels le débogage est activé, car cela peut casser le format de types de fichiers spéciaux comme l’exportation iCal.)';
...
$string['invitationregex'] = 'Expression regex et capacités d’une invitation Zoom';
$string['invitationregex_help'] = 'Définr les modèles regex pour isoler chaque partie d’une invitation de zoom afin que les informations puissent être contrôlées par des fonctionnalités.';
$string['invitationregex_nohideif'] = 'Remarque : les modèles regex ne seront utilisés que si le paramètre « {$a} » est activé.';
$string['invitationregexenabled'] = 'Activer l’expression regex et les capacités d’une invitation Zoom';
...
$string['invitationremoveicallink_help'] = 'Si ce réglage est activé, le lien iCal qui peut être inclus dans le message électronique de la réunion zoom sera supprimé à l’aide du modèle regex invitation_icallink.';
...
$string['meetingparticipantsdeleted'] = 'Les données utilisateur des participants à la réunion ont été supprimées.';
$string['meetingrecordingviewsdeleted'] = 'Les données d’affichage de l’utilisateur de l’enregistrement de la réunion ont été supprimées.';
...
$string['on'] = 'Activé';
$string['option_allow_recording_change'] = 'Autoriser l’enregistrement des modifications';
$string['option_allow_recording_change_help'] = 'Autoriser l’utilisateur à modifier la configuration de l’enregistrement au moment de la création de l’activité';
...
$string['option_auto_recording_help'] = 'L’activation de cette option enregistrera automatiquement la réunion';
...
$string['privacy:metadata:zoom_breakout_participants'] = 'La table de la base de données pour stocker une liste des participants aux salles de petits groupes d’une réunion zoom';
...
$string['privacy:metadata:zoom_meeting_view'] = 'La table de base de données pour suivre les utilisateurs qui visualisent les enregistrements de la réunion';
$string['privacy:metadata:zoom_meeting_view:userid'] = 'L’identifiant de l’utilisateur qui a visionné l’enregistrement';
...
$string['registration'] = 'Nécessite une inscription';
$string['registration_help'] = 'L’activation de cette option obligera les participants à s’inscrire à la réunion/webinaire Zoom avant de la/le rejoindre.';
...
$string['resetzoomsall'] = 'Supprimer toutes les notes des utilisateurs, les données d’enregistrement des vues des utilisateurs et les données des utilisateurs des participants à la réunion.';
$string['room'] = 'Salle';
...
$string['selectionarea'] = 'Pas de choix';
...
$string['showmedia'] = 'Afficher la section Média';
$string['showmedia_help'] = 'Activer cette option affichera la section Média sur la page de la réunion.';
$string['showmediaonview'] = 'Afficher la section Média sur la page de la réunion';
$string['showschedule'] = 'Afficher la section Planification';
$string['showschedule_help'] = 'Activer cette option affichera la section Planification sur la page de la réunion.';
$string['showscheduleonview'] = 'Afficher la section Planification sur la page de la réunion';
$string['showsecurity'] = 'Afficher la section Sécurité';
$string['showsecurity_help'] = 'Activer cette option affichera la section Sécurité sur la page de la réunion.';
$string['showsecurityonview'] = 'Afficher la section Sécurité sur la page de la réunion';
...
$string['trackingfields_help'] = 'Saisir le(s) nom(s)/libellé(s) du champ de suivi, séparés par des virgules, à activer pour les activités Zoom.';
...
$string['updatetrackingfields'] = 'Mettre à jour les paramètres du champ de suivi depuis Zoom';
...
$string['webinar_by_default_desc'] = 'Créer l’instance Zoom comme un webinaire par défaut.';
...
$string['zoomerr_field_missing'] = '{$a} introuvable';
...
$string['zoomerr_no_access_token'] = 'Aucun jeton d’accès renvoyé';
