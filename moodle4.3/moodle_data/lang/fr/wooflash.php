...
/**
 * Strings for component 'wooflash', language 'fr', version '4.3'.
 *
 * @package     wooflash
 * @category    string
...
$string['accesskeyid'] = 'ID Plateforme (accessKeyId)';
...
$string['pingNOTOK'] = 'La connexion n’a pas pu être établie avec Wooflash. Veuillez vérifier vos réglages.';
...
$string['wooflashname'] = 'Nom';
$string['wooflashsettings'] = 'Réglages';
