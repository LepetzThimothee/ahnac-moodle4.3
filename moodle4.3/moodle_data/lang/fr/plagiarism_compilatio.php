...
/**
 * Strings for component 'plagiarism_compilatio', language 'fr', version '4.3'.
 *
...
$string['cron_check'] = 'La tâche planifiée get_scores du plugin a été exécuté le {$a} pour la dernière fois.';
...
$string['detailed_error_too_large'] = 'Ces documents n\'ont pas pu être analysés par Compilatio car ils sont trop volumineux (Taille maximale : {$a} MB).';
...
$string['no_students_finished_quiz'] = 'Aucun étudiant n\'a terminé le quiz';
...
$string['privacy:metadata:external_compilatio_user:email'] = 'Email de l\'enseignant';
...
$string['privacy:metadata:external_compilatio_user:username'] = 'Email de l\'enseignant';
...
$string['saved_config_failed'] = '<strong>La combinaison de la clé API et de l\'adresse saisie est invalide. Compilatio est désactivé, veuillez réessayer.<br/>
...
$string['send_files'] = 'Envoie les fichiers à Compilatio pour détection de similitudes';
...
$string['studentanalyses'] = 'Permettre aux élèves d\'analyser leurs documents';
...
$string['subscription_analysis_count'] = 'Documents analysés : {$a->usage} de {$a->valeur}';
$string['subscription_analysis_page_count'] = 'Pages analysées : {$a->usage} de {$a->valeur}';
...
$string['title_error_too_large'] = 'Ce fichier est trop volumineux pour être traité par Compilatio. Taille maximale : {$a} MB';
...
$string['title_queue'] = 'Le document est maintenant dans la file d\'attente et il sera bientôt analysé par la Compilatio';
...
$string['webservice_unreachable_title'] = 'Indisponibilité Compilatio';
$string['word'] = 'mots';
