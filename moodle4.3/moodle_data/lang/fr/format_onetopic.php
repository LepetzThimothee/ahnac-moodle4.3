...
/**
 * Strings for component 'format_onetopic', language 'fr', version '4.3'.
 *
...
$string['aboutresource'] = 'Sur la ressource';
...
$string['colorpicker'] = 'Choix de couleur';
...
$string['courseindex'] = 'Index de cours';
$string['creating_section'] = 'Création du nouveau sujet';
$string['cssbackground'] = 'Fond';
$string['cssborder'] = 'Bordure';
$string['csscolor'] = 'Couleur';
$string['cssfont'] = 'Police';
$string['cssnone'] = 'Aucun';
$string['cssnormal'] = 'Normal';
$string['cssother'] = 'Autres styles';
$string['csssize'] = 'Taille';
...
$string['cssunit'] = 'Unité';
$string['cssunit_percent'] = '%';
$string['cssweightbold'] = 'Gras';
$string['currentsection'] = 'Cette section';
$string['defaultsectionsnavigation'] = 'Valeur par défaut pour la navigation entre les sections';
...
$string['enableanchorposition'] = 'Activer la position d\'ancrage';
$string['enableanchorposition_help'] = 'Utiliser un ancrage pour naviguer au sommet des onglets lorsqu\'on clique sur un onglet';
$string['enablecustomstyles'] = 'Activer la personnalisation des styles';
$string['enablecustomstyles_help'] = 'Activer la couleur de police, de fond, et autres styles d\'onglet personnalisés dans la configuration des sections';
...
$string['hiddentabsbar'] = 'Les onglets sont programmés pour être cachés. Ils ne seront pas visibles si le mode d\'édition n\'est pas activé.';
...
$string['increasesections'] = 'Ajouter une section à la suite de la section actuellement sélectionnée';
$string['index'] = 'Index';
...
$string['sectionsnavigation_sitelevel'] = 'Utiliser la valeur du site par défaut';
$string['sectionsnavigation_slides'] = 'Comme les slides';
...
$string['tablabelactive'] = 'Activer les onglets';
$string['tablabeldefault'] = 'Onglet par défaut';
$string['tablabeldisabled'] = 'Désactivé';
$string['tablabelhighlighted'] = 'Souligné';
$string['tablabelparent'] = 'Onglet parent';
$string['tabstylebuttons_help'] = 'Cliquer sur chaque bouton pour configurer l\'apparence de l\'onglet dans chacun de ses états possibles';
$string['tabstyleclear'] = 'Effacer les styles';
$string['tabstyles'] = 'Styles d\'onglet';
$string['tabstyles_help'] = 'Définir les styles pour les différents onglets';
$string['tabstylesset'] = 'Définir les styles';
$string['tabstylestitle'] = 'Styles d\'onglet';
$string['tabsview'] = 'Vue des onglets';
$string['tabsview_default'] = 'Par défaut';
$string['tabsview_oneline'] = 'Une ligne seulement';
$string['tabsview_vertical'] = 'Verticalement';
...
$string['usecourseindexsite'] = 'Utiliser la valeur du site par défaut';
$string['usescourseindex'] = 'Utiliser l\'index de cours';
$string['usescourseindex_help'] = 'Utiliser la barre « index de cours » pour naviguer entre les sections et ressources';
$string['usessectionsnavigation'] = 'Utiliser la navigation entre les sections';
$string['usessectionsnavigation_help'] = 'Montrer le bouton pour naviguer à la section suivante ou précédente';
