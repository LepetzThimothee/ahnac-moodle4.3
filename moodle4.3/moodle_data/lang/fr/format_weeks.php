...
/**
 * Strings for component 'format_weeks', language 'fr', version '4.3'.
 *
...
$string['sectionavailability_title'] = 'Disponibilité de la semaine';
$string['sectiondelete_title'] = 'Supprimer la semaine ?';
$string['sectionmove_title'] = 'Déplacer la semaine';
$string['sectionname'] = 'Semaine';
$string['sectionsavailability'] = 'Disponibilité des semaines';
$string['sectionsavailability_title'] = 'Disponibilité des semaines';
$string['sectionsdelete'] = 'Supprimer des semaines';
$string['sectionsdelete_info'] = 'Cette opération supprimera {$a->count} semaines et toutes les activités qu\'elles contiennent.';
$string['sectionsdelete_title'] = 'Supprimer les semaines sélectionnées ?';
$string['sectionsmove'] = 'Déplacer des semaines';
$string['sectionsmove_info'] = 'Déplacer {$a} semaines après';
$string['sectionsmove_title'] = 'Déplacer les semaines sélectionnées';
$string['selectsection'] = 'Sélectionner la semaine {$a}';
