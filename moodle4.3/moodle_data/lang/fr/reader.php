...
/**
 * Strings for component 'reader', language 'fr', version '4.3'.
 *
 * @package     reader
 * @category    string
...
$string['averagepassed_help'] = 'Le nombre moyen des tests de Reader réussis par étudiant';
...
$string['averagewordsallterms_help'] = 'Nombre moyen de mots gagnés par chaque étudiant de ce groupe, en tenant compte de tous les mots jamais gagnés par aucun d’entre eux dans aucune activité de lecture sur ce site Moodle';
$string['averagewordsthisterm_help'] = 'Nombre moyen de mots gagnés par chaque étudiant de ce groupe, en considérant uniquement les mots gagnés dans cette activité de lecture pendant le trimestre en cours';
$string['awardbookpoints'] = 'Attribuer des crédits aux étudiants sélectionnés';
...
$string['bookratingslevel'] = 'Afficher les notes du livre de l’étudiant pour chaque niveau de livre';
$string['books'] = 'Livres';
...
$string['completiontotalwords_help'] = 'Le nombre total de lectures qu’un étudiant doit réaliser dans le cadre de cette activité pour pouvoir la marquer comme étant terminée.';
...
* Chaque test a plusieurs questions sur le livre. Les questions sont différentes pour chaque étudiant.
...
En règle générale, la note maximale est de 100, mais si tous les étudiants ont le même objectif de lecture, cela peut aider les étudiants à comprendre leur note si ce paramètre est identique à l’objectif de lecture.';
$string['maxquizattemptrate'] = 'Taux maximal de tentatives de test';
$string['maxquizattemptrate_help'] = 'Le taux maximum auquel les étudiants peuvent tenter des tests Reader. Si un étudiant essaie de tenter plus que le nombre spécifié de test pendant la durée spécifiée, l’action spécifiée sera exécutée.';
...
$string['modulename_help'] = 'Le module Reader permet aux enseignants de définir des objectifs de lecture pour les étudiants et de démontrer qu’ils ont atteint les objectifs de lecture spécifiés.';
...
$string['nextlevel_help'] = 'Nombre de tests qu’un étudiant peut répondre au prochain niveau de lecture, c’est-à-dire au niveau de lecture juste au-dessus de son niveau de lecture actuel. Notez que ces tests ne comptent PAS dans la promotion.';
...
$string['percentactive_help'] = 'Pourcentage d’étudiants ayant répondu à au moins un test Reader';
$string['percentinactive'] = 'Pourcentage d’inactif';
$string['percentinactive_help'] = 'Pourcentage d’étudiants n’ayant répondu à aucun test Reader';
...
$string['pleasespecifyyourclassgroup'] = 'Veuillez spécifier votre groupe de classe ou rechercher un étudiant spécifique.';
...
$string['prevlevel_help'] = 'Le nombre de tests qu’un étudiant peut effectuer à partir du niveau de lecture précédent, c’est-à-dire le niveau de lecture qui se situe juste en dessous de leur niveau de lecture actuel. Notez que ces quiz ne comptent pas dans la progression.';
