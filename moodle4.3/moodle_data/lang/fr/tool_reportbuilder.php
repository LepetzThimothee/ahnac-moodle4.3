...
/**
 * Strings for component 'tool_reportbuilder', language 'fr', version '4.3'.
 *
...
$string['customizecondition'] = 'Modifier le nom de la condition';
$string['customizefilter'] = 'Modifier le nom du filtre';
$string['customizeheader'] = 'Modifier l’en-tête de la colonne « {$a} »';
...
$string['usersuspended'] = 'Enregistrement suspendu';
