...
/**
 * Strings for component 'vpl', language 'fr', version '4.3'.
 *
 * @package     vpl
 * @category    string
...
<li> « <strong>grade reduction</strong> = [valeur|pourcentage%] » : par défaut, une erreur diminue la note de l’étudiant (en commençant par maxgrade) de la valeur (grade_range / nombre de cas) ; avec cette instruction, il est possible de changer la valeur ou le pourcentage de la diminution.</li>
</ul>';
$string['text'] = 'Texte';
