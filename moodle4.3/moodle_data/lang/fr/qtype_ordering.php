...
/**
 * Strings for component 'qtype_ordering', language 'fr', version '4.3'.
 *
...
$string['answerheader'] = 'Élément déplaçable {no}';
...
$string['itemplural'] = 'éléments';
$string['itemsingular'] = 'élément';
...
$string['privacy:metadata'] = 'Le plugin type de question classement n’enregistre aucune donnée personnelle.';
...
$string['removeeditor'] = 'Enlever l\'éditeur HTML';
...
$string['yougotnincorrect'] = 'Vous avez {$a->numincorrect} {$a->numincorrectplural} incorrectes.';
$string['yougotnpartial'] = 'Vous avez {$a->numpartial} {$a->numpartialplural} partiellement correctes.';
$string['yougotnright'] = 'Vous avez {$a->numright} {$a->numrightplural} correctes.';
