...
/**
 * Strings for component 'auth', language 'fr', version '4.3'.
 *
 * @package     auth
 * @category    string
...
$string['alternatelogin'] = 'Si une URL est indiquée ici, elle sera utilisée comme page de connexion pour ce site. La page spécifiée doit contenir un formulaire dont la propriété « action » est <strong>{$a}</strong> et doit contenir les champs <strong>username</strong> et <strong>password</strong>.<br />Attention à saisir une URL correcte, sans quoi on risque de ne plus pouvoir accéder au site.<br />Pour utiliser la page de connexion par défaut, laisser ce champ vide.';
...
$string['errorminpasswordnonalphanum'] = 'Le mot de passe doit comporter au moins {$a} caractère(s) spéciaux tels que *, - ou #.';
...
$string['informminpasswordnonalphanum'] = 'au moins {$a} caractère(s) spéciaux tels que *, - ou #';
