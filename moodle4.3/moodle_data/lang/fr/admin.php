...
/**
 * Strings for component 'admin', language 'fr', version '4.3'.
 *
 * @package     admin
 * @category    string
...
$string['agedigitalconsentverification_desc'] = 'Active la vérification de l’âge de majorité numérique des utilisateurs avant l’affichage de la page d’auto-inscription. Ceci permet d’éviter que des mineurs s’inscrivent sur votre site sans le consentement de leur représentant légal. <a target="_blank" href="{$a}">Des informations supplémentaires</a> sont disponibles pour plus d’aide.';
...
$string['availabletoanyone'] = 'Disponible pour tout visiteur du site';
...
$string['blockprotected'] = 'Les instances de {$a} sont protégées.';
$string['blocksettings'] = 'Gestion des blocs';
$string['blockunprotect'] = 'Déprotéger';
$string['blockunprotectblock'] = 'Déprotéger les instances de {$a}';
$string['blockunprotected'] = 'Les instances de {$a} ne sont pas protégées.';
...
$string['cliupgradecompletenomaintenanceupgrade'] = 'Pour vider les caches restants après le transfert du trafic utilisateur vers le nouveau code :
...
Effectuez ces opérations de façon isolée, en laissant du temps entre les commandes, afin de réduire les pics de charges sur le serveur web.';
...
$string['cliupgrademaintenancenotrequired'] = 'Cette mise à jour <strong>n\'activera pas</strong> le mode de maintenance pour les utilisateurs.';
$string['cliupgrademaintenancerequired'] = 'Cette mise à jour <strong>activera</strong> le mode de maintenance pour les utilisateurs.';
...
$string['cliupgradesetlock'] = 'La mise à jour a été verrouillée de sorte à n’être possible qu’au moyen de la ligne de commande.';
$string['cliupgradeunsetlock'] = 'Le verrouillage de la mise à jour en mode ligne de commande uniquement a été retiré.';
$string['cliyesnoprompt'] = 'Tapez y (pour oui) ou n (pour non)';
$string['close'] = 'Fermer';
$string['cohort_customfield'] = 'Champs de cohorte personnalisés';
...
$string['configallowobjectembed'] = 'Par mesure de sécurité, les utilisateurs avec rôle d\'étudiant n’ont pas les permissions requises pour intégrer des fichiers multimédias dans des textes à l’aide de balises EMBED et OBJECT du code HTML, bien que le multimédia puisse être affiché au moyen du filtre multimédia. Activer cette option pour permettre l’utilisation de ces balises.';
...
$string['configallusersaresitestudents'] = 'Pour les activités affichées sur la page d’accueil, TOUS les utilisateurs doivent-ils être considérés comme des étudiants ? Si oui, tout utilisateur avec un compte pourra participer à ces activités en tant qu’étudiant. Sinon, seuls les participants d’au moins un cours pourront participer à ces activités. Seuls les administrateurs et les utilisateurs désignés spécifiquement comme enseignants peuvent agir comme enseignants pour les activités de la page d’accueil.';
...
$string['configcoursegraceperiodafter'] = 'Classer comme « actifs » les anciens cours durant ce nombre de journées après la date de fin du cours.';
$string['configcoursegraceperiodbefore'] = 'Classer comme « actifs » les futurs cours durant ce nombre de journées avant la date de début du cours.';
...
$string['configcustomusermenuitems'] = 'Vous pouvez configurer le contenu du menu utilisateur (à l’exception du lien de déconnexion, qui est ajouté automatiquement). Chaque ligne définit un élément de menu et comprend 3 éléments, séparés par des barres verticales (|) : 1) une chaîne de caractères de la forme « chaînedecaractèresmoodle, nomducomposant » ou un simple texte, et 2) une URL. Des barres de séparation peuvent être spécifiées en ajoutant à l’endroit désiré une ligne avec un ou plusieurs #.';
...
$string['configdebugdisplay'] = 'Une fois ce réglage activé, les rapports d’erreur seront affichés sur la page HTML. C’est pratique, mais cela rend non conforme le XHTML, le JS, les cookies et les en-têtes HTTP en général. Si le réglage est désactivé, les rapports sont écrits dans les journaux du serveur, permettant un meilleur débogage. Le réglage error_log de PHP contrôle dans quel fichier les rapports sont écrits.';
...
$string['configdocroot'] = 'Définit l’URL de Moodle Docs pour la documentation contextuelle signalée par le lien « Documentation pour cette page » au bas de chaque page. Si le champ n’est pas renseigné, les liens ne seront pas affichés.';
...
$string['configduration_low'] = 'Cette valeur est trop basse. La valeur minimale est {$a}.';
...
$string['configemailheaders'] = 'En-têtes de courriel à ajouter verbatim à tous les courriels sortant.';
...
$string['configfilterall'] = 'Filtrer toutes les chaînes, y compris les en-têtes, titres, barre de navigation, etc. Ce réglage n’est utile qu’en combinaison avec l’utilisation du filtre « Contenus multilingues ». Utilisé seul, il ne fera que charger inutilement votre serveur.';
...
$string['configfilternavigationwithsystemcontext'] = 'Normalement, le filtrage est lié au contexte dans lequel il est utilisé (par exemple dans un cours) ; pour la navigation du site, tout filtrer explicitement au niveau système peut cependant améliorer la performance lors de l’utilisation du filtrage sur « Contenu et titres ».';
...
$string['configforcelogin'] = 'Habituellement, la page d’accueil et la liste des cours (mais pas les cours eux-mêmes) peuvent être consultés sans se connecter au site. Si vous voulez imposer aux visiteurs de se connecter avant de faire <strong>quoi que ce soit</strong> dans le site, veuillez activer cette option.';
...
$string['configfrontpagecourselimithelp'] = 'Ce réglage détermine le nombre maximal de cours à afficher dans les listes de cours sur la page d’accueil.';
$string['configfrontpageloggedin'] = 'Les éléments sélectionnés ci-dessus seront affichés sur la page d’accueil pour les utilisateurs connectés.';
...
$string['configgetremoteaddrconf'] = 'Si votre serveur est situé derrière un proxy inverse, vous pouvez utiliser ce réglage pour indiquer les en-têtes HTTP dont on peut être sûr qu’ils contiennent l’adresse IP distante. Les en-têtes sont lus dans l’ordre indiqué, le premier disponible étant utilisé.';
...
$string['configintrosite'] = 'Cette page permet définir l’aspect de la page d’accueil et le nom de ce site. Vous pourrez modifier ces paramètres en tout temps en utilisant les menus d’administration.';
...
$string['configproxyfixunsafe_help'] = 'Ce réglage tente de corriger les appels internes qui ne passent pas par le proxy en ajoutant l’agent utilisateur MoodleBot et utilisant le proxy.';
...
$string['configproxylogunsafe_help'] = 'Ce réglage tente d’ajouter au journal les appels internes qui ne passent pas par le proxy et qui le devraient.';
...
$string['configrecaptchapublickey'] = 'Chaîne de caractères (clef de site) utilisée pour afficher l’élément reCAPTCHA dans le formulaire d’enregistrement et d’assistance de site. Les clefs reCAPTCHA peuvent être obtenues de <a target="_blank" href="https://www.google.com/recaptcha">Google reCAPTCHA</a>.';
...
$string['configservicespage'] = 'Saisir l\'URL d\'une page de services et d\'assistance ou laisser vide pour lier vers la page des services de moodle.com. Le lien n\'est affiché qu\'aux administrateurs du site.';
...
$string['configsessiontimeoutwarning'] = 'Si des personnes connectées à ce site sont inactives pendant une longue durée (sans charger de page), elles sont averties que leur session va se terminer. Ce réglage détermine la durée avant affichage de l’avertissement.';
$string['configsessiontimeoutwarningcheck'] = 'La durée avant avertissement d’échéance doit être inférieure à la durée de session';
...
$string['configsmtpoauthservice'] = 'Sélectionner le service OAuth 2 configuré pour communiquer avec le serveur SMTP. Si ce service n’existe pas encore, vous devez le créer. Remarque : ce réglage ne fonctionne que si le type d’authentification SMTP est réglé sur XOAUTH2.';
...
$string['configsupportavailability'] = 'Détermine qui peut contacter l’assistance du site depuis le pied de page.';
$string['configsupportemail'] = 'Si le serveur SMTP est configuré sur ce site et qu’une page d’assistance n’est pas définie, cette adresse de courriel recevra les messages envoyés au moyen du formulaire d’assistance. Si l’envoi échoue, l’adresse de courriel sera affichée pour les utilisateurs connectés.';
$string['configsupportname'] = 'Le nom de la personne ou du service fournissant de l’assistance au moyen du formulaire d’assistance ou de la page d’assistance.';
$string['configsupportpage'] = 'Saisir l’URL d’une page d’assistance ou laisser vide pour lier vers un formulaire de contact. Le lien est affiché dans le pied de page du site.';
...
$string['confirmdeletecomments'] = 'Voulez-vous vraiment supprimer les commentaires sélectionnés ?';
$string['confirmed'] = 'Confirmé';
$string['contactsitesupport'] = 'Contacter l’assistance du site';
...
$string['coursecolorheading_desc'] = 'Les cours qui n’ont pas d’image de cours définie dans les paramètres du cours sont affichés sur le Tableau de bord avec dans une carte à motifs colorés. Les couleurs à utiliser peuvent être indiquées ci-dessous.';
...
$string['coursecreationguide'] = 'URL du guide de création de cours Moodle';
$string['coursecreationguide_help'] = 'Définit l\'URL vers un Guide de démarrage avec de courtes vidéos et des astuces générales sur la création de cours. Un lien vers ce guide est affiché sur la page Mes cours lorsqu\'il n\'y a pas de cours à afficher. Seuls les utilisateurs ayant la capacité de créer des cours voient ce lien.';
...
$string['coursepage'] = 'Page de cours';
...
$string['cron_keepalive'] = 'Temps d\'entretien';
$string['cron_keepalive_desc'] = 'La durée pendant laquelle continuer à s\'attendre à des tâches additionnelles. Ce réglage permet d\'assurer que le cron est toujours en cours d\'exécution. Si des systèmes d\'exécution de tâches dédiés sont utilisés, fixer cette valeur à 0. Sinon, fixer-la à une valeur similaire à la limite de concurrence des tâches ad hoc. Les valeurs trop longues sont à éviter ; la durée maximale est de 15 minutes.';
...
$string['datarootsecurityerror'] = '<p><strong>NOTIFICATION DE SÉCURITÉ !</strong></p><p>Votre dossier de données n’est pas au bon emplacement. Il est directement exposé au web. Ceci signifie que tous les fichiers privés de votre Moodle sont disponibles pour n’importe qui et que certains d’entre eux pourraient être utilisés par des pirates pour accéder de façon non autorisée à l’administration de votre site !</p><p>Vous <em>devez</em> déplacer votre dossier de données ({$a}) en dehors de votre dossier web public et mettre à jour le réglage <code>$CFG->dataroot</code> de votre fichier config.php de façon adéquate.</p>';
$string['datarootsecuritywarning'] = 'La configuration de votre site semble ne pas être sûre. Veuillez vous assurer que le dossier des données de Moodle ({$a}) ne puisse pas être atteint directement depuis le web.';
$string['dbprefixtoolong'] = 'Le préfixe de la base de données de votre site ($CFG->prefix) est trop long ({$a->current} caractères). Le nombre maximal de caractères autorisé est de {$a->maximum}.';
...
$string['debugtemplateinfo'] = 'Afficher les infos de gabarit';
$string['debugtemplateinfo_desc'] = 'Si ce réglage est activité, les gabarits utilisés pour le rendu sont affichés en commentaire dans la page HTML. Après avoir modifé ce réglage, veuillez purger les caches. À n\'utiliser que temporairement, à des fins de débogage, car le code HTML résultant produit des erreurs de validation. Ce règlage peut aussi bloquer certaines fonctionnalités.';
...
$string['defaulthomepage'] = 'Page initiale des utilisateurs';
...
$string['devlibdirpresent'] = 'Les dossiers contenant des bibliothèques de développement, en particulier <em>/vendor</em> et <em>/node_modules</em>, ne doivent pas être présents sur des sites publics. Consulter le <a href="{$a->moreinfourl}">Panorama de sécurité</a> pour plus d’informations.';
...
$string['enableanalytics'] = 'Analyse de données';
...
$string['enablecommunicationsubsystem_desc'] = 'Ce réglage permet l\'intégration de fournisseurs de communication comme Matrix pour faciliter la communication entre étudiants et enseignants. Ces intégrations se gérent dans les <a href="settings.php?section=managecommunicationproviders">Plugins</a>.';
...
$string['enabledashboard_help'] = 'Le tableau de bord affiche par défaut la chronologie, le calendrier et les éléments récemment consultés. Il est possible de choisir un tableau de bord par défaut différent et de permettre aux utilisateurs de personnaliser leur propre tableau de bord. Si ce réglage est désactivé, le réglage « Page initiale des utilisateurs » doit avoir une valeur autre que Tableau de bord.';
...
$string['enablepdfexportfont'] = 'Activer les polices de caractères PDF';
$string['enablepdfexportfont_desc'] = 'Si votre site a des cours dans des langues nécessitant des caractères particuliers dans les fichiers PDF, ce réglage permet de spécifier la police dans les réglages du cours. Les polices disponibles doivent être indiquées dans le fichier config.php avec $CFG->pdfexportfont.';
...
$string['enablesharingtomoodlenet'] = 'Activer le partage vers MoodleNet (externe)';
$string['enablesharingtomoodlenet_desc'] = 'Permet aux utilisateurs de partager des contenus de cours vers une instance MoodleNet, s\'ils ont la capacité adéquate.';
...
$string['encryptedpassword_edit'] = 'Saisir une nouvelle valeur';
$string['encryptedpassword_set'] = '(défini et chiffré)';
$string['enroladminnewcourse'] = 'Inscrire automatiquement l’administrateur dans les nouveaux cours';
$string['enroladminnewcourse_help'] = 'Lorsqu’un administrateur crée un cours, doit-il y être automatiquement inscrit avec le rôle de créateur de cours ?';
...
$string['environmentmariadbwrongdbtype'] = 'Type de base de données $CFG->dbtype incorrect. Vous devez le modifier dans votre fichier config.php, en remplaçant « mysql » par « mariadb ».';
...
$string['favicon_desc'] = 'La favicon est affichée tout contre le titre du site dans l’onglet du navigateur. Une favicon de Moodle est affichée si aucune favicon personnalisée n’est fournie.';
...
$string['filternavigationwithsystemcontext'] = 'Filtrer la navigation dans le contexte système';
...
$string['group_customfield'] = 'Champs personnalisés de groupe';
...
$string['grouping_customfield'] = 'Champs personnalisés de groupement';
...
$string['hookcallbacknotcallable'] = 'Ce callback ne peut pas être appelé. C\'est peut-être que la classe ou la méthode n\'existe pas ou parce que la méthode n\'est pas publique.';
$string['hookcallbacks'] = 'Callbacks';
$string['hookcallbacks_help'] = 'La liste des callbacks qui seront appelé lorsque le hook est déclenché.

L\'ordre indiqué est celui dans lequel les callbacks seront appelés.

Un callback de priorité plus élevée sera appelé avant un callback de priorité inférieure.';
$string['hookclassmissing'] = 'Classe du hook introuvable';
$string['hookclassmissing_desc'] = 'L\'agent de découverte de hook a renvoyé une classe inexistante.';
$string['hookconfigoverride'] = 'Modifié';
$string['hookconfigoverride_help'] = 'La définition de ce callback a été modifiée dans le fichier de configuration du site config.php.';
$string['hookdeprecates'] = 'Callbacks';
$string['hookdescription'] = 'Description';
$string['hookdescriptionmissing'] = 'Le hook n\'a pas de méthode de description';
$string['hookname'] = 'Hook';
$string['hooksoverview'] = 'Vue d\'ensemble des hooks';
$string['hookunknown'] = 'Hook introuvable';
$string['hookunknown_desc'] = 'L\'objet surveillé par ce callback n\'est pas disponible. Il a peut-être été supprimé ou renommé, ou n\'est pas disponible dans cette version de Moodle.';
...
$string['iplookupinfo'] = 'Le serveur gratuit NetGeo pour localiser les adresses IP. Cette base de données n’est toutefois plus entretenue et peut fournir des données incorrects. Il est recommandé d’installer sur votre serveur une copie de la base de données GeoLite2 City gratuite de MaxMind.<br />Si une clef API Google Maps V3 est fournie, la localisation des adresses IP est affichée à l’aide de Google Maps. Il faut pour cela un compte Google et de demander une clef API Google Maps V3. Si une telle clef n’est pas fournie, la localisation des adresses IP est affichée au moyen de OpenStreetMap.';
...
$string['logo'] = 'Logo';
$string['logo_desc'] = 'Un logo ou logotype qui sera utilisé par certains thèmes. Cette image peut être en haute résolution, car elle sera mise à l \'échelle (et mise en cache pour augmenter la performance). Les logos plus larges que long donnent de meilleurs résultats.';
$string['logocompact'] = 'Logo compact';
$string['logocompact_desc'] = 'Une version compacte du même logo que ci-dessus, par exemple une icône ou un emblême. L’image doit être lisible même en petite taille.';
...
$string['maturitycoreinfo'] = 'Votre site utilise actuellement du code de développement non stable « {$a} ».';
$string['maturitycorewarning'] = 'Vous êtes sur le point d’installer une version ou de mettre à jour Moodle vers un version marquée comme « {$a} », qui n’est pas considérée comme prête pour la production. Veuillez vous assurer que cette action est intentionnelle et que vous utilisez la version voulue de Moodle. Consultez la documentation pour plus d’informations.';
...
$string['mnetrestore_extusers'] = '<strong>Remarque :</strong> ce fichier de sauvegarde contient des comptes utilisateurs distants provenant d’un serveur MNet, qui seront restaurés au cours du processus.';
$string['mnetrestore_extusers_admin'] = '<strong>Remarque :</strong> ce fichier de sauvegarde semble provenir d’une installation de Moodle différente et contient des comptes utilisateurs distants provenant du réseau MNet. Le processus de restauration tentera de faire correspondre les serveurs MNet pour tous les utilisateurs créés. Ceux qui n’auront pas de correspondance seront automatiquement basculés en mode d’authentification interne (au lieu de MNet). Le journal de restauration vous informera à ce sujet.';
$string['mnetrestore_extusers_mismatch'] = '<strong>Remarque :</strong> ce fichier de sauvegarde semble provenir d’une installation de Moodle différente. Il contient des comptes utilisateurs provenant du réseau MNet dont la restauration pourrait échouer. Cette opération n’est pas supportée. Si vous êtes vraiment certain que ce fichier a été créé sur ce Moodle, ou si vous pouvez vous assurer que tous les serveurs MNet sont configurés correctement, vous pouvez malgré tout tenter la restauration.';
$string['mnetrestore_extusers_noadmin'] = '<strong>Remarque :</strong> ce fichier de sauvegarde semble provenir d’une installation de Moodle différente et contient des comptes utilisateurs distants d’un serveur MNet. Vous n’avez pas les permissions requises pour effectuer ce type de restauration. Veuillez contacter l’administrateur du site ou restaurer le cours sans les informations des utilisateurs (modules, fichiers, etc.)';
$string['mnetrestore_extusers_switchuserauth'] = 'Authentification de l’utilisateur {$a->username} d’un serveur MNet distant (provenant de {$a->mnethosturl}) basculée vers utilisateur authentifié localement {$a->auth}.';
$string['mobilenotconfiguredwarning'] = 'L’app Moodle n’est pas activée.';
$string['modassignmentinuse'] = 'Votre site utilise encore le plugin Devoir 2.2. Avant d\'effectuer la mise à jour, vous devez 1) sauvegarder toutes les activités Devoir 2.2 que vous voulez conserver et les restaurant comme activités Devoir, et 2) supprimer de la base de données toutes les données Devoir 2.2.';
$string['modassignmentsubpluginsexist'] = 'Des sous-plugins Devoirs 2.2 sont peut-être encore présents. Le dossier mod/assignment et tous ses sous-plugins doivent être supprimés avant la mise à jour.';
...
$string['multilangforceold'] = 'Imposer l’ancienne syntaxe multilingue : &lt;span&gt; sans le class="multilang" ni &lt;lang&gt;';
...
$string['navshowfrontpagemods_help'] = 'Si ce réglage est activé, les activités de la page d’accueil seront affichées dans la navigation, au-dessous des pages de site. Ce réglage n’a d’effet qu’avec les thèmes basés sur Classic.';
...
$string['navsortmycoursessort'] = 'Ordre des cours dans le bloc de navigation';
$string['navsortmycoursessort_help'] = 'Détermine si les cours sont listés dans l’ordre de tri indiqué dans Administration du site > Cours > Gestion des cours et catégories, ou suivant l’ordre alphabétique. Ce réglage ne s’applique qu’aux thèmes fondés sur Classic.';
$string['never'] = 'Jamais';
...
$string['noemaileverwarning'] = '<strong>Remarque :</strong> l\'envoi de tous les courriels est désactivé.';
...
$string['noteunneededblocks'] = 'Information : les blocs à afficher ne seront pas listés dans le menu « Ajouter un bloc » dans les cours s’ils sont désignés dans le réglage du thème « Blocs inutiles ».';
...
$string['opensslrecommended'] = 'L’installation de la bibliothèque optionnelle OpenSSL est vivement recommandée, afin de pouvoir utiliser la fonctionnalité MNet.';
...
$string['oracledatabaseinuse'] = 'La prise en charge des bases de données Oracle va être supprimée. La version 4.5 de Moodle sera la dernière version à prendre en charge les bases de données Oracle. Pour plus d\'informations à ce sujet, voir l\'annonce sur moodle.org <a href="https://moodle.org/mod/forum/discuss.php?d=456122" target="_blank">Oracle database support in LMS deprecation</a> (en anglais).';
...
$string['passwordchangelogout_desc'] = 'Si ce réglage est activé, lorsqu’un mot de passe est modifié, toutes les sessions de navigateurs sont terminées, à l’exception de celle dans laquelle le nouveau mot de passe est spécifié (ce réglage ne concerne pas le changement de mots de passe par le dépôt d’utilisateurs par lots).';
...
$string['pathtosassc_help'] = 'Si le chemin d’accès au programme SassC est renseigné, la compilation SASS sera effectuée par ce programme, au lieu du code PHP de Moodle. Consulter https://github.com/sass/sassc pour des informations supplémentaires.';
...
$string['perfdebugdeferred'] = 'En attente de la fin du script pour afficher les infos de performance…';
...
$string['pluginsoverviewsee'] = 'Voir <a href="{$a->url}">la vue d’ensemble des plugins</a> pour plus d’informations.';
...
$string['profilefieldmaxlength_help'] = 'Pour utiliser ce champ dans le réglage « Afficher l’identité de l’utilisateur », la limite doit être au maximum de 255 caractères.';
...
$string['profilevisible_help'] = '* caché - pour les données privées, uniquement visible pour les administrateurs et gestionnaires
...
$string['proxyfixunsafe'] = 'Corriger les appels sans proxy';
$string['proxyhost'] = 'Hôte du proxy';
$string['proxylogunsafe'] = 'Journaliser les appels sans proxy';
...
$string['referrerpolicydesc'] = 'Détermine l’en-tête de politique de référent à inclure dans les réponses envoyées par votre site.';
...
$string['replacefrontsearch'] = 'Utilisé pour la recherche de cours sur la page d’accueil';
...
$string['resetindentation'] = 'Réinitialiser l\'indentation sur tout le site';
$string['resetindentation_help'] = 'Cette opération supprimera toutes les indentations faites précédemment pour les cours du site en {$a->format}.';
$string['resetindentation_title'] = 'Réinitialiser l\'indentation sur tout le site ?';
$string['resetindentationsuccess'] = 'Indentation réinitialisée';
...
$string['searchmaxtopresults'] = 'Nombre de premiers résultats';
$string['searchmaxtopresults_desc'] = 'Le nombre maximum de résultats les plus haut classés à afficher au-dessus des résultats de recherche des contenus de cours, des cours et des utilisateurs.';
...
$string['searchteacherroles'] = 'Rôles d’enseignant';
$string['searchteacherroles_desc'] = 'Sélectionner tous les rôles qui remontent les utilisateurs dans les résultats de recherche.';
...
$string['sessiontimeoutwarning'] = 'Avertissement d’échéance';
...
$string['sitenameintitle_help'] = 'Ce réglage permet de d’ajouter le nom du site à la fin du titre de la page. Cette pratique est encouragée pour augmenter l’accessibilité du site en permettant aux utilisateurs d’identifier rapidement la page sur laquelle ils sont.';
...
$string['sitesectionhelp'] = 'Si cette option est activée, une section sera affichée sur la page d’accueil.';
...
$string['sort_idnumber'] = 'N° identifiant du cours';
...
$string['supportandservices'] = 'Assistance et service';
$string['supportavailability'] = 'Disponibilité de l’assistance';
$string['supportcontact'] = 'Contact d’assistance';
$string['supportemail'] = 'Courriel d’assistance';
$string['supportemailsubject'] = 'Demande d’assistance - {$a}';
$string['supportname'] = 'Nom d’assistance';
$string['supportpage'] = 'Lien contact d’assistance';
...
$string['task_dbreads'] = 'Lectures de la base de données';
$string['task_dbstats'] = 'Base de données';
$string['task_dbwrites'] = 'Écritures dans la base de données';
$string['task_duration'] = 'Durée';
$string['task_endtime'] = 'Horodatage de fin';
...
$string['task_logoutput'] = 'Résultat de tâche';
...
$string['task_status'] = 'Statut de la tâche';
$string['task_status_desc'] = 'La tâche « {$a->name} » est {$a->status}.<br />Pour plus d’informations, voir {$a->class}{$a->extradescription} dans <a href="{$a->gotourl}">Tâches programmées</a>.';
...
$string['taskautomatedbackup_report'] = 'Rapport des sauvegardes automatiques';
$string['taskbackupcleanup'] = 'Nettoyage des tables, journaux et fichiers de sauvegarde';
$string['taskbadgesadhoc'] = 'Délivrer un badge';
$string['taskbadgescron'] = 'Tâche ad hoc de délivrance de badges';
...
$string['tasklockcleanuptask'] = 'Nettoyer les méta-données de tâches ad hoc';
...
$string['testoutgoingmailconf_fromemail'] = 'Nom d’utilisateur ou adresse de courriel de l’expéditeur';
$string['testoutgoingmailconf_fromemail_help'] = 'Ce champ permet d’émuler l’envoi d’un message par cet utilisateur, mais l’en-tête From utilisé dans le véritable courriel envoyé dépendra d’autres réglages, comme allowedemaildomains';
$string['testoutgoingmailconf_fromemail_invalid'] = 'Nom d’utilisateur ou adresse de courriel de l’expéditeur non valide. L’adresse doit être correctement formatée ou bien ce doit être un nom d’utilisateur existant dans Moodle.';
$string['testoutgoingmailconf_message'] = 'Ceci est un message de test confirmant que vous avez configuré correctement les réglages de courriel sortant de votre site. Envoyé le : {$a}';
...
$string['testoutgoingmailconf_subject'] = '{$a->site} : message de test. {$a->additional} Envoyé le : {$a->time}';
...
$string['tokenizerrecommended'] = 'L’installation de l’extension Tokenizer de PHP est recommandée. Elle améliore les fonctionnalités de MNet.';
...
$string['unsupporteddbfilepertable'] = 'Pour un support complet de l’encodage UTF-8, tant MySQL que MariaDB nécessitent d’activer le paramètre « innodb_file_per_table ». Veuillez consulter la documentation pour plus d’informations.';
...
$string['unsupportedphpversion82'] = 'Les versions 8.2 et ultérieures de PHP ne sont pas prises en charge.';
$string['unsupportedphpversion83'] = 'Les versions 8.3 et ultérieures de PHP ne sont pas prises en charge.';
...
$string['userbulk'] = 'Actions par lots sur les utilisateurs';
...
$string['userfeedbackencouragement'] = '<p>Moodle possède une fonctionnalité donnant l’opportunité aux utilisateurs de communiquer leur avis sur le logiciel Moodle au moyen d’une plateforme d’enquête hébergée par Moodle HQ. Aucune information d’identification des utilisateurs n’est transmise à la plateforme d’enquête.</p>
...
<p>Les feedbacks des utilisateurs aident Moodle HQ à améliorer Moodle. Pour activer cette fonctionnalité, rendez-vous sur les <a href="{$a}">réglages de feedback</a>.</p>';
...
$string['userfiltersdefault_desc'] = 'Sélectionner les filtres à afficher sur les pages « Liste des utilisateurs » et « Actions par lots sur les utilisateurs ». Garder la touche ctrl ou cmd pour sélectionner plusieurs éléments. Les filtres non sélectionnés seront disponibles en cliquant sur « Afficher plus...».';
