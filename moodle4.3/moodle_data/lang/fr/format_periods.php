...
/**
 * Strings for component 'format_periods', language 'fr', version '4.3'.
 *
...
$string['futuresneakpeek_help'] = 'Traiter les périodes qui commencent plus tôt que cet intervalle en tant que période courante (par exemple, cela pourrait permettre aux étudiants de voir la semaine prochaine deux jours avant la fin de la semaine en cours)';
