...
/**
 * Strings for component 'enrol', language 'fr', version '4.3'.
 *
 * @package     enrol
 * @category    string
...
$string['bulkuseroperation'] = 'Opération par lots sur les utilisateurs';
...
$string['errorwithbulkoperation'] = 'Une erreur est survenue lors du traitement de vos modifications d’inscription par lots.';
