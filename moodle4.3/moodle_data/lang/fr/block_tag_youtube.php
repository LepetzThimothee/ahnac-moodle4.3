...
/**
 * Strings for component 'block_tag_youtube', language 'fr', version '4.3'.
 *
...
$string['categoryerror'] = 'Échec lors de l’obtention de la liste des catégories. <br /> {$a}';
...
$string['nonprofitactivism'] = 'Associations et organismes';
