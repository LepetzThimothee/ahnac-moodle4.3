...
/**
 * Strings for component 'availability_days', language 'fr', version '4.3'.
 *
...
$string['ajaxerror'] = 'Erreur en contactant le serveur pour convertir les temps';
$string['conditiontitle'] = 'Jours depuis le début';
