...
/**
 * Strings for component 'auth_imap', language 'fr', version '4.3'.
 *
 * @package     auth_imap
 * @category    string
...
$string['auth_imapchangepasswordurl_key'] = 'URL pour changement de mot de passe';
...
$string['auth_imaptype'] = 'Type de serveur IMAP. Les serveurs IMAP peuvent avoir différents types d’authentification et de négociation.';
$string['auth_imaptype_key'] = 'Type';
$string['pluginname'] = 'Serveur IMAP';
$string['privacy:metadata'] = 'Le plugin d’authentification Serveur IMAP n’enregistre aucune donnée personnelle.';
