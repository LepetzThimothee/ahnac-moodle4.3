...
/**
 * Strings for component 'coursecertificate', language 'fr', version '4.3'.
 *
...
$string['enableautomaticsendpopup'] = 'Tous les étudiants recevront automatiquement une copie PDF du certificat dès qu’ils auront satisfait aux restrictions d’accès de cette activité.<br/><br/> Les étudiants qui satisfont déjà à ces restrictions d’accès mais qui n’ont pas encore accédé à cette activité recevront également leur copie immédiatement.<br/><br/> Les étudiants qui ont déjà accédé à cette activité ne recevront pas à nouveau le certificat.';
